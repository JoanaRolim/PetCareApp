...
/** Extracts the backend's type order for the provided value. */ function ot(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? $(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : C();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function st(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return V(t.arrayValue.values || [], e.arrayValue.values || [], st);
...
function at(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = F(J(t.latitude), J(e.latitude));
            return 0 !== n ? n : F(J(t.longitude), J(e.longitude));
 ...
 */ function Ht(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new Vt(n)), e.p.push(new Vt(z.keyField(), "asc" /* ASCENDING */)); else {
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && V(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof le && e instanceof le || t instanceof de && e instanceof de ? V(t.elements, e.elements, st) : t instanceof ye && e instanceof ye ? st(t.A, e.A) : t instanceof he && e instanceof he;
...
/** A mutation that deletes the document at the given key. */ var Oe, Pe, Me = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
 ...
 */ var en = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, nn.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(x.min(), r, tn(), ze(), Ze());
    }, t;
}(), nn = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(H.EMPTY_BYTE_STRING, n, Ze(), Ze(), Ze());
    }, t;
}(), rn = function(
...
function Rn(t) {
    return t ? void 0 !== t.unaryFilter ? [ Un(t) ] : void 0 !== t.fieldFilter ? [ Vn(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return Rn(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : C() : [];
 ...
 */
        ...
        for (var r = Ze(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
    ...
    return t.Pn = function(e, n) {
        for (var r = Ze(), i = Ze(), o = 0, s = n.docChanges; o < s.length; o++) {
            var u = s[o];
            switch (u.type) {
              case 0 /* Added */ :
                r = r.add(u.doc.key);
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (Gt(e) || Kt(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (N() <= c.DEBUG && S("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), $t(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return N() <= c.DEBUG && S("QueryEngine", "Using full collection scan to execute query:", $t(e)), 
 ...
 */ function yr(t, e, n) {
    ...
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            ...
            return r.xn.getDocumentsMatchingQuery(t, e, n ? i : x.min(), n ? o : Ze());
        })).next((function(t) {
            return {
                documents: t,
                Bn: o
 ...
 */ function vr(t, e, n, r) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(p) {
            switch (p.label) {
              case 0:
                for (i = O(t), o = Ze(), s = ze(), u = Xe(), a = 0, c = n; a < c.length; a++) h = c[a], 
 ...
 */ function mr(t, e, n) {
    return void 0 === n && (n = Ze()), w(this, void 0, void 0, (function() {
        var r, i;
 ...
 */ var gr = /** @class */ function() {
    ...
    t.prototype.Zn = function(t) {
        ...
        var e = new it(new K([])), n = new br(e, t), r = new br(e, t + 1), i = Ze();
    ...
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this._s = new wr, this.targetCount = 0, this.ys = Zn.Jt();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.ys = new Zn(e), this.highestTargetId = e), t.sequenceNumber > this.ws && (this.ws = t.sequenceNumber);
    ...
    return g(e, t), e.prototype.wr = function(t) {
        ...
        var e = function(t, e) {
            ...
            n = new rn([], o, i, null); else {
                ...
                e.filter;
                var h = e.filter;
                h.targetId, r = h.count || 0, i = new Ve(r), o = h.targetId, n = new on(o, i);
            }
            return n;
        ...
        n.enqueueAndForget((function() {
            return w(o, void 0, void 0, (function() {
                return b(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return $r(this) ? (S("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return w(this, void 0, void 0, (function() {
                                var e;
                                return b(this, (function(n) {
 ...
 */ function Hr(t, e) {
    var n = O(t), r = pi(n);
    n.Or.delete(e), r.er() && Xr(n, e), 0 === n.Or.size && (r.er() ? r.ir() : $r(n) && 
...
function Zr(t) {
    return $r(t) && !pi(t).tr() && t.Or.size > 0;
}
...
function ui(t) {
    return $r(t) && !yi(t).tr() && t.kr.length > 0;
}
    ...
    t.Ur = function(t, e, n) {
        ...
        return w(e, void 0, void 0, (function() {
            return b(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n ? (t.Ur.sr(), Zr(t) ? Jr(t) : t.Br.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
    ...
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(c) {
            switch (c.label) {
              ...
              case 3:
                return u = c.sent(), a = mi(u, "Initialization of query '" + $t(e.query) + "' failed"), 
 ...
 */ var Oi = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = Ze(), this.lo = ee(t), this.fo = new gi(this.lo);
    }
    ...
    t.prototype.po = function(t) {
        ...
        // updating many documents.
                var e = this.ho;
        this.ho = Ze(), this.fo.forEach((function(e) {
...
n) {
    ...
    r, i, o) {
        ...
        this.Fo = new Map, this.ko = Zn.Yt(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(h) {
            switch (h.label) {
              ...
              case 1:
                return i = h.sent(), o = new Mi(e, i.Bn), s = o._o(i.documents), u = nn.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" /* Offline */ !== t.onlineState), 
                a = o.applyChanges(s, 
                /* updateLimboDocuments= */ t.isPrimaryClient, u), $i(t, n, a.To), c = new Fi(e, n, o), 
 ...
 */ function Hi(t, e) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(u) {
            switch (u.label) {
              case 0:
                $r((n = O(t)).remoteStore) || S("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                u.label = 1;
 ...
 */ function eo(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Co.set(r, new Vi(n)), t.Do = t.Do.insert(n, r), Wr(t.remoteStore, new Wn(Yt(jt(n.path)), r, 2 /* LimboResolution */ , E.o));
    }
}
...
function io(t, e) {
    ...
    if (r && r.bo) return Ze().add(r.key);
    var i = Ze(), o = n.Vo.get(e);
    if (!o) return i;
...
var so = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t, e) {
        ...
        var e, n = Vr(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Mr(e));
 ...
 */ var co = /** @class */ function() {
    ...
    e, n) {
        ...
        this.clientId = M.u(), this.credentialListener = function() {}, this.oc = new jn, 
...
function(t, e, n, r, i, o, s) {
    ...
    function t(t) {
        ...
        this.currentUser = Dr.UNAUTHENTICATED, this.oc = !1, 
        /**
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.uc !== e ? (S("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Oo(this.hc, this.lc, this.fc));
    }, t.prototype.setChangeListener = function(t) {
 ...
 */ function Ho(t, e) {
    ...
    if (t = s(t), Mo("collection", "path", e), t instanceof Ko) return xo(n = K.fromString.apply(K, _([ e ], r))), 
 ...
 */ function Yo(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = M.u()), Mo("doc", "path", e), t instanceof Ko) return Uo(n = K.fromString.apply(K, _([ e ], r))), 
    new Qo(t, 
...
function Jo(t, e) {
    return t = s(t), e = s(e), t instanceof zo && e instanceof zo && t.firestore === e.firestore && Jt(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
    ...
    t.prototype.Rc = function() {
        ...
        var e = this, n = this.dc.then((function() {
            return e.gc = !0, t().catch((function(t) {
                ...
                throw e.yc = t, e.gc = !1, D("INTERNAL UNHANDLED ERROR: ", 
                /**
...
var ts = /** @class */ function() {
    ...
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, n) || this).type = "firestore", r._queue = new Zo, r._persistenceKey = "name" in e ? e.name : "[DEFAULT]", 
        r;
    }
...
/** A "context" object passed around while parsing user data. */ var ds = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Nc = function(e) {
        ...
        return Os(t, this.settings.methodName, this.settings.Lc || !1, this.path, this.settings.Bc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (fs(this.Cc) && cs.test(t)) throw this.Mc('Document fields cannot begin and end with "__"');
    }, t;
}(), ps = /** @class */ function() {
    function t(t, e, n) {
...
var ws = /** @class */ function(t) {
    ...
    return g(e, t), e.prototype._toFieldTransform = function(t) {
        var e = new ye(t.R, oe(t.R, this.Qc));
 ...
 */ function Ns(t, e) {
    ...
    return function(t, e) {
        ...
        if (!fs(e.Cc)) throw e.Mc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.Mc("Unsupported field value: " + qo(t));
    }(t, e);
}
 ...
 */
    ...
    return g(e, t), e.prototype._apply = function(t) {
        return new zo(t.firestore, t.converter, Xt(t._query, this.zc, this.Hc));
    }, e;
    ...
    return g(e, t), e.prototype._apply = function(t) {
        var e = Zs(t, this.type, this.Jc, this.Yc);
        return new zo(t.firestore, t.converter, function(t, e) {
...
function Zs(t, e, n, r) {
    if (n[0] = s(n[0]), n[0] instanceof Ms) return function(t, e, n, r, i) {
        ...
        for (var o = [], s = 0, u = Ht(t); s < u.length; s++) {
            ...
            if (a.field.isKeyField()) o.push(ft(e, r.key)); else {
                ...
                if ($(c)) throw new I(T.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
 ...
 */;
        ...
        try {
            return new Ru(this, function(t, e) {
                if (t = Bo(t, Ko), Mo("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new I(T.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new zo(t, 
                /* converter= */ null, 
                /**
 ...
 */
    ...
    return g(e, t), e.prototype.convertBytes = function(t) {
        ...
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Iu.tu(e, this.firestore, /* converter= */ null);
    }, e;
}(nu);
...
var Iu = /** @class */ function() {
    ...
    return t.su = function(e, n, r) {
        ...
        return hu(Bo((t = this._delegate).firestore, ns), [ new Me(t._key, be.none()) ]);
        var t;
        /**
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        return new t(this.firestore, e ? this._delegate.withConverter(Tu.eu(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
var Du = /** @class */ function() {
                                    ...
                                    return w(this, void 0, void 0, (function() {
                                        ...
                                        return b(this, (function(a) {
                                            switch (a.label) {
                                              ...
                                              case 1:
                                                return u = a.sent(), r = new Mi(e, u.Bn), i = r._o(u.documents), o = r.applyChanges(i, 
    ...
    return g(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        return new e(this.firestore, t ? this._delegate.withConverter(Tu.eu(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}(Ru);
...
export { mu as $, Du as H, ku as J, gu as L, U as O, Eu as Q, _u as U, as as V, Ru as Y, Lu as Z, ns as g, Vu as i, Iu as j, yu as k, Mu as n, bu as q, Uu as r, Fu as s, Ou as t, es as y };
//# sourceMappingURL=prebuilt-360bb275-b64c147b.js.map
