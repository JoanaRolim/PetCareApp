...
import { XhrIo as T, EventType as E, ErrorCode as S, createWebChannelTransport as _, getStatEventTarget as N, WebChannel as D, Event as A, Stat as k } from "@firebase/webchannel-wrapper";
...
var R = {
    ...
    return t(n, e), n;
}(Error), L = new f("@firebase/firestore");
...
function F(t) {
    ...
    if (L.logLevel <= l.DEBUG) {
        var i = n.map(U);
        L.debug.apply(L, e([ "Firestore (" + x + "): " + t ], i));
    }
}

function V(t) {
    for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
    if (L.logLevel <= l.ERROR) {
        var i = n.map(U);
        L.error.apply(L, e([ "Firestore (" + x + "): " + t ], i));
    }
}

function q(t) {
    for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
    if (L.logLevel <= l.WARN) {
        var i = n.map(U);
        L.warn.apply(L, e([ "Firestore (" + x + "): " + t ], i));
    }
}
 ...
 */ var Y = /** @class */ function() {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new O(R.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new O(R.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new O(R.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new O(R.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
 ...
 */ var tt = /** @class */ function() {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var s = o[i];
            if (s.indexOf("//") >= 0) throw new O(R.INVALID_ARGUMENT, "Invalid segment (" + s + "). Paths must not contain // in them.");
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            ...
            if ("\\" === u) {
                ...
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new O(R.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function gt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return W(t.arrayValue.values || [], e.arrayValue.values || [], gt);
...
function bt(t, e) {
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return It(t.timestampValue, e.timestampValue);
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = z(at(t.latitude), at(e.latitude));
            return 0 !== n ? n : z(at(t.longitude), at(e.longitude));
...
function It(t, e) {
    ...
    var n = ut(t), r = ut(e), i = z(n.seconds, r.seconds);
    return 0 !== i ? i : z(n.nanos, r.nanos);
}
 ...
 */ var xt = /** @class */ function() {
    ...
    /** Returns the full protobuf representation. */ t.prototype.toProto = function() {
        return this.field(rt.emptyPath());
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        ...
        return gt(this.buildProto(), t.buildProto());
    }, 
    /**
    ...
    t.prototype.applyOverlay = function(e, n) {
        var r = this, i = !1, o = t.extractNestedValue(this.partialValue, e), s = kt(o) ? // If there is already data at the current path, base our
    ...
    t.prototype.buildProto = function() {
        var t = this.applyOverlay(rt.emptyPath(), this.overlayMap);
        ...
        for (var n = t, r = 0; r < e.length - 1; ++r) {
            ...
            if (!kt(n = n.mapValue.fields[e.get(r)])) return null;
        }
...
var Rt = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , X.min(), xt.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */ t.newNoDocument = function(e, n) {
        return new t(e, 2 /* NO_DOCUMENT */ , n, xt.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newUnknownDocument = function(e, n) {
        return new t(e, 3 /* UNKNOWN_DOCUMENT */ , n, xt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }, 
    /**
...
function Pt(t) {
    ...
    if (null === e.h) {
        ...
        n += Ht(e.startAt)), e.endAt && (n += "|ub:", n += Ht(e.endAt)), e.h = n;
    }
    return e.h;
}
...
var Vt = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, r) : new qt(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new jt(t, r) : "in" /* IN */ === e ? new Qt(t, r) : "not-in" /* NOT_IN */ === e ? new Gt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new zt(t, r) : new n(t, e, r);
    }, n.l = function(t, e, n) {
        return "in" /* IN */ === e ? new Ut(t, n) : new Bt(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.m(bt(e, this.value)) : null !== e && mt(this.value) === mt(e) && this.m(bt(e, this.value));
...
var qt = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = vt.fromName(r.referenceValue), 
        i;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = vt.comparator(t.key, this.key);
        return this.m(e);
    }, n;
}(Vt), Ut = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = Kt("in" /* IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* NOT_IN */ , n) || this).keys = Kt("not-in" /* NOT_IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** Filter that matches on key fields within an array. */ function Kt(t, e) {
    var n;
    return ((null === (n = e.arrayValue) || void 0 === n ? void 0 : n.values) || []).map((function(t) {
        return vt.fromName(t.referenceValue);
    }));
}
...
/** A Filter that implements the array-contains operator. */ var jt = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        return Nt(e) && wt(e.arrayValue, this.value);
    }, n;
}(Vt), Qt = /** @class */ function(e) {
    function n(t, n) {
...
/** A Filter that implements the IN operator. */ function Ht(t) {
    // TODO(b/29183165): Make this collision robust.
 ...
 */ function $t(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.isKeyField() ? vt.comparator(vt.fromName(s.referenceValue), n.key) : bt(s, n.data.field(o.field)), 
...
/** Creates a new Query instance with the options provided. */ function te(t, e, n, r, i, o, s, u) {
 ...
 */ function ue(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new Yt(n)), e.p.push(new Yt(rt.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function ae(t) {
    var e = j(t);
    if (!e.T) if ("F" /* First */ === e.limitType) e.T = Lt(e.path, e.collectionGroup, ue(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = ue(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new Yt(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var u = e.endAt ? new Wt(e.endAt.position, !e.endAt.before) : null, a = e.startAt ? new Wt(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.T = Lt(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.T;
}
...
function he(t, e) {
    return Mt(ae(t), ae(e)) && t.limitType === e.limitType;
}
...
function le(t) {
    return "Query(target=" + function(t) {
        ...
        })).join(", ") + "]"), t.startAt && (e += ", startAt: " + Ht(t.startAt)), t.endAt && (e += ", endAt: " + Ht(t.endAt)), 
        "Target(" + e + ")";
    }(ae(t)) + "; limitType=" + t.limitType + ")";
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function de(t, e) {
    return e.isFoundDocument() && function(t, e) {
        ...
        return !(t.startAt && !$t(t.startAt, ue(t), e)) && (!t.endAt || !$t(t.endAt, ue(t), e));
    }(t, e);
}

function pe(t) {
    return function(e, n) {
        for (var r = !1, i = 0, o = ue(t); i < o.length; i++) {
            var s = o[i], u = ye(s, e, n);
            if (0 !== u) return u;
...
function ye(t, e, n) {
    var r = t.field.isKeyField() ? vt.comparator(e.key, n.key) : function(t, e, n) {
        var r = e.data.field(t), i = n.data.field(t);
        return null !== r && null !== i ? bt(r, i) : B();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 * limitations under the License.
 */
/** Used to represent a field transform on a mutation. */ var we = function() {
 ...
 */ function be(t, e, n) {
    ...
    }(n, e) : t instanceof Se ? _e(t, e) : t instanceof Ne ? De(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = Te(t, e), r = ke(n) + ke(t.A);
        return _t(n) && _t(t.A) ? me(r) : ve(t.R, r);
    }(t, e);
}
 ...
 */ function Ie(t, e, n) {
    ...
    // applications.
    return t instanceof Se ? _e(t, e) : t instanceof Ne ? De(t, e) : n;
}
 ...
 */ function Te(t, e) {
    return t instanceof Ae ? _t(n = e) || function(t) {
...
/** Transforms a value into a server-generated timestamp. */ var Ee = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n;
...
/** Transforms an array value via a union operation. */ function _e(t, e) {
...
/** Transforms an array value via a remove operation. */ var Ne = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).elements = t, n;
    }
 ...
 */
/** Returns true if the preconditions is valid for the given document. */ function Le(t, e) {
 ...
 */ function Me(t, e, n) {
    t instanceof Be ? function(t, e, n) {
        ...
        // must have held.
        var r = t.value.clone(), i = Qe(t.fieldTransforms, e, n.transformResults);
        r.setAll(i), e.convertToFoundDocument(n.version, r).setHasCommittedMutations();
    }(t, e, n) : t instanceof Ke ? function(t, e, n) {
        if (Le(t.precondition, e)) {
            var r = Qe(t.fieldTransforms, e, n.transformResults), i = e.data;
            i.setAll(je(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Fe(t, e, n) {
    t instanceof Be ? function(t, e, n) {
        if (Le(t.precondition, e)) {
            var r = t.value.clone(), i = Ge(t.fieldTransforms, n, e);
            r.setAll(i), e.convertToFoundDocument(Ue(e), r).setHasLocalMutations();
        }
    }(t, e, n) : t instanceof Ke ? function(t, e, n) {
        if (Le(t.precondition, e)) {
            var r = Ge(t.fieldTransforms, n, e), i = e.data;
            i.setAll(je(t)), i.setAll(r), e.convertToFoundDocument(Ue(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        Le(t.precondition, e) && 
 ...
 */ function Ve(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), u = Te(o.transform, s || null);
        null != u && (null == n && (n = xt.empty()), n.set(o.field, u));
    }
    return n || null;
}
...
function qe(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.precondition.isEqual(e.precondition) && !!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && W(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Se && e instanceof Se || t instanceof Ne && e instanceof Ne ? W(t.elements, e.elements, gt) : t instanceof Ae && e instanceof Ae ? gt(t.A, e.A) : t instanceof Ee && e instanceof Ee;
 ...
 */ function Ge(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(s.field, be(u, a, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var ze, We, He = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 */ function Je(t) {
    ...
    return V("GRPC error has no .code"), R.UNKNOWN;
    switch (t) {
      case ze.OK:
        return R.OK;
 ...
 *     Code.UNKNOWN.
 */ (We = ze || (ze = {}))[We.OK = 0] = "OK", We[We.CANCELLED = 1] = "CANCELLED", 
We[We.UNKNOWN = 2] = "UNKNOWN", We[We.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", 
We[We.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", We[We.NOT_FOUND = 5] = "NOT_FOUND", 
We[We.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", We[We.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", 
We[We.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", We[We.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", 
We[We.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", We[We.ABORTED = 10] = "ABORTED", 
We[We.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", We[We.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", 
We[We.INTERNAL = 13] = "INTERNAL", We[We.UNAVAILABLE = 14] = "UNAVAILABLE", We[We.DATA_LOSS = 15] = "DATA_LOSS";
...
var Ze = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, en.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, en.BLACK, null, null));
    }, 
...
}(), on = new Ze(vt.comparator);

function sn() {
    return on;
}

var un = new Ze(vt.comparator);

function an() {
    return un;
}

var cn = new Ze(vt.comparator);

function hn() {
    return cn;
}

var fn = new nn(vt.comparator);

function ln() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = fn, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.add(o);
    }
    return n;
 ...
 */ var yn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, vn.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(X.min(), r, pn(), sn(), ln());
    }, t;
}(), vn = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(ot.EMPTY_BYTE_STRING, n, ln(), ln(), ln());
    }, t;
}(), mn = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = ot.EMPTY_BYTE_STRING), void 0 === r && (r = null), this.state = t, 
    ...
    function t() {
        ...
        this.C = ot.EMPTY_BYTE_STRING, this.N = !1, 
        /**
    ...
    t.prototype.rt = function(t) {
        ...
        if (r) {
            ...
            if (Ft(i)) if (0 === n) {
                ...
                // queries.
                var o = new vt(i.path);
                this.tt(e, o, Rt.newNoDocument(o, X.min()));
    ...
    t.prototype.at = function(t) {
        ...
        this.G.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && Ft(o.target)) {
                    ...
                    var s = new vt(o.target.path);
                    null !== e.H.get(s) || e.ut(i, s) || e.tt(i, s, Rt.newNoDocument(s, t));
                }
                r.O && (n.set(i, r.F()), r.L());
            }
        }));
        ...
        var i = new yn(t, n, this.Y, this.H, r);
        return this.H = sn(), this.J = Tn(), this.Y = new nn(z), i;
    }, 
    /**
    ...
    t.prototype.q = function(t) {
        ...
        var e = this.G.get(t);
        return e || (e = new bn, this.G.set(t, e)), e;
    }, t.prototype.ht = function(t) {
        var e = this.J.get(t);
        return e || (e = new nn(z), this.J = this.J.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.it = function(t) {
        var e = this;
        this.G.set(t, new bn), this.W.getRemoteKeysForTarget(t).forEach((function(n) {
...
function xn(t) {
    return K(!!t), X.fromTimestamp(function(t) {
        var e = ut(t);
        return new Y(e.seconds, e.nanos);
    }(t));
}
...
function On(t, e) {
    return Cn(t.databaseId, e.path);
}

function Ln(t, e) {
    var n = Rn(e);
    if (n.get(1) !== t.databaseId.projectId) throw new O(R.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
    if (n.get(3) !== t.databaseId.database) throw new O(R.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
    return new vt(Vn(n));
}

function Pn(t, e) {
    return Cn(t.databaseId, e);
}
...
function Mn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? et.emptyPath() : Vn(e);
}
...
function Un(t, e, n) {
    var r = Ln(t, e.name), i = xn(e.updateTime), o = new xt({
        mapValue: {
            fields: e.fields
        }
    }), s = Rt.newFoundDocument(r, i, o);
...
function Kn(t, e) {
    ...
    }(e.currentDocument) : Oe.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) K("REQUEST_TIME" === e.setToServerValue), n = new Ee; else if ("appendMissingElements" in e) {
                var r = e.appendMissingElements.values || [];
                n = new Se(r);
            } else if ("removeAllFromArray" in e) {
                var i = e.removeAllFromArray.values || [];
                n = new Ne(i);
            } else "increment" in e ? n = new Ae(t, e.increment) : B();
            var o = rt.fromServerFormat(e.fieldPath);
            return new Ce(o, n);
        }(t, e);
    })) : [];
    if (e.update) {
        e.update.name;
        var i = Ln(t, e.update.name), o = new xt({
            mapValue: {
        ...
        if (e.updateMask) {
            var s = function(t) {
                ...
                return new it(e.map((function(t) {
                    return rt.fromServerFormat(t);
                })));
            }(e.updateMask);
            return new Ke(i, o, s, n, r);
        }
...
function Qn(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Pn(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Pn(t, r.popLast()), n.structuredQuery.from = [ {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = Wn(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = Wn(e.endAt)), n;
}

function Gn(t) {
    var e = Mn(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
    if (r > 0) {
        K(1 === r);
        var o = n.from[0];
    ...
    var s = [];
    n.where && (s = zn(n.where));
    var u = [];
    n.orderBy && (u = n.orderBy.map((function(t) {
        return function(t) {
            return new Yt(Jn(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    var c = null;
    n.startAt && (c = Hn(n.startAt));
    var h = null;
    return n.endAt && (h = Hn(n.endAt)), te(e, i, u, s, a, "F" /* First */ , c, h);
}

function zn(t) {
    return t ? void 0 !== t.unaryFilter ? [ tr(t) ] : void 0 !== t.fieldFilter ? [ Zn(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return zn(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : B() : [];
...
function Zn(t) {
    return Vt.create(Jn(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
 ...
 */ function sr(t) {
    ...
    var e = t.length;
    if (K(e >= 2), 2 === e) return K("" === t.charAt(0) && "" === t.charAt(1)), et.emptyPath();
...
/** Name of the IndexedDb object store.  */ cr.store = "mutationQueues", 
...
/** Name of the IndexedDb object store.  */ hr.store = "mutations", 
/** Keys are automatically assigned via the userId, batchId properties. */
hr.keyPath = "batchId", 
/** The index name for lookup of mutations by user. */
hr.userMutationsIndex = "userMutationsIndex", 
/** The user mutations index is keyed by [userId, batchId] pairs. */
hr.userMutationsKeyPath = [ "userId", "batchId" ];
...
yr.store = "remoteDocumentGlobal", yr.key = "remoteDocumentGlobalKey";
...
vr.queryTargetsIndexName = "queryTargetsIndex", 
/**
     * The index of all canonicalIds to the targets that they match. This is not
     * a unique mapping because canonicalId does not promise a unique name for all
     * possible queries, so we append the targetId to make the mapping unique.
     */
vr.queryTargetsKeyPath = [ "canonicalId", "targetId" ];
 ...
 */ gr.key = "targetGlobalKey", gr.store = "targetGlobal";
...
/** Name of the IndexedDb object store. */ wr.store = "collectionParents", 
/** Keys are automatically assigned via the collectionId, parent properties. */
wr.keyPath = [ "collectionId", "parent" ];
...
/** Name of the IndexedDb object store. */ br.store = "clientMetadata", 
...
/** Name of the IndexedDb object store. */ Ir.store = "bundles", Ir.keyPath = "bundleId";
...
/** Name of the IndexedDb object store. */ Tr.store = "namedQueries", Tr.keyPath = "name";

// Visible for testing
var Er = e(e([], e(e([], e(e([], e(e([], [ cr.store, hr.store, fr.store, pr.store, vr.store, ar.store, gr.store, mr.store ]), [ br.store ])), [ yr.store ])), [ wr.store ])), [ Ir.store, Tr.store ]), Sr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", _r = /** @class */ function() {
    function t() {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.ft = new Nr, this.transaction.oncomplete = function() {
            n.ft.resolve();
        }, this.transaction.onabort = function() {
            e.error ? n.ft.reject(new Cr(t, e.error)) : n.ft.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Mr(e.target.error);
            n.ft.reject(new Cr(t, r));
        };
    }
    return t.open = function(e, n, r, i) {
        ...
        t && this.ft.reject(t), this.aborted || (F("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    function t(e, n, r) {
        ...
        // log on 12.2.
        12.2 === t._t(d()) && V("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    return t.delete = function(t) {
        return F("SimpleDb", "Removing database:", t), Lr(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
                  ...
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, r) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            r(new Cr(t, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
                        }, i.onerror = function(e) {
                            var n = e.target.error;
                            "VersionError" === n.name ? r(new O(R.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r(new Cr(t, n));
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 2:
                                ...
                                // caller.
                                return a.db = r.sent(), e = Ar.open(a.db, t, n ? "readonly" : "readwrite", i), u = o(e).catch((function(t) {
                                    // Abort the transaction if there was an error.
                                    return e.abort(t), Dr.reject(t);
                              ...
                              case 4:
                                return h = r.sent(), f = "FirebaseError" !== h.name && s < 3, F("SimpleDb", "Transaction failed with error:", h.message, "Retrying:", f), 
    ...
    t.prototype.delete = function() {
        return Lr(this.vt.delete());
    }, t;
}(), Cr = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, R.UNAVAILABLE, "IndexedDB transaction '" + t + "' failed: " + n) || this).name = "IndexedDbTransactionError", 
        r;
    }
    return t(n, e), n;
}(O);
 ...
 */ var Or = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return F("SimpleDb", "ADD", this.store.name, t, t), Lr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        return F("SimpleDb", "DELETE", this.store.name, t), Lr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return F("SimpleDb", "COUNT", this.store.name), Lr(this.store.count());
 ...
 */ var Fr = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Ft = t, r.currentSequenceNumber = n, r;
    }
    return t(n, e), n;
}(_r);
 ...
 */ var qr = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && Me(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalView = function(t) {
        ...
        for (var e = 0, n = this.baseMutations; e < n.length; e++) {
            var r = n[e];
            r.key.isEqual(t.key) && Fe(r, t, this.localWriteTime);
        }
        // Second, apply all user-provided mutations.
                for (var i = 0, o = this.mutations; i < o.length; i++) {
            var s = o[i];
            s.key.isEqual(t.key) && Fe(s, t, this.localWriteTime);
        }
    }, 
    /**
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = hn(), o = e.mutations, s = 0; s < o.length; s++) i = i.insert(o[s].key, r[s].version);
     ...
     * time from which the server should resume sending results.
     */ , s) {
        void 0 === i && (i = X.min()), void 0 === o && (o = X.min()), void 0 === s && (s = ot.EMPTY_BYTE_STRING), 
...
/** Decodes a remote document from storage locally to a Document. */ function jr(t, e) {
    ...
    if (e.noDocument) {
        var n = vt.fromSegments(e.noDocument.path), r = Hr(e.noDocument.readTime), i = Rt.newNoDocument(n, r);
        return e.hasCommittedMutations ? i.setHasCommittedMutations() : i;
    }
    if (e.unknownDocument) {
        var o = vt.fromSegments(e.unknownDocument.path), s = Hr(e.unknownDocument.version);
        return Rt.newUnknownDocument(o, s);
    }
    return B();
}

/** Encodes a document for storage locally. */ function Qr(t, e, n) {
    var r = Gr(n), i = e.key.path.popLast().toArray();
    ...
    if (e.isNoDocument()) {
        var u = e.key.path.toArray(), a = Wr(e.version), c = e.hasCommittedMutations;
        return new pr(
        /* unknownDocument= */ null, new lr(u, a), 
        /* document= */ null, c, r, i);
    }
    if (e.isUnknownDocument()) {
        var h = e.key.path.toArray(), f = Wr(e.version);
        return new pr(new dr(h, f), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function zr(t) {
    var e = new Y(t[0], t[1]);
    return X.fromTimestamp(e);
}

function Wr(t) {
    var e = t.toTimestamp();
    return new ur(e.seconds, e.nanoseconds);
}

function Hr(t) {
    var e = new Y(t.seconds, t.nanoseconds);
    return X.fromTimestamp(e);
}

/** Encodes a batch of mutations into a DbMutationBatch for local storage. */
/** Decodes a DbMutationBatch into a MutationBatch */ function Yr(t, e) {
    ...
    var s = e.mutations.map((function(e) {
        return Kn(t.Lt, e);
    })), u = Y.fromMillis(e.localWriteTimeMs);
    return new qr(e.batchId, u, n, s);
}

/** Decodes a DbTarget into TargetData */ function Xr(t) {
    var e, n, r = Hr(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? Hr(t.lastLimboFreeSnapshotVersion) : X.min();
    return void 0 !== t.query.documents ? (K(1 === (n = t.query).documents.length), 
    e = ae(ee(Mn(n.documents[0])))) : e = function(t) {
        return ae(Gn(t));
    }(t.query), new Br(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, ot.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function $r(t, e) {
    var n, r = Wr(e.snapshotVersion), i = Wr(e.lastLimboFreeSnapshotVersion);
    n = Ft(e.target) ? jn(t.Lt, e.target) : Qn(t.Lt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
    var o = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new vr(e.targetId, Pt(e.target), r, o, e.sequenceNumber, i, n);
}
 ...
 */ function ti(t) {
    return Vr(t, Ir.store);
}

/**
 * Helper to get a typed SimpleDbStore for the namedQueries object store.
 */ function ei(t) {
    return Vr(t, Tr.store);
}
 ...
 */ var ni = /** @class */ function() {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.Bt.add(e), Dr.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return Dr.resolve(this.Bt.getEntries(e));
    }, t;
}(), ri = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new nn(et.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new nn(et.comparator)).toArray();
    }, t;
}(), ii = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        var n = [], r = IDBKeyRange.bound([ e, "" ], [ H(e), "" ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return oi(t).Nt(r).next((function(t) {
 ...
 */
function ai(t, e, n) {
    var r = t.store(hr.store), i = t.store(fr.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.Ot({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    ...
    for (var c = [], h = 0, f = n.mutations; h < f.length; h++) {
        var l = f[h], d = fr.key(e, l.key.path, n.batchId);
        o.push(i.delete(d)), c.push(l.key);
    }
    return Dr.waitFor(o).next((function() {
        return c;
    }));
}
...
var hi = /** @class */ function() {
    ...
    return t.Qt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(u) {
            K("number" == typeof u);
            for (var a = new qr(u, e, n, r), c = function(t, e, n) {
                var r = n.baseMutations.map((function(e) {
                    return Bn(t.Lt, e);
                })), i = n.mutations.map((function(e) {
                    return Bn(t.Lt, e);
                }));
                return new hr(e, n.batchId, n.localWriteTime.toMillis(), r, i);
            }(i.R, i.userId, a), h = [], f = new nn((function(t, e) {
                return z(t.canonicalString(), e.canonicalString());
            })), l = 0, d = r; l < d.length; l++) {
                var p = d[l], y = fr.key(i.userId, p.key.path, u);
                f = f.add(p.key.path.popLast()), h.push(s.put(c)), h.push(o.put(y, fr.PLACEHOLDER));
            }
            return f.forEach((function(e) {
                h.push(i.qt.addToCollectionParentIndex(t, e));
            })), t.addOnCommittedListener((function() {
                i.Kt[u] = a.keys();
            })), Dr.waitFor(h).next((function() {
                return a;
            }));
        }));
        ...
        return li(t).get(e).next((function(t) {
            return t ? (K(t.userId === n.userId), Yr(n.R, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.jt = function(t, e) {
        var n = this;
        return this.Kt[e] ? Dr.resolve(this.Kt[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.Kt[e] = r, r;
            }
        ...
        return li(t).Ot({
            ...
            e.userId === n.userId && (K(e.batchId >= r), o = Yr(n.R, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return li(t).Nt(hr.userMutationsIndex, n).next((function(t) {
            return t.map((function(t) {
                return Yr(e.R, t);
            }));
        }));
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = fr.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        ...
        // the given documentKey.
            ...
            return li(t).get(c).next((function(t) {
                if (!t) throw B();
                K(t.userId === n.userId), o.push(Yr(n.R, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new nn(z), i = [];
        return e.forEach((function(e) {
            var o = fr.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = di(t).Ot({
                range: s
            }, (function(t, i, o) {
            ...
            i.push(u);
        })), Dr.waitFor(i).next((function() {
            return n.Wt(t, r);
        }));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = fr.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new nn(z);
        return di(t).Ot({
            range: s
        }, (function(t, e, o) {
        ...
        return e.forEach((function(e) {
            i.push(li(t).get(e).next((function(t) {
                if (null === t) throw B();
                K(t.userId === n.userId), r.push(Yr(n.R, t));
            })));
        })), Dr.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return ai(t.Ft, this.userId, e).next((function(r) {
    ...
    t.prototype.Gt = function(t) {
        ...
        return this.checkEmpty(t).next((function(n) {
            ...
            // the queue is empty.
                        var r = IDBKeyRange.lowerBound(fr.prefixForUser(e.userId)), i = [];
            return di(t).Ot({
                range: r
            }, (function(t, n, r) {
                if (t[0] === e.userId) {
    ...
    t.prototype.zt = function(t) {
        var e = this;
        return pi(t).get(this.userId).next((function(t) {
            return t || new cr(e.userId, -1, 
            /*lastStreamToken=*/ "");
        }));
    }, t;
}();
 ...
 */ function fi(t, e, n) {
    var r = fr.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return di(t).Ot({
        range: o,
        $t: !0
    }, (function(t, n, r) {
 ...
 */ function li(t) {
    return Vr(t, hr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function di(t) {
    return Vr(t, fr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function pi(t) {
    return Vr(t, cr.store);
}
 ...
 */ var yi = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Xt(t).next((function(n) {
            var r = new yi(n.highestTargetId);
        ...
        return this.Xt(t).next((function(t) {
            return X.fromTimestamp(new Y(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
     ...
     */
    t.prototype.forEachTarget = function(t, e) {
        return mi(t).Ot((function(t, n) {
            var r = Xr(n);
            e(r);
        }));
    }, t.prototype.Xt = function(t) {
        return gi(t).get(gr.key).next((function(t) {
            return K(null !== t), t;
        }));
    }, t.prototype.Zt = function(t, e) {
        return gi(t).put(gr.key, e);
    }, t.prototype.te = function(t, e) {
        return mi(t).put($r(this.R, e));
    }, 
    /**
    ...
    t.prototype.ee = function(t, e) {
        ...
        // IndexedDb.
            ...
            var o = rr(e.path);
            return Dr.waitFor([ i.delete([ n, o ]), r.referenceDelegate.removeReference(t, n, e) ]);
        }));
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = wi(t), i = ln();
        return r.Ot({
            range: n,
            $t: !0
        }, (function(t, e, n) {
            var r = sr(t[1]), o = new vt(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.containsKey = function(t, e) {
        var n = rr(e.path), r = IDBKeyRange.bound([ n ], [ H(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return wi(t).Ot({
 ...
 */
function mi(t) {
    return Vr(t, vr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function gi(t) {
    return Vr(t, gr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function wi(t) {
    return Vr(t, mr.store);
}
 ...
 */ function bi(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            if (t.code !== R.FAILED_PRECONDITION || t.message !== Sr) throw t;
 ...
 * limitations under the License.
 */ function Ii(t, e) {
    var n = t[0], r = t[1], i = e[0], o = e[1], s = z(n, i);
    return 0 === s ? z(r, o) : s;
}
 ...
 */ var Ti = /** @class */ function() {
    function t(t) {
        this.ne = t, this.buffer = new nn(Ii), this.se = 0;
    }
    ...
    return t.prototype.start = function(t) {
        ...
        F("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.ce = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Rr(e = n.sent()) ? (F("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        Dr.resolve(si)) : this.getCacheSize(t).next((function(r) {
            return r < n.params.cacheSizeCollectionThreshold ? (F("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.params.cacheSizeCollectionThreshold), 
            si) : n.fe(t, e);
        }));
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return e > c.params.maximumSequenceNumbersToCollect ? (F("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + c.params.maximumSequenceNumbersToCollect + " from " + e), 
            ...
            return a = Date.now(), P() <= l.DEBUG && F("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - h) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (u - s) + "ms\n\tRemoved " + t + " documents in " + (a - u) + "ms\nTotal Duration: " + (a - h) + "ms"), 
            Dr.resolve({
                didRun: !0,
    ...
    t.prototype._e = function(t, e) {
        return function(t, e) {
            var n = !1;
            return pi(t).Mt((function(r) {
                return fi(t, r, e).next((function(t) {
            ...
            if (u <= e) {
                var a = n._e(t, s).next((function(e) {
                    ...
                    return o++, r.getEntry(t, s).next((function() {
                        return r.removeEntry(s), wi(t).delete([ 0, rr(s.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var Di = /** @class */ function() {
    ...
    function t() {
        ...
        this.changes = new Di((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
    ...
    t.prototype.getEntry = function(t, e) {
        ...
        return void 0 !== n ? Dr.resolve(n.document) : this.getFromCache(t, e);
    }, 
    /**
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return Ri(t).get(Oi(e)).next((function(t) {
            return n.ge(e, t);
        }));
    }, 
    /**
     ...
     */
    t.prototype.Ee = function(t, e) {
        var n = this, r = sn(), i = new Ze(vt.comparator);
        return this.pe(t, e, (function(t, e) {
            var o = n.ge(t, e);
            r = r.insert(t, o), i = i.insert(t, ci(e));
        })).next((function() {
            return {
                documents: r,
                Te: i
        ...
        if (e.isEmpty()) return Dr.resolve();
        var r = IDBKeyRange.bound(e.first().path.toArray(), e.last().path.toArray()), i = e.getIterator(), o = i.getNext();
        return Ri(t).Ot({
            range: r
        }, (function(t, e, r) {
            // Go through keys not found in cache.
            for (var s = vt.fromSegments(t); o && vt.comparator(o, s) < 0; ) n(o, null), o = i.getNext();
            o && o.isEqual(s) && (
            // Key found in cache.
        ...
        return Ri(t).Ot(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                var u = jr(r.R, n);
                e.path.isPrefixOf(u.key.path) ? de(e, u) && (i = i.insert(u.key, u)) : s.done();
            }
        })).next((function() {
            return i;
        }));
        ...
        return Ci(t).get(yr.key).next((function(t) {
            return K(!!t), t;
        }));
    }, t.prototype.me = function(t, e) {
        return Ci(t).put(yr.key, e);
    }, 
    /**
    ...
    t.prototype.ge = function(t, e) {
        if (e) {
            ...
            // `getNewDocumentChanges()`
                        if (!n.isNoDocument() || !n.version.isEqual(X.min())) return n;
        }
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [], r = 0, i = new nn((function(t, e) {
            return z(t.canonicalString(), e.canonicalString());
        }));
        return this.changes.forEach((function(o, s) {
            var u = e.Ae.get(o);
            if (s.document.isValidDocument()) {
                var a = Qr(e.Ie.R, s.document, e.getReadTime(o));
 ...
 */ function Ci(t) {
    return Vr(t, yr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Ri(t) {
    return Vr(t, pr.store);
}
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ var Li = /** @class */ function() {
    function t(t) {
        this.R = t;
    }
    /**
     ...
     */    return t.prototype.Rt = function(t, e, n, r) {
        var i = this;
        K(n < r && n >= 0 && r <= 11);
        var o = new Ar("createOrUpgrade", e);
        n < 1 && r >= 1 && (function(t) {
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(mr.store), t.deleteObjectStore(vr.store), t.deleteObjectStore(gr.store);
        }(t), Pi(t)), s = s.next((function() {
            /**
     ...
     */
            return function(t) {
                var e = t.store(gr.store), n = new gr(
                /*highestTargetId=*/ 0, 
                /*lastListenSequenceNumber=*/ 0, X.min().toTimestamp(), 
                /*targetCount=*/ 0);
                return e.put(gr.key, n);
            }(o);
        }))), n < 4 && r >= 4 && (0 !== n && (
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(hr.store).Nt().next((function(n) {
                    ...
                    var r = e.store(hr.store), i = n.map((function(t) {
                        return r.put(t);
                    }));
                    return Dr.waitFor(i);
                }));
        ...
        var e = 0;
        return t.store(pr.store).Ot((function(t, n) {
            e += ci(n);
        })).next((function() {
            var n = new yr(e);
            return t.store(yr.store).put(yr.key, n);
        }));
    }, t.prototype.Re = function(t) {
        var e = this, n = t.store(cr.store), r = t.store(hr.store);
        return n.Nt().next((function(n) {
            return Dr.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Nt(hr.userMutationsIndex, i).next((function(r) {
    ...
    t.prototype.be = function(t) {
        var e = t.store(mr.store), n = t.store(pr.store);
        return t.store(gr.store).get(gr.key).next((function(t) {
            var r = [];
            return n.Ot((function(n, i) {
                var o = new et(n), s = function(t) {
                    return [ 0, rr(t) ];
                }(o);
                r.push(e.get(s).next((function(n) {
                    return n ? Dr.resolve() : function(n) {
                        return e.put(new mr(0, rr(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return Dr.waitFor(r);
        ...
        var n = e.store(wr.store), r = new ri, i = function(t) {
            if (r.add(t)) {
        ...
        var e = this, n = t.store(vr.store);
        return n.Ot((function(t, r) {
            var i = Xr(r), o = $r(e.R, i);
            return n.put(o);
        }));
    }, t;
}();
...
var Mi = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Fi = /** @class */ function() {
    function t(
    /**
    ...
    h) {
        ...
        }, !t.gt()) throw new O(R.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new _i(this, i), this.Le = n + "main", this.R = new Kr(a), 
        this.Be = new kr(this.Le, 11, new Li(this.R)), this.Ue = new vi(this.referenceDelegate, this.R), 
        this.qt = new ii, this.qe = function(t, e) {
            return new ki(t, e);
        }(this.R, this.qt), this.Ke = new Zr, this.window && this.window.localStorage ? this.Qe = this.window.localStorage : (this.Qe = null, 
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new O(R.FAILED_PRECONDITION, Mi);
    ...
    t.prototype.je = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return qi(e).put(new br(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
        ...
        var e = this;
        return Vi(t).get(ar.key).next((function(t) {
            return Dr.resolve(e.tn(t));
        }));
    ...
    t.prototype.nn = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return !this.isPrimary || this.sn(this.Me, 18e5) ? [ 3 /*break*/ , 2 ] : (this.Me = Date.now(), 
    ...
    t.prototype.Ye = function(t) {
        var e = this;
        return this.Ce ? Dr.resolve(!0) : Vi(t).get(ar.key).next((function(n) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || qi(t).Nt().next((function(t) {
            ...
            return e.isPrimary !== t && F("IndexedDbPersistence", "Client " + (t ? "is" : "is not") + " eligible for a primary lease."), 
            t;
        }));
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.hn(), [ 4 /*yield*/ , this.Be.runTransaction("shutdown", "readwrite", [ ar.store, br.store ], (function(e) {
                        var n = new Fr(e, C.o);
    ...
    t.prototype.fn = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return qi(e).Nt().next((function(e) {
        ...
        return hi.Qt(t, this.R, this.qt, this.referenceDelegate);
        ...
        return this.Be.runTransaction(t, o, Er, (function(o) {
            return i = new Fr(o, r.Ne ? r.Ne.next() : C.o), "readwrite-primary" === e ? r.Je(i).next((function(t) {
                return !!t || r.Ye(i);
            })).next((function(e) {
                if (!e) throw V("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Se.enqueueRetryable((function() {
                    return r.Fe(!1);
                })), new O(R.FAILED_PRECONDITION, Sr);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.dn = function(t) {
        var e = this;
        return Vi(t).get(ar.key).next((function(t) {
            if (null !== t && e.sn(t.leaseTimestampMs, 5e3) && !e.cn(t.ownerId) && !e.tn(t) && !(e.Ce || e.allowTabSynchronization && t.allowTabSynchronization)) throw new O(R.FAILED_PRECONDITION, Mi);
        }));
    }, 
    /**
    ...
    t.prototype.Ze = function(t) {
        var e = new ar(this.clientId, this.allowTabSynchronization, Date.now());
        return Vi(t).put(ar.key, e);
    }, t.gt = function() {
        return kr.gt();
    }, 
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.Xe = function(t) {
        var e = this, n = Vi(t);
        return n.get(ar.key).next((function(t) {
            return e.tn(t) ? (F("IndexedDbPersistence", "Releasing primary lease."), n.delete(ar.key)) : Dr.resolve();
        }));
    }, 
 ...
 */
function Vi(t) {
    return Vr(t, ar.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function qi(t) {
    return Vr(t, br.store);
}
 ...
 */
        return function(t) {
            return vt.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Tn(t, e.path) : se(e) ? this.In(t, e, n) : this.An(t, e, n);
    }, t.prototype.Tn = function(t, e) {
        // Just do a simple document lookup.
        return this.mn(t, new vt(e)).next((function(t) {
            var e = an();
            return t.isFoundDocument() && (e = e.insert(t.key, t)), e;
        }));
    }, t.prototype.In = function(t, e, n) {
        var r = this, i = e.collectionGroup, o = an();
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Rn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    h = Rt.newInvalidDocument(c), r = r.insert(c, h)), Fe(a, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
        ...
        for (var r = ln(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
    ...
    return t.vn = function(e, n) {
        for (var r = ln(), i = ln(), o = 0, s = n.docChanges; o < s.length; o++) {
            var u = s[o];
            switch (u.type) {
              case 0 /* Added */ :
                r = r.add(u.doc.key);
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (ne(e) || re(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (P() <= l.DEBUG && F("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), le(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return P() <= l.DEBUG && F("QueryEngine", "Using full collection scan to execute query:", le(e)), 
    ...
    t, e, n, r) {
        ...
        /**
             ...
             */
        this.On = X.min(), this._n = t.getMutationQueue(n), this.Mn = t.getRemoteDocumentCache(), 
        this.Ue = t.getTargetCache(), this.Fn = new Ki(this.Mn, this._n, this.persistence.getIndexManager()), 
...
function Wi(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = j(t), i = n._n, o = n.Fn, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n._n.getAllMutationBatches(t).next((function(s) {
                        ...
                        // MutationQueue.
                        o = new Ki(n.Mn, i, n.persistence.getIndexManager()), i.getAllMutationBatches(t);
                    })).next((function(e) {
                        for (var n = [], i = [], s = ln(), u = 0, a = r
              ...
              case 1:
                return s = r.sent(), [ 2 /*return*/ , (n._n = i, n.Fn = o, n.xn.Vn(n.Fn), s) ];
            }
        }));
    }));
}
 ...
 */ function Hi(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        var r = e.batch.keys(), i = n.Mn.newChangeBuffer({
            trackRemovals: !0
        });
 ...
 * queue.
 */ function Xi(t, e) {
    var n = j(t), r = e.snapshotVersion, i = n.kn;
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(t) {
        var o = n.Mn.newChangeBuffer({
            trackRemovals: !0
        });
     ...
     */
        ...
        s.push($i(t, o, e.documentUpdates, r, void 0).next((function(t) {
            u = t;
        }))), !r.isEqual(X.min())) {
        ...
        return Dr.waitFor(s).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.Fn.En(t, u);
        })).next((function() {
...
i) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, s) {
            ...
            o = o.insert(n, s)) : F("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", u.version, " Watch version:", s.version);
        })), o;
    }))
    /**
 ...
 */ function Zi(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.Ue.getTargetData(t, e).next((function(i) {
            ...
            r = i, Dr.resolve(r)) : n.Ue.allocateTargetId(t).next((function(i) {
                return r = new Br(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.Ue.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
...
function to(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = j(t), o = n.kn.get(e), s = i ? "readwrite" : "readwrite-primary", r.label = 1;
              ...
              case 4:
                if (!Rr(u = r.sent())) throw u;
                // All `releaseTarget` does is record the final metadata state for the
                // target, but we've been recording this periodically during target
                // activity. If we lose this write this could cause a very slight
                // difference in the order of target deletion during GC, but we
                // don't define exact LRU semantics so this is acceptable.
                                return F("LocalStore", "Failed to update sequence numbers for target " + e + ": " + u), 
                [ 3 /*break*/ , 5 ];
 ...
 */ function eo(t, e, n) {
    var r = j(t), i = X.min(), o = ln();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = j(t), i = r.$n.get(n);
            return void 0 !== i ? Dr.resolve(r.kn.get(i)) : r.Ue.getTargetData(e, n);
        }(r, t, ae(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.Ue.getMatchingKeysForTargetId(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.xn.getDocumentsMatchingQuery(t, e, n ? i : X.min(), n ? o : ln());
        })).next((function(t) {
            return {
                documents: t,
                Bn: o
...
// PORTING NOTE: Multi-Tab only.
function no(t, e) {
    var n = j(t), r = j(n.Ue), i = n.kn.get(e);
...
function ro(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = j(t), i = sn(), o = Gr(n), s = Ri(e), u = IDBKeyRange.lowerBound(o, !0);
            return s.Ot({
...
function io(t) {
    return n(this, void 0, void 0, (function() {
        var e;
        return r(this, (function(n) {
            return [ 2 /*return*/ , (e = j(t)).persistence.runTransaction("Synchronize last document change read time", "readonly", (function(t) {
                return function(t) {
                    var e = Ri(t), n = X.min();
                    // If there are no existing entries, we return SnapshotVersion.min().
                        ...
                        e.readTime && (n = zr(e.readTime)), r.done();
                    })).next((function() {
                        return n;
                    }));
                }(t);
            ...
            switch (r.label) {
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return $i(t, d, u, X.min(), a).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
 ...
 */ function so(t, e, i) {
    return void 0 === i && (i = ln()), n(this, void 0, void 0, (function() {
        var n, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , Zi(t, ae(Jr(e.bundledQuery))) ];

              case 1:
                return n = r.sent(), [ 2 /*return*/ , (o = j(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    var r = xn(e.readTime);
                    // Simply save the query itself if it is older than what the SDK already
                    // has.
                                        if (n.snapshotVersion.compareTo(r) >= 0) return o.Ke.saveNamedQuery(t, e);
                    // Update existing target data because the query from the bundle is newer.
                                        var s = n.withResumeToken(ot.EMPTY_BYTE_STRING, r);
 ...
 */ var uo = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return Dr.resolve(this.Qn.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
        ...
        return Dr.resolve(this.jn.get(e));
    }, t.prototype.saveNamedQuery = function(t, e) {
    ...
    function t() {
        ...
        this.Wn = new nn(co.Gn), 
        // A set of outstanding references to a document sorted by target id.
        this.zn = new nn(co.Hn)
    ...
    t.prototype.Zn = function(t) {
        var e = this, n = new vt(new et([])), r = new co(n, t), i = new co(n, t + 1), o = [];
        ...
        var e = new vt(new et([])), n = new co(e, t), r = new co(e, t + 1), i = ln();
        return this.zn.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new co(t, 0), n = this.Wn.firstAfterOrEqual(e);
    ...
    return t.Gn = function(t, e) {
        return vt.comparator(t.key, e.key) || z(t.ns, e.ns);
    }, 
    /** Compare by ID then by key */ t.Hn = function(t, e) {
        return z(t.ns, e.ns) || vt.comparator(t.key, e.key);
    }, t;
}(), ho = /** @class */ function() {
    function t(t, e) {
        ...
        this.rs = new nn(co.Gn);
    }
    return t.prototype.checkEmpty = function(t) {
        return Dr.resolve(0 === this._n.length);
    }, t.prototype.addMutationBatch = function(t, e, n, r) {
        var i = this.ss;
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.rs = this.rs.add(new co(a.key, i)), this.qt.addToCollectionParentIndex(t, a.key.path.popLast());
        }
        return Dr.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return Dr.resolve(this.os(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        var n = e + 1, r = this.cs(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Dr.resolve(this._n.length > i ? this._n[i] : null);
    }, t.prototype.getHighestUnacknowledgedBatchId = function() {
        return Dr.resolve(0 === this._n.length ? -1 : this.ss - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        return Dr.resolve(this._n.slice());
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = new co(e, 0), i = new co(e, Number.POSITIVE_INFINITY), o = [];
        return this.rs.forEachInRange([ r, i ], (function(t) {
            var e = n.os(t.ns);
            o.push(e);
        })), Dr.resolve(o);
    }, t.prototype.getAllMutationBatchesAffectingDocumentKeys = function(t, e) {
        var n = this, r = new nn(z);
        return e.forEach((function(t) {
            var e = new co(t, 0), i = new co(t, Number.POSITIVE_INFINITY);
            n.rs.forEachInRange([ e, i ], (function(t) {
                r = r.add(t.ns);
            }));
        })), Dr.resolve(this.us(r));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        ...
        var o = new co(new vt(i), 0), s = new nn(z);
        ...
        var n = new co(e, 0), r = this.rs.firstAfterOrEqual(n);
        return Dr.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this._n.length, Dr.resolve();
    }, 
    /**
    ...
    function t(t, e) {
        ...
        this.docs = new Ze(vt.comparator), 
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return Dr.resolve(n ? n.document.clone() : Rt.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = sn();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.clone() : Rt.newInvalidDocument(t));
        })), Dr.resolve(r);
    }, t.prototype.getDocumentsMatchingQuery = function(t, e, n) {
        for (var r = sn(), i = new vt(e.path.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var s = o.getNext(), u = s.key, a = s.value, c = a.document, h = a.readTime;
            if (!e.path.isPrefixOf(u.path)) break;
            h.compareTo(n) <= 0 || de(e, c) && (r = r.insert(c.key, c.clone()));
        }
        return Dr.resolve(r);
...
}(Ai), po = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.ds = new Di((function(t) {
            return Pt(t);
        }), Mt), 
        ...
        /**
             ...
             * IDs.
             */
        this._s = new ao, this.targetCount = 0, this.gs = yi.Jt();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return Dr.resolve(this.ws);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.gs.next(), Dr.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        return this.te(e), this.targetCount += 1, Dr.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.te(e), Dr.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        ...
        return this._s.Jn(e, n), Dr.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this._s.Xn(e, n);
        ...
        return this._s.Zn(e), Dr.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this._s.es(e);
        return Dr.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return Dr.resolve(this._s.containsKey(e));
    }, t;
}(), yo = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        var n = this;
        this.ys = {}, this.Ne = new C(0), this.xe = !1, this.xe = !0, this.referenceDelegate = t(this), 
        this.Ue = new po(this), this.qt = new ni, this.qe = function(t, e) {
            return new fo(t, (function(t) {
                return n.referenceDelegate.ps(t);
            }));
        }(this.qt), this.R = new Kr(e), this.Ke = new uo(this.R);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
        ...
        return e || (e = new ho(this.qt, this.referenceDelegate), this.ys[t.toKey()] = e), 
        e;
    }, t.prototype.getTargetCache = function() {
        return this.Ue;
    }, t.prototype.getRemoteDocumentCache = function() {
        ...
        return Dr.or(Object.values(this.ys).map((function(n) {
            return function() {
    ...
    return t.Ps = function(e) {
        ...
        return this.As.addReference(n, e), this.bs.delete(n.toString()), Dr.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.As.removeReference(n, e), this.bs.add(n.toString()), Dr.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.bs.add(e.toString()), Dr.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return Dr.forEach(this.bs, (function(r) {
            var i = vt.fromPath(r);
        ...
        var n = this;
        return Dr.or([ function() {
            return Dr.resolve(n.As.containsKey(e));
        }, function() {
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function bo(t, e, n) {
 ...
 */
// Visible for testing
/** A user with a null UID. */ go.UNAUTHENTICATED = new go(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
go.GOOGLE_CREDENTIALS = new go("google-credentials-uid"), go.FIRST_PARTY = new go("first-party-uid");
...
var To = /** @class */ function() {
    ...
    return t.Vs = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = pn(), s = 0; i && s < r.activeTargetIds.length; ++s) i = yt(r.activeTargetIds[s]), 
    ...
    function t(t, e, n, r, i) {
        ...
        this.$s = new Ze(z), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Ms = wo(this.persistenceKey, this.Ns), 
        this.Fs = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.$s = this.$s.insert(this.Ns, new No), this.Ls = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.gt = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    for (t = r.sent(), e = 0, n = t; e < n.length; e++) (i = n[e]) !== this.Ns && (o = this.getItem(wo(this.persistenceKey, i))) && (s = So.Vs(i, o)) && (this.$s = this.$s.insert(s.clientId, s));
        ...
        // `Window.addEventListener`.
            ...
            if (F("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.Ms) return void V("Received WebStorage notification for local change. Another client might have garbage-collected our state");
                ...
                return n(e, void 0, void 0, (function() {
                    ...
                    return r(this, (function(r) {
                        if (this.started) {
                            if (null !== i.key) if (this.Ls.test(i.key)) {
                            ...
                            } else if (i.key === this.Fs) (u = function(t) {
                                var e = C.o;
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                ...
                                return e;
                            }(i.newValue)) !== C.o && this.sequenceNumberHandler(u); else if (i.key === this.Ks) return [ 2 /*return*/ , this.syncEngine.ci() ];
                        } else this.Os.push(i);
                        return [ 2 /*return*/ ];
                    }));
                }));
        ...
        var r = new To(this.currentUser, t, e, n), i = bo(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Ss());
    }, t.prototype.Hs = function(t) {
        var e = bo(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
        ...
        var r = Io(this.persistenceKey, t), i = new Eo(t, e, n);
        this.setItem(r, i.Ss());
    ...
    t.prototype.js = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine.ai(t.batchId, t.state, t.error) ] : (F("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    ...
    function t() {
        this.li = new No, this.fi = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.li = new No, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t(n, e), n.prototype.$i = function(t, e, n, r) {
            ...
            s.listenOnce(E.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case S.TIMEOUT:
                        F("Connection", 'RPC "' + t + '" timed out'), o(new O(R.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case S.HTTP_ERROR:
                        var n = s.getStatus();
                        if (F("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", s.getResponseText()), 
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new O(u, r.message));
                            } else o(new O(R.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new O(R.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var s = n.join("");
        F("Connection", "Creating WebChannel: " + s, o);
        var u = r.createWebChannel(s, o), a = !1, c = !1, h = new Ro({
            Ei: function(t) {
                c ? F("Connection", "Not sending because WebChannel is closed:", t) : (a || (F("Connection", "Opening WebChannel transport."), 
                u.open(), a = !0), F("Connection", "WebChannel sending:", t), u.send(t));
            },
            Ti: function() {
                return u.close();
            }
        ...
        return f(u, D.EventType.OPEN, (function() {
            c || F("Connection", "WebChannel transport opened.");
        })), f(u, D.EventType.CLOSE, (function() {
            c || (c = !0, F("Connection", "WebChannel transport closed"), h.Vi());
        })), f(u, D.EventType.ERROR, (function(t) {
            c || (c = !0, q("Connection", "WebChannel transport errored:", t), h.Vi(new O(R.UNAVAILABLE, "The operation could not be completed")));
        })), f(u, D.EventType.MESSAGE, (function(t) {
            var e;
            if (!c) {
                var n = t.data[0];
                K(!!n);
 ...
 */
                    ...
                    void 0 === s && (s = R.INTERNAL, a = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    c = !0, h.Vi(new O(s, a)), u.close();
                } else F("Connection", "WebChannel received:", n), h.Si(n);
            }
        })), f(i, A.STAT_EVENT, (function(t) {
            t.stat === k.PROXY ? F("Connection", "Detected buffering proxy") : t.stat === k.NOPROXY && F("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
...
/** The Platform's 'document' implementation or null if not available. */ function Po() {
 ...
 */ var Fo = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.Se = t, this.timerId = e, this.Fi = n, this.Li = r, this.Bi = i, this.Ui = 0, 
        this.qi = null, 
    ...
    t.prototype.ji = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && F("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Ui + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.Yi = 0, this.Xi = null, this.stream = null, this.Zi = new Fo(t, e)
        /**
    ...
    t.prototype.ur = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new O(R.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.dr(e);
            }));
        }));
    ...
    t.prototype.dr = function(t) {
        ...
        return F("PersistentStream", "close with error: " + t), this.stream = null, this.close(3 /* Error */ , t);
    }, 
    /**
    ...
    t.prototype.hr = function(t) {
        ...
        return function(n) {
            e.Se.enqueueAndForget((function() {
                return e.Yi === t ? n() : (F("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.I ? (K(void 0 === e || "string" == typeof e), ot.fromBase64String(e || "")) : (K(void 0 === e || e instanceof Uint8Array), 
                    ot.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), s = e.targetChange.cause, u = s && function(t) {
                    var e = void 0 === t.code ? R.UNKNOWN : Je(t.code);
                    return new O(e, t.message || "");
                }(s);
                n = new wn(r, i, o, u || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var a = e.documentChange;
                a.document, a.document.name, a.document.updateTime;
                var c = Ln(t, a.document.name), h = xn(a.document.updateTime), f = new xt({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), l = Rt.newFoundDocument(c, h, f), d = a.targetIds || [], p = a.removedTargetIds || [];
                n = new mn(d, p, l.key, l);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var y = e.documentDelete;
                y.document;
                var v = Ln(t, y.document), m = y.readTime ? xn(y.readTime) : X.min(), g = Rt.newNoDocument(v, m), w = y.removedTargetIds || [];
                n = new mn([], w, g.key, g);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var b = e.documentRemove;
                b.document;
                var I = Ln(t, b.document), T = b.removedTargetIds || [];
                n = new mn([], T, I, null);
            } else {
                ...
                var E = e.filter;
                E.targetId;
                var S = E.count || 0, _ = new Xe(S), N = E.targetId;
                n = new gn(N, _);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? X.min() : e.readTime ? xn(e.readTime) : X.min();
        }(t);
    ...
    n.prototype.mr = function(t) {
        var e = {};
        e.database = Fn(this.R), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = Ft(r) ? {
                documents: jn(t, r)
            } : {
                query: Qn(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = An(t, e.resumeToken) : e.snapshotVersion.compareTo(X.min()) > 0 && (
    ...
    n.prototype.gr = function(t) {
        var e = {};
        e.database = Fn(this.R), e.removeTarget = t, this.cr(e);
    }, n;
}(Vo), Uo = /** @class */ function(e) {
    function n(t, n, r, i, o) {
        var s = this;
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (K(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        var n = t.updateTime ? xn(t.updateTime) : xn(e);
                        ...
                        n = xn(e)), new Re(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
            }(t.writeResults, t.commitTime), n = xn(t.commitTime);
    ...
    n.prototype.Ar = function() {
        ...
        var t = {};
        t.database = Fn(this.R), this.cr(t);
    }, 
    ...
    return t(n, e), n.prototype.Pr = function() {
        if (this.Rr) throw new O(R.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.Ni = function(t, e, n) {
        ...
        return this.Pr(), this.credentials.getToken().then((function(i) {
            ...
            throw "FirebaseError" === t.name ? (t.code === R.UNAUTHENTICATED && r.credentials.invalidateToken(), 
            t) : new O(R.UNKNOWN, t.toString());
        }));
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.Vr ? (V(e), this.Vr = !1) : F("OnlineStateTracker", e);
...
e, i, o, s) {
    ...
    /**
             ...
             */
    this.Fr = [], this.Lr = s, this.Lr.di((function(t) {
        i.enqueueAndForget((function() {
            return n(u, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return Jo(this) ? (F("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                var e;
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = j(t)).Mr.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Go(e) ];

                                      case 1:
                                        return n.sent(), e.Br.set("Unknown" /* Unknown */), e.Mr.delete(4 /* ConnectivityChange */), 
                                        [ 4 /*yield*/ , Qo(e) ];
 ...
 */ function Wo(t, e) {
    var n = j(t), r = ds(n);
    n.Or.delete(e), r.er() && Yo(n, e), 0 === n.Or.size && (r.er() ? r.ir() : Jo(n) && 
...
function $o(t) {
    return Jo(t) && !ds(t).tr() && t.Or.size > 0;
}

function Jo(t) {
    return 0 === j(t).Mr.size;
}
...
function ns(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t.Br.set("Online" /* Online */), !(e instanceof wn && 2 /* Removed */ === e.state && e.cause)) 
              ...
              case 3:
                return o = a.sent(), F("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), o), 
                [ 4 /*yield*/ , rs(t, o) ];
              ...
              case 6:
                if (e instanceof mn ? t.Ur.X(e) : e instanceof gn ? t.Ur.rt(e) : t.Ur.et(e), i.isEqual(X.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;

              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , Yi(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            // state.
                            t.Or.set(e, n.withResumeToken(ot.EMPTY_BYTE_STRING, n.snapshotVersion)), 
                            ...
                            var r = new Br(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            Ho(t, r);
                        }
              ...
              case 11:
                return F("RemoteStore", "Failed to raise snapshot:", u = a.sent()), [ 4 /*yield*/ , rs(t, u) ];
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.Mr.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Go(t) ];
                    ...
                    return n(o, void 0, void 0, (function() {
                        return r(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Mr.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Qo(t) ];
...
function os(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                e = j(t), n = ps(e), i = e.$r.length > 0 ? e.$r[e.$r.length - 1].batchId : -1, r.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return r.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , Ji(e.localStore, i) ];
              ...
              case 4:
                return s = r.sent(), [ 4 /*yield*/ , rs(e, s) ];
...
function ss(t) {
    return Jo(t) && !ps(t).tr() && t.$r.length > 0;
}
...
function cs(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            ...
            for (e = ps(t), n = 0, i = t.$r; n < i.length; n++) o = i[n], e.Er(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function hs(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = t.$r.shift(), o = Ur.from(n, e, i), [ 4 /*yield*/ , is(t, (function() {
...
function fs(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(i) {
            switch (i.label) {
              case 0:
                return e && ps(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                return $e(i = e.code) && i !== R.ABORTED ? (n = t.$r.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                ps(t).sr(), [ 4 /*yield*/ , is(t, (function() {
 ...
 */ function ls(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = j(t), e ? (n.Mr.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Qo(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return r.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (i = e) ? [ 3 /*break*/ , 4 ] : (n.Mr.add(2 /* IsSecondary */), [ 4 /*yield*/ , Go(n) ]);

              case 3:
                r.sent(), i = n.Br.set("Unknown" /* Unknown */), r.label = 4;
 ...
 */ function ds(t) {
    ...
    t.qr = function(t, e, n) {
        var r = j(t);
        return r.Pr(), new qo(e, r.Hi, r.credentials, r.R, n);
    }(t.datastore, t.asyncQueue, {
        Ii: ts.bind(null, t),
        Ri: es.bind(null, t),
        _r: ns.bind(null, t)
    }), t.Fr.push((function(i) {
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.qr.sr(), $o(t) ? Xo(t) : t.Br.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
...
function ps(t) {
    ...
    t.Kr = function(t, e, n) {
        var r = j(t);
        return r.Pr(), new Uo(e, r.Hi, r.credentials, r.R, n);
    }(t.datastore, t.asyncQueue, {
        Ii: as.bind(null, t),
        Ri: fs.bind(null, t),
        Ir: cs.bind(null, t),
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.Kr.sr(), [ 4 /*yield*/ , os(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 3:
                    e.sent(), t.$r.length > 0 && (F("RemoteStore", "Stopping write stream with " + t.$r.length + " pending writes"), 
                    t.$r = []), e.label = 4;
...
var ys = /** @class */ function() {
    function t(t, e, n, r, i) {
        ...
        this.deferred = new Nr, this.then = this.deferred.promise.then.bind(this.deferred.promise), 
    ...
    t.prototype.cancel = function(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new O(R.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
 ...
 */ function vs(t, e) {
    if (V("AsyncQueue", e + ": " + t), Rr(t)) return new O(R.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var ms = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.comparator = t ? function(e, n) {
            return t(e, n) || vt.comparator(e.key, n.key);
        } : function(t, e) {
            return vt.comparator(t.key, e.key);
        }, this.keyedMap = an(), this.sortedSet = new Ze(this.comparator)
        /**
    ...
    this.queries = new Di((function(t) {
        return fe(t);
    }), he), this.onlineState = "Unknown" /* Unknown */ , this.Gr = new Set;
};
 ...
 */ function Ts(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (n = j(t), i = e.query, o = !1, (s = n.queries.get(i)) || (o = !0, s = new bs), 
                !o) return [ 3 /*break*/ , 4 ];
                r.label = 1;
              ...
              case 3:
                return a = r.sent(), c = vs(a, "Initialization of query '" + le(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(c) ];

              case 4:
                return n.queries.set(i, s), s.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.zr(n.onlineState), s.Wr && e.Hr(s.Wr) && Ns(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
...
function Es(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o, s, u;
        return r(this, (function(r) {
            return n = j(t), i = e.query, o = !1, (s = n.queries.get(i)) && (u = s.listeners.indexOf(e)) >= 0 && (s.listeners.splice(u, 1), 
 ...
 */ var Ds = /** @class */ function() {
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.zr = function(t) {
        ...
        t = ws.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Yr = !0, 
        this.Jr.next(t);
    }, t;
}(), As = /** @class */ function() {
    function t(t, 
    ...
    t.prototype.qn = function(t) {
        return t.metadata.exists ? Un(this.R, t.document, !1) : Rt.newNoDocument(this.Un(t.metadata.name), this.Kn(t.metadata.readTime));
    ...
    function t(t, e, n) {
        ...
        this.documents = [], this.progress = Cs(t)
        /**
    ...
    t.prototype.complete = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , oo(this.localStore, new ks(this.R), this.documents, this.ro.id) ];
                  ...
                  case 5:
                    return [ 2 /*return*/ , (this.progress.taskState = "Success", new Bi(Object.assign({}, this.progress), t)) ];
                }
            }));
        }));
    }, t;
 ...
 */ var Rs = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = ln(), this.lo = pe(t), this.fo = new ms(this.lo);
    }
    ...
    t.prototype._o = function(t, e) {
        var n = this, r = e ? e.mo : new gs, i = e ? e.fo : this.fo, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, u = !1, a = ne(this.query) && i.size === this.query.limit ? i.last() : null, c = re(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var h = i.get(t), f = de(n.query, e) ? e : null, l = !!h && n.mutatedKeys.has(h.key), d = !!f && (f.hasLocalMutations || 
            ...
            o = o.delete(t)));
        })), ne(this.query) || re(this.query)) for (;s.size > this.query.limit; ) {
            var h = ne(this.query) ? s.last() : s.first();
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        return this.uo = u, 0 !== o.length || a ? {
            snapshot: new ws(this.query, t.fo, i, o, t.mutatedKeys, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            To: s
        } : {
            To: s
    ...
    t.prototype.po = function(t) {
        ...
        // updating many documents.
                var e = this.ho;
        this.ho = ln(), this.fo.forEach((function(e) {
            t.Io(e.key) && (t.ho = t.ho.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.ho.has(e) || n.push(new Os(e));
    ...
    t.prototype.Ro = function() {
        return ws.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 /* Local */ === this.uo);
    }, t;
}(), Ps = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.bo = {}, this.vo = new Di((function(t) {
            return fe(t);
        }), he), this.Vo = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.Do = new Ze(vt.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.Co = new Map, this.No = new ao, 
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return [ 4 /*yield*/ , Zi(n.localStore, ae(e)) ];

              case 2:
                return u = r.sent(), a = n.sharedClientState.addLocalQueryTarget(u.targetId), i = u.targetId, 
                [ 4 /*yield*/ , qs(n, e, i, "current" === a) ];

              case 3:
                o = r.sent(), n.isPrimaryClient && zo(n.remoteStore, u), r.label = 4;
                    ...
                    return function(t, e, i, o) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = e.view._o(i), n.Nn ? [ 4 /*yield*/ , eo(t.localStore, e.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, s), [ 2 /*return*/ , (Js(t, e.targetId, u.To), 
                                    u.snapshot) ];
                                }
                            }));
                        }));
                    }(t, e, i, o);
                }, [ 4 /*yield*/ , eo(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return s = l.sent(), u = new Ls(e, s.Bn), a = u._o(s.documents), c = vn.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = u.applyChanges(a, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), Js(t, i, h.To), f = new Ps(e, i, u), 
...
/** Stops listening to the query. */ function Us(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = j(t), i = n.vo.get(e), (o = n.Vo.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (n.Vo.set(i.targetId, o.filter((function(t) {
                    return !he(t, e);
                }))), void n.vo.delete(e)) ] : n.isPrimaryClient ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                n.sharedClientState.removeLocalQueryTarget(i.targetId), n.sharedClientState.isActiveQueryTarget(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , to(n.localStore, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(i.targetId), Wo(n.remoteStore, i.targetId), 
                    Xs(n, i.targetId);
                })).catch(bi) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return Xs(n, i.targetId), [ 4 /*yield*/ , to(n.localStore, i.targetId, 
            ...
            switch (r.label) {
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Fn.pn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                var c = a[u], h = Ve(c, n.get(c.key));
                                null != h && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                s.push(new Ke(c.key, h, Ct(h.toProto().mapValue), Oe.exists(!0)));
                            }
              ...
              case 2:
                return o = r.sent(), n.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    ...
                    r || (r = new Ze(z)), r = r.insert(e, n), t.xo[t.currentUser.toKey()] = r;
                }(n, o.batchId, i), [ 4 /*yield*/ , eu(n, o.changes) ];

              case 3:
                return r.sent(), [ 4 /*yield*/ , os(n.remoteStore) ];

              case 4:
                return r.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return s = r.sent(), u = vs(s, "Failed to persist write"), i.reject(u), [ 3 /*break*/ , 6 ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (n = j(t)).sharedClientState.updateQueryState(e, "rejected", i), o = n.Co.get(e), 
                (s = o && o.key) ? (u = (u = new Ze(vt.comparator)).insert(s, Rt.newNoDocument(s, X.min())), 
                a = ln().add(s), c = new yn(X.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new nn(z), u, a), [ 4 /*yield*/ , Ks(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.Do = n.Do.remove(s), n.Co.delete(e), tu(n), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , to(n.localStore, e, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return Xs(n, e, i);
                })).catch(bi) ];
...
function Gs(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = j(t), i = e.batch.batchId, r.label = 1;

              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Hi(n.localStore, e) ];
              ...
              case 2:
                ...
                Ys(n, i, /*error=*/ null), Hs(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , eu(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                ...
                // listen events.
                Ys(n, e, i), Hs(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , eu(n, o) ];
 ...
 */ function Ws(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                Jo((n = j(t)).remoteStore) || F("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                r.label = 1;
              ...
              case 3:
                return s = r.sent(), u = vs(s, "Initialization of waitForPendingWrites() operation failed"), 
...
function Ys(t, e, n) {
    var r = j(t), i = r.xo[r.currentUser.toKey()];
...
function $s(t, e) {
    ...
    var n = t.Do.get(e);
    null !== n && (Wo(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), tu(t));
}

function Js(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Rs ? (t.No.addReference(o.key, e), Zs(t, o)) : o instanceof Os ? (F("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function Zs(t, e) {
    ...
    t.Do.get(n) || t.So.has(r) || (F("SyncEngine", "New document in limbo: " + n), t.So.add(r), 
    tu(t));
}
 ...
 */ function tu(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        var n = new vt(et.fromString(e)), r = t.$o.next();
        t.Co.set(r, new Ms(n)), t.Do = t.Do.insert(n, r), zo(t.remoteStore, new Br(ae(ee(n.path)), r, 2 /* LimboResolution */ , C.o));
    }
}
...
function eu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = j(t), s = [], u = [], a = [], o.vo.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.vo.forEach((function(t, n) {
                    a.push(o.Mo(n, e, i).then((function(t) {
                        if (t) {
                            o.isPrimaryClient && o.sharedClientState.updateQueryState(n.targetId, t.fromCache ? "not-current" : "current"), 
                            s.push(t);
                            var e = ji.vn(n.targetId, t);
                            u.push(e);
                        }
                    })));
                            ...
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return Dr.forEach(e, (function(e) {
                                        return Dr.forEach(e.Pn, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return Dr.forEach(e.bn, (function(r) {
...
function nu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return (n = j(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (F("SyncEngine", "User change. New user:", e.toKey()), 
                [ 4 /*yield*/ , Wi(n.localStore, e) ]);
              ...
              case 1:
                ...
                function(t, e) {
                    t.ko.forEach((function(t) {
                        t.forEach((function(t) {
                            t.reject(new O(R.CANCELLED, "'waitForPendingWrites' promise is rejected due to a user change."));
                        }));
                    })), t.ko.clear();
                }(n), 
                // TODO(b/114226417): Consider calling this only in the primary tab.
                n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , eu(n, i.Ln) ];
...
function ru(t, e) {
    var n = j(t), r = n.Co.get(e);
    if (r && r.Po) return ln().add(r.key);
    var i = ln(), o = n.Vo.get(e);
    if (!o) return i;
 ...
 */ function iu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , eo((n = j(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = r.sent(), o = e.view.Ao(i), [ 2 /*return*/ , (n.isPrimaryClient && Js(n, e.targetId, o.To), 
                o) ];
            }
        }));
    }));
...
function ou(t) {
    return n(this, void 0, void 0, (function() {
        var e;
        return r(this, (function(n) {
            return [ 2 /*return*/ , ro((e = j(t)).localStore).then((function(t) {
                return eu(e, t);
            })) ];
        }));
    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.jt(t, e).next((function(e) {
                            return e ? n.Fn.pn(t, e) : Dr.resolve(null);
                        }));
                    }));
                }((n = j(t)).localStore, e) ];

              case 1:
                return null === (s = r.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , os(n.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                Ys(n, e, o || null), Hs(n, e), function(t, e) {
                    j(j(t)._n).Gt(e);
                }(n.localStore, e)) : B(), r.label = 4;

              case 4:
                return [ 4 /*yield*/ , eu(n, s) ];
              ...
              case 6:
                ...
                // as applicable.
                F("SyncEngine", "Cannot apply mutation batch with id: " + e), r.label = 7;
...
function uu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return du(n = j(t)), pu(n), !0 !== e || !0 === n.Oo ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , au(n, i.toArray()) ]);

              case 1:
                return o = r.sent(), n.Oo = !0, [ 4 /*yield*/ , ls(n.remoteStore, !0) ];

              case 2:
                for (r.sent(), s = 0, u = o; s < u.length; s++) a = u[s], zo(n.remoteStore, a);
                return [ 3 /*break*/ , 7 ];
              ...
              case 3:
                ...
                n.Vo.forEach((function(t, e) {
                    n.sharedClientState.isLocalQueryTarget(e) ? c.push(e) : h = h.then((function() {
                        return Xs(n, e), to(n.localStore, e, 
                        /*keepPersistedTargetData=*/ !0);
                    })), Wo(n.remoteStore, e);
                })), [ 4 /*yield*/ , h ]);
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.Co.forEach((function(t, n) {
                        Wo(e.remoteStore, n);
                    })), e.No.ts(), e.Co = new Map, e.Do = new Ze(vt.comparator);
                }(n), n.Oo = !1, [ 4 /*yield*/ , ls(n.remoteStore, !1) ];
...
function au(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = j(t), i = [], o = [], s = 0, u = e, r.label = 1;

              case 1:
                return s < u.length ? (a = u[s], c = void 0, (h = n.Vo.get(a)) && 0 !== h.length ? [ 4 /*yield*/ , Zi(n.localStore, ae(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return f < l.length ? (d = l[f], p = n.vo.get(d), [ 4 /*yield*/ , iu(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , no(n.localStore, a) ];

              case 8:
                return v = r.sent(), [ 4 /*yield*/ , Zi(n.localStore, v) ];

              case 9:
                return c = r.sent(), [ 4 /*yield*/ , qs(n, cu(v), a, 
                /*current=*/ !1) ];
...
function hu(t) {
    var e = j(t);
    return j(j(e.localStore).persistence).fn();
}
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                F("SyncEngine", "Ignoring unexpected query state notification."), [ 3 /*break*/ , 8 ]) : [ 3 /*break*/ , 1 ];
              ...
              case 2:
                return [ 4 /*yield*/ , ro(n.localStore) ];

              case 3:
                return s = r.sent(), u = yn.createSynthesizedRemoteEventForCurrentChange(e, "current" === i), 
                [ 4 /*yield*/ , eu(n, s, u) ];
              ...
              case 6:
                return r.sent(), Xs(n, e, o), [ 3 /*break*/ , 8 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function lu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, o, s, u, a, c, h, f, l, d;
        return r(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(n = du(t)).Oo) return [ 3 /*break*/ , 10 ];
                o = 0, s = e, p.label = 1;

              case 1:
                return o < s.length ? (u = s[o], n.Vo.has(u) ? (
                // A target might have been added in a previous attempt
                F("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , no(n.localStore, u) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = p.sent(), [ 4 /*yield*/ , Zi(n.localStore, a) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , qs(n, cu(a), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                p.sent(), zo(n.remoteStore, c), p.label = 5;
              ...
              case 6:
                h = function(t) {
                    return r(this, (function(e) {
                        switch (e.label) {
                          case 0:
                            return n.Vo.has(t) ? [ 4 /*yield*/ , to(n.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                Wo(n.remoteStore, t), Xs(n, t);
                            })).catch(bi) ] : [ 3 /*break*/ , 2 ];
...
function du(t) {
    var e = j(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Ks.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = ru.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = Qs.bind(null, e), e.bo._r = Ss.bind(null, e.eventManager), 
    e.bo.Fo = _s.bind(null, e.eventManager), e;
}

function pu(t) {
    var e = j(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = Gs.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = zs.bind(null, e), 
    e
    /**
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 4:
                    return i._updateProgress(Cs(n)), o = new xs(n, t.localStore, e.R), [ 4 /*yield*/ , e.Lo() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return a = r.sent(), [ 4 /*yield*/ , eu(t, a.wn, 
                    /* remoteEvent */ void 0) ];
...
var vu = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.R = Mo(t.databaseInfo.databaseId), this.sharedClientState = this.Bo(t), 
        ...
        return zi(this.persistence, new Qi, t.initialUser, this.R);
    }, t.prototype.Uo = function(t) {
        return new yo(mo.Ps, this.R);
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.sent(), [ 4 /*yield*/ , io(this.localStore) ];
                  ...
                  case 3:
                    ...
                    return n.sent(), [ 4 /*yield*/ , pu(this.Qo.syncEngine) ];

                  case 4:
                    // Enqueue writes from a previous session
                    return n.sent(), [ 4 /*yield*/ , os(this.Qo.remoteStore) ];
        ...
        var e = Ui(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? ui.withCacheSize(this.cacheSizeBytes) : ui.DEFAULT;
        return new Fi(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Lo(), Po(), this.R, this.sharedClientState, !!this.forceOwnership);
    }, i.prototype.Bo = function(t) {
        return new Ao;
    }, i;
}(vu), gu = /** @class */ function(e) {
    function i(t, n) {
        var r = this;
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this.Qo.syncEngine, this.sharedClientState instanceof Do ? (this.sharedClientState.syncEngine = {
                        ai: su.bind(null, i),
                        ui: fu.bind(null, i),
                        hi: lu.bind(null, i),
                        fn: hu.bind(null, i),
                    ...
                    return [ 4 /*yield*/ , this.persistence.He((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , uu(this.Qo.syncEngine, t) ];
        ...
        var e = Lo();
        if (!Do.gt(e)) throw new O(R.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = Ui(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new Do(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(mu), wu = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return js(n.syncEngine, t, 1 /* SharedClientState */);
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = nu.bind(null, this.syncEngine), 
                    [ 4 /*yield*/ , ls(this.remoteStore, this.syncEngine.isPrimaryClient) ]);
        ...
        var e, n = Mo(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Oo(e));
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return js(s.syncEngine, t, 0 /* RemoteStore */);
        }, o = xo.gt() ? new xo : new ko, new jo(e, n, r, i, o);
        ...
        return function(t) {
            return n(this, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = j(t), F("RemoteStore", "RemoteStore shutting down."), e.Mr.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , Go(e) ];
 ...
 */ var Iu = /** @class */ function() {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 2:
                    return i = r.sent(), [ 2 /*return*/ , new As(JSON.parse(i), t.length + n) ];
                }
            }));
        }));
    }, 
    ...
    return t.prototype.lookup = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new O(R.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            var n, i, o, s, u, a;
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = j(t), i = Fn(n.R) + "/documents", o = {
                                    ...
                                    return s = r.sent(), u = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Ln(t, e.found.name), r = xn(e.found.updateTime), i = new xt({
                                                    mapValue: {
                                                        fields: e.found.fields
                                                    }
                                                });
                                                return Rt.newFoundDocument(n, r, i);
                                            }(t, e) : "missing" in e ? function(t, e) {
                                                K(!!e.missing), K(!!e.readTime);
                                                var n = Ln(t, e.missing), r = xn(e.readTime);
                                                return Rt.newNoDocument(n, r);
                                            }(t, e) : B();
                                        }(n.R, t);
            ...
            return r(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = vt.fromPath(n);
                        e.mutations.push(new Ye(r, e.precondition(r)));
        ...
        if (n) {
            ...
            throw new O(R.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.preconditionForUpdate = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new O(R.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    function t(t, e, n, r) {
        ...
        this.ec = 5, this.Zi = new Fo(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.Zi.ji((function() {
            return n(t, void 0, void 0, (function() {
                var t, e, n = this;
                return r(this, (function(r) {
                    return t = new Eu(this.datastore), (e = this.sc(t)) && e.then((function(e) {
        ...
        if ("FirebaseError" === t.name) {
            ...
            var e = t.code;
            return "aborted" === e || "failed-precondition" === e || !$e(e);
        }
        return !1;
    }, t;
}(), _u = /** @class */ function() {
    ...
    e, i) {
        var o = this;
        this.credentials = t, this.asyncQueue = e, this.databaseInfo = i, this.user = go.UNAUTHENTICATED, 
        this.clientId = G.u(), this.credentialListener = function() {
            return Promise.resolve();
            ...
            return n(o, void 0, void 0, (function() {
                return r(this, (function(e) {
                    switch (e.label) {
                      case 0:
                        return F("FirestoreClient", "Received user=", t.uid), [ 4 /*yield*/ , this.credentialListener(t) ];
    ...
    t.prototype.verifyNotTerminated = function() {
        if (this.asyncQueue.isShuttingDown) throw new O(R.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.terminate = function() {
        var t = this;
            ...
            return n(t, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = vs(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
                ...
                return u.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return n(s, void 0, void 0, (function() {
                        return r(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Wi(e.localStore, t) ];
...
function Du(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , Au(t) ];

              case 1:
                return i = s.sent(), F("FirestoreClient", "Initializing OnlineComponentProvider"), 
                [ 4 /*yield*/ , t.getConfiguration() ];
                    ...
                    return function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return (n = j(t)).asyncQueue.verifyOperationInProgress(), F("RemoteStore", "RemoteStore received new credentials"), 
                                    i = Jo(n), 
                                    // Tear down and re-create our network streams. This will ensure we get a
                                    // fresh auth token for the new user and re-fill the write pipeline with
                                    // new mutations from the LocalStore (since mutations are per-user).
                                    n.Mr.add(3 /* CredentialChange */), [ 4 /*yield*/ , Go(n) ];
                                  ...
                                  case 2:
                                    return r.sent(), n.Mr.delete(3 /* CredentialChange */), [ 4 /*yield*/ , Qo(n) ];
...
function Au(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.offlineComponents ? [ 3 /*break*/ , 2 ] : (F("FirestoreClient", "Using default OfflineComponentProvider"), 
                [ 4 /*yield*/ , Nu(t, new vu) ]);
...
function ku(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.onlineComponents ? [ 3 /*break*/ , 2 ] : (F("FirestoreClient", "Using default OnlineComponentProvider"), 
                [ 4 /*yield*/ , Du(t, new wu) ]);
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = Vs.bind(null, e.syncEngine), 
                n.onUnlisten = Us.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function Pu(t, e, i) {
    var o = this;
    void 0 === i && (i = {});
    var s = new Nr;
                    ...
                    return n = function(t, e, n, r, i) {
                        var o = new Iu({
                            next: function(o) {
                                ...
                                i.reject(new O(R.UNAVAILABLE, "Failed to get document because the client is offline.")) : u && o.fromCache && r && "server" === r.source ? i.reject(new O(R.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(o);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
                        }), s = new Ds(ee(n.path), o, {
                    ...
                    return n = function(t, e, n, r, i) {
                        var o = new Iu({
                            next: function(n) {
                                ...
                                e.enqueueAndForget((function() {
                                    return Es(t, s);
                                })), n.fromCache && "server" === r.source ? i.reject(new O(R.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
...
function(t, e, n, r, i, o, s) {
    ...
    function t(t) {
        var e = this;
        /** Tracks the current User. */        this.currentUser = go.UNAUTHENTICATED, 
        ...
        var n = function(t) {
            F("FirebaseCredentialsProvider", "Auth detected"), e.auth = t, e.lc(), e.auth.addAuthTokenListener(e.uc);
        };
        t.onInit((function(t) {
            return n(t);
        })), 
        ...
        setTimeout((function() {
            if (!e.auth) {
                ...
                // with null token
                F("FirebaseCredentialsProvider", "Auth not yet detected"), e.asyncQueue.enqueueRetryable((function() {
                    return e.changeListener(e.currentUser);
                })));
            }
        }), 0);
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.cc !== e ? (F("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (K("string" == typeof n.accessToken), new Uu(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.hc = function() {
        ...
        return K(null === t || "string" == typeof t), new go(t);
    }, 
    /**
    ...
    function t(t, e, n) {
        this.fc = t, this.dc = e, this.wc = n, this.type = "FirstParty", this.user = go.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Qu(this.fc, this.dc, this.wc));
    }, t.prototype.setChangeListener = function(t, e) {
        // Fire with initial uid.
        t.enqueueRetryable((function() {
            return e(go.FIRST_PARTY);
        }));
 ...
 */
function zu(t, e, n) {
    if (!n) throw new O(R.INVALID_ARGUMENT, "Function " + t + "() cannot be called with an empty " + e + ".");
}
 ...
 */ function Wu(t) {
    if (!vt.isDocumentKey(t)) throw new O(R.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function Hu(t) {
    if (vt.isDocumentKey(t)) throw new O(R.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function Yu(t) {
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new O(R.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = Yu(t);
        throw new O(R.INVALID_ARGUMENT, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function $u(t, e) {
    if (e <= 0) throw new O(R.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */ var Ju = /** @class */ function() {
    function t(t) {
        ...
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new O(R.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
        function(t, e, n, r) {
            if (!0 === e && !0 === r) throw new O(R.INVALID_ARGUMENT, "experimentalForceLongPolling and experimentalAutoDetectLongPolling cannot be used together.");
    ...
    function t(t, e) {
        ...
        this._settingsFrozen = !1, t instanceof Vu ? (this._databaseId = t, this._credentials = new Bu) : (this._app = t, 
        this._databaseId = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new O(R.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
            return new Vu(t.options.projectId);
        }(t), this._credentials = new ju(e));
    }
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this._app) throw new O(R.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this._app;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this._settingsFrozen) throw new O(R.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this._settings = new Ju(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new Bu;
            switch (t.type) {
              case "gapi":
                var e = t.client;
                ...
                new Gu(e, t.sessionIndex || "0", t.iamToken || null);
 ...
 */
        return t = this, (e = qu.get(t)) && (F("ComponentProvider", "Removing Datastore"), 
        qu.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}();
 ...
 */ function ta(t, e, n, r) {
    void 0 === r && (r = {});
    var i = (t = Xu(t, Zu))._getSettings();
    if ("firestore.googleapis.com" !== i.host && i.host !== e && q("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
    t._setSettings(Object.assign(Object.assign({}, i), {
        ...
        if (!s) throw new O(R.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
        t._credentials = new Ku(new Uu(o, new go(s)));
    }
}
 ...
 */ var ea = /** @class */ function() {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, ee(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.isEmpty() ? null : new ea(this.firestore, 
 ...
 */ function ia(t, n) {
    ...
    if (t = I(t), zu("collection", "path", n), t instanceof Zu) {
        var o = et.fromString.apply(et, e([ n ], r));
        return Hu(o), new ra(t, /* converter= */ null, o);
    }
    if (!(t instanceof ea || t instanceof ra)) throw new O(R.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = et.fromString.apply(et, e([ t.path ], r)).child(et.fromString(n));
    return Hu(s), new ra(t.firestore, 
    /* converter= */ null, s);
}
 ...
 */ function oa(t, e) {
    if (t = Xu(t, Zu), zu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new O(R.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new na(t, 
    /* converter= */ null, 
    /**
...
function sa(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = G.u()), zu("doc", "path", n), t instanceof Zu) {
        var o = et.fromString.apply(et, e([ n ], r));
        return Wu(o), new ea(t, 
        /* converter= */ null, new vt(o));
    }
    if (!(t instanceof ea || t instanceof ra)) throw new O(R.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(et.fromString.apply(et, e([ n ], r)));
    return Wu(s), new ea(t.firestore, t instanceof ra ? t.converter : null, new vt(s));
}
 ...
 * Firestore database.
 */ function ua(t, e) {
    return t = I(t), e = I(e), (t instanceof ea || t instanceof ra) && (e instanceof ea || e instanceof ra) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function aa(t, e) {
    return t = I(t), e = I(e), t instanceof na && e instanceof na && t.firestore === e.firestore && he(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var ca = /** @class */ function() {
    function t() {
        ...
        this.Zi = new Fo(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Ac = function() {
            var e = Po();
            e && F("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.Zi.Gi();
        };
        var e = Po();
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.Rc(), this.gc ? new Promise((function(t) {})) : this.Pc(t);
    }, t.prototype.enqueueRetryable = function(t) {
        var e = this;
        this.enqueueAndForget((function() {
            return e.mc.push(t), e.bc();
        }));
    }, 
    /**
    ...
    t.prototype.bc = function() {
        ...
        var e = this, n = this._c.then((function() {
            return e.Tc = !0, t().catch((function(t) {
                ...
                throw e.Ec = t, e.Tc = !1, V("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
        ...
        var i = ys.createAndSchedule(this, t, e, n, (function(t) {
            return r.vc(t);
        }));
...
var fa = /** @class */ function() {
    function t() {
        this._progressObserver = {}, this._taskCompletionResolver = new Nr, this._lastProgress = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
...
}(), la = -1, da = /** @class */ function(e) {
    /** @hideconstructor */
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, n) || this).type = "firestore", r._queue = new ca, r._persistenceKey = "name" in t ? t.name : "[DEFAULT]", 
        r;
    }
...
function pa(t, e) {
    ...
    if (n.isInitialized()) throw new O(R.FAILED_PRECONDITION, "Firestore can only be initialized once per app.");
    if (void 0 !== e.cacheSizeBytes && -1 !== e.cacheSizeBytes && e.cacheSizeBytes < 1048576) throw new O(R.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    return n.initialize({
        options: e
    });
}
...
function ma(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new Fu(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new _u(t._credentials, t._queue, r);
}
 ...
 */ function ga(t, e) {
    Aa(t = Xu(t, da));
    var n = va(t), r = t._freezeSettings(), i = new wu;
    return ba(n, i, new mu(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function wa(t) {
    Aa(t = Xu(t, da));
    var e = va(t), n = t._freezeSettings(), r = new wu;
    return ba(e, r, new gu(r, n.cacheSizeBytes));
}
    ...
    return t.asyncQueue.enqueue((function() {
        return n(o, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return r.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , Nu(t, i) ];

                  case 1:
                    return r.sent(), [ 4 /*yield*/ , Du(t, e) ];
         ...
         */
                    function(t) {
                        return "FirebaseError" === t.name ? t.code === R.FAILED_PRECONDITION || t.code === R.UNIMPLEMENTED : !("undefined" != typeof DOMException && t instanceof DOMException) || (22 === t.code || 20 === t.code || 
...
function Ia(t) {
    var e = this;
    if (t._initialized && !t._terminated) throw new O(R.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
    var i = new Nr;
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return kr.gt() ? (e = t + "main", [ 4 /*yield*/ , kr.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
                    ...
                    }(Ui(t._databaseId, t._persistenceKey)) ];
 ...
 */ function Ea(t) {
            ...
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return e = r.sent(), [ 4 /*yield*/ , Ru(t) ];

                      case 2:
                        return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = j(t);
                            return e.Mr.delete(0 /* UserDisabled */), Qo(e);
                        }(n)) ];
                    }
                }));
            }));
    ...
    /** Disables the network connection. Pending operations will not complete. */ (va(t = Xu(t, da)));
}
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = j(t)).Mr.add(0 /* UserDisabled */), [ 4 /*yield*/ , Go(e) ];
...
function Na(t, e) {
    var i = va(t = Xu(t, da)), o = new fa;
    return function(t, e, i, o) {
        var s = this, u = function(t, e) {
            return function(t, e) {
                return new Tu(t, e);
            }(function(t, e) {
                if (t instanceof Uint8Array) return bu(t, e);
                if (t instanceof ArrayBuffer) return bu(new Uint8Array(t), e);
...
function Da(t, e) {
    ...
    }(va(t = Xu(t, da)), e).then((function(e) {
        return e ? new na(t, null, e.query) : null;
    }));
}

function Aa(t) {
    if (t._initialized || t._terminated) throw new O(R.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ var ka = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new O(R.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
 ...
 */ var Ca = /** @class */ function() {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            ...
            throw new O(R.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
...
function(t) {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new O(R.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
...
}(), La = /^__.*__$/, Pa = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Ke(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Be(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Ma = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Va = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.kc = function(e) {
        ...
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.kc({
            path: n,
            Oc: !1
        });
        return r.Mc(t), r;
        ...
        return ic(t, this.settings.methodName, this.settings.Uc || !1, this.path, this.settings.qc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Fa(this.xc) && La.test(t)) throw this.Bc('Document fields cannot begin and end with "__"');
    }, t;
}(), qa = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.R = n || Mo(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.Kc = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Va({
            xc: t,
            methodName: e,
            qc: n,
            path: rt.emptyPath(),
 ...
 * classes.
 */ function Ua(t) {
    var e = t._freezeSettings(), n = Mo(t._databaseId);
    return new qa(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function Ba(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.Kc(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    tc("Data must be an object, but it was:", s, r);
    var u, a, c = Ja(r, s);
    if (o.merge) u = new it(s.fieldMask), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var d = ec(e, l[f], n);
            if (!s.contains(d)) throw new O(R.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            oc(h, d) || h.push(d);
        }
    ...
    return new Pa(new xt(c), u, a);
}

var Ka = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
...
var Qa = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        return new Ce(t.path, new Ee);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(Ra), Ga = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
}(Ra), Wa = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).jc = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new Ae(t.R, ge(t.R, this.jc));
...
/** Parse update data from an update() call. */ function Ha(t, e, n, r) {
    var i = t.Kc(1 /* Update */ , e, n);
    tc("Data must be an object, but it was:", i, r);
    var o = [], s = xt.empty();
    J(r, (function(t, r) {
        var u = rc(e, t, n);
...
/** Parse update data from a list of field/value arguments. */ function Ya(t, e, n, r, i, o) {
    var s = t.Kc(1 /* Update */ , e, n), u = [ ec(e, r, n) ], a = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) u.push(ec(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = xt.empty(), l = u.length - 1; l >= 0; --l) if (!oc(h, u[l])) {
        var d = u[l], p = a[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = I(p);
    ...
    var m = new it(h);
    return new Ma(f, m, s.fieldTransforms);
}
 ...
 */ function Xa(t, e, n, r) {
    return void 0 === r && (r = !1), $a(n, t.Kc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function $a(t, e) {
    ...
    // from firestore-exp.
    t = I(t))) return tc("Unsupported field value:", e, t), Ja(t, e);
    if (t instanceof Ra) 
    ...
    return function(t, e) {
        ...
        if (!Fa(e.xc)) throw e.Bc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return ge(e.R, t);
        ...
        if (t instanceof Y) {
            ...
            var r = new Y(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
                timestampValue: Dn(e.R, r)
            };
        }
        ...
        if (t instanceof ea) {
            ...
            if (!o.isEqual(i)) throw e.Bc("Document reference is for database " + o.projectId + "/" + o.database + " but should be for database " + i.projectId + "/" + i.database);
            return {
                referenceValue: Cn(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.Bc("Unsupported field value: " + Yu(t));
    }(t, e);
}
...
function Za(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof Y || t instanceof Oa || t instanceof Ca || t instanceof ea || t instanceof Ra);
}
 ...
 */ function ec(t, e, n) {
    ...
    // FieldPath.
    (e = I(e)) instanceof ka) return e._internalPath;
    if ("string" == typeof e) return rc(t, e);
    throw ic("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function rc(t, n, r) {
    if (n.search(nc) >= 0) throw ic("Invalid field path (" + n + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
        return (new (ka.bind.apply(ka, e([ void 0 ], n.split(".")))))._internalPath;
    } catch (e) {
        throw ic("Invalid field path (" + n + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
}
...
function ic(t, e, n, r, i) {
    ...
    a += ")"), new O(R.INVALID_ARGUMENT, (u += ". ") + t + a)
 ...
 */ var sc = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "id", {
         ...
         */
        get: function() {
            return new ea(this._firestore, this._converter, this._key);
        },
        enumerable: !1,
        configurable: !0
    }), 
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new uc(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(ac("DocumentSnapshot.get", t));
 ...
 */
function ac(t, e) {
    return "string" == typeof e ? rc(t, e) : e instanceof ka ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var cc = /** @class */ function() {
    ...
    n.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new fc(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    n.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(ac("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, n;
}(sc), fc = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    /**
...
}(hc), lc = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new cc(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new fc(n._firestore, n._userDataWriter, r.key, r, new cc(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
    ...
    t.prototype.docChanges = function(t) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new O(R.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    var r = new fc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new cc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new fc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new cc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 * limitations under the License.
 */ function yc(t) {
    if (re(t) && 0 === t.explicitOrderBy.length) throw new O(R.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var gc = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).Wc = t, i.Gc = n, i.zc = r, i.type = "where", 
        i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Ua(t.firestore), n = function(t, e, n, r, i, o, s) {
            var u;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new O(R.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || Oc(s, o), 
            u = Xa(n, "where", s, 
            /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
            var l = Vt.create(i, o, u);
            return function(t, e) {
                if (e.g()) {
                    var n = oe(t);
                    if (null !== n && !n.isEqual(e.field)) throw new O(R.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = ie(t);
                    null !== r && Lc(t, e.field, r);
                }
                var i = function(t, e) {
                    for (var n = 0, r = t.filters; n < r.length; n++) {
                        var i = r[n];
 ...
 */
                ...
                throw i === e.op ? new O(R.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new O(R.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, l), l;
        }(t._query, 0, e, t.firestore._databaseId, this.Wc, this.Gc, this.zc);
        return new na(t.firestore, t.converter, function(t, e) {
...
var bc = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Wc = t, r.Hc = n, r.type = "orderBy", r;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new O(R.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new O(R.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new Yt(e, n);
            return function(t, e) {
                if (null === ie(t)) {
                    // This is the first order by. It must match any inequality.
                    var n = oe(t);
                    null !== n && Lc(t, n, e.field);
                }
            }(t, r), r;
...
var Tc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        return new na(t.firestore, t.converter, ce(t._query, this.Jc, this.Yc));
    }, n;
}(vc);
 ...
 * @returns The created `Query`.
 */ function Ec(t) {
    return $u("limit", t), new Tc("limit", t, "F" /* First */)
    /**
...
function Sc(t) {
    return $u("limitToLast", t), new Tc("limitToLast", t, "L" /* Last */);
}
...
var _c = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Cc(t, this.type, this.Xc, this.Zc);
        return new na(t.firestore, t.converter, function(t, e) {
...
function Nc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new _c("startAt", t, /*before=*/ !0);
}

function Dc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new _c("startAfter", t, 
    /*before=*/ !1);
}
...
function kc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Ac("endBefore", t, /*before=*/ !0);
}

function xc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Ac("endAt", t, /*before=*/ !1);
}

/** Helper function to create a bound from a document or fields */ function Cc(t, e, n, r) {
    if (n[0] = I(n[0]), n[0] instanceof sc) return function(t, e, n, r, i) {
        if (!r) throw new O(R.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        // results.
        for (var o = [], s = 0, u = ue(t); s < u.length; s++) {
            var a = u[s];
            if (a.field.isKeyField()) o.push(St(e, r.key)); else {
                var c = r.data.field(a.field);
                if (ht(c)) throw new O(R.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var h = a.field.canonicalString();
                    throw new O(R.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    var i = Ua(t.firestore);
    return function(t, e, n, r, i, o) {
        // Use explicit order by's because it has to match the query the user made
        var s = t.explicitOrderBy;
        if (i.length > s.length) throw new O(R.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var u = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (s[a].field.isKeyField()) {
                if ("string" != typeof c) throw new O(R.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!se(t) && -1 !== c.indexOf("/")) throw new O(R.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(et.fromString(c));
                if (!vt.isDocumentKey(h)) throw new O(R.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var f = new vt(h);
                u.push(St(e, f));
            } else {
                var l = Xa(n, r, c);
...
function Rc(t, e, n) {
    if ("string" == typeof (n = I(n))) {
        if ("" === n) throw new O(R.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!se(e) && -1 !== n.indexOf("/")) throw new O(R.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(et.fromString(n));
        if (!vt.isDocumentKey(r)) throw new O(R.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return St(t, new vt(r));
    }
    if (n instanceof ea) return St(t, n._key);
    throw new O(R.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Yu(n) + ".");
}
 ...
 * array requirements.
 */ function Oc(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new O(R.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new O(R.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function Lc(t, e, n) {
    if (!n.isEqual(e)) throw new O(R.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
 ...
 */ var Pc = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new Oa(at(t.latitude), at(t.longitude));
        ...
        K(nr(n));
        var r = new Vu(n.get(1), n.get(3)), i = new vt(n.popFirst(5));
        return r.isEqual(e) || 
...
var Fc = /** @class */ function(e) {
...
}(Pc), Vc = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = Ua(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = qc(t, this._firestore), i = Mc(r.converter, e, n), o = Ba(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, Oe.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, s = qc(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof ka ? Ya(this._dataReader, "WriteBatch.update", s._key, e, n, r) : Ha(this._dataReader, "WriteBatch.update", s._key, e), 
        this._mutations.push(o.toMutation(s._key, Oe.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.commit = function() {
        ...
        if (this._committed) throw new O(R.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();
 ...
 * called.
 */ function qc(t, e) {
    if ((t = I(t)).firestore !== e) throw new O(R.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function Uc(t) {
    t = Xu(t, ea);
    var e = Xu(t.firestore, da);
    return Pu(va(e), t._key).then((function(n) {
        return th(e, t, n);
    }));
}
 ...
 */ function Kc(t) {
    t = Xu(t, ea);
    var e = Xu(t.firestore, da), i = va(e), o = new Bc(e);
    return function(t, e) {
        var i = this, o = new Nr;
        return t.asyncQueue.enqueueAndForget((function() {
            return n(i, void 0, void 0, (function() {
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 1:
                                        return (n = r.sent()).isFoundDocument() ? i.resolve(n) : n.isNoDocument() ? i.resolve(null) : i.reject(new O(R.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                        [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return o = r.sent(), s = vs(o, "Failed to get document '" + e + " from cache"), 
        ...
        return new hc(e, o, t._key, n, new cc(null !== n && n.hasLocalMutations, 
 ...
 */ function Qc(t) {
    t = Xu(t, na);
    var e = Xu(t.firestore, da), n = va(e), r = new Bc(e);
    return yc(t._query), Mu(n, t._query).then((function(n) {
                        ...
                        return i = function(t, e, i) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      case 0:
                                        return r.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , eo(t, e, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return n = r.sent(), o = new Ls(e, n.Bn), s = o._o(n.documents), u = o.applyChanges(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(u.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = r.sent(), c = vs(a, "Failed to execute query '" + e + " against cache"), 
...
function Wc(t, e, n) {
    t = Xu(t, ea);
    var r = Xu(t.firestore, da), i = Mc(t.converter, e, n);
    return Zc(r, [ Ba(Ua(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Oe.none()) ]);
}

function Hc(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = Xu(t, ea);
    var o = Xu(t.firestore, da), s = Ua(o);
    return Zc(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof ka ? Ya(s, "updateDoc", t._key, e, n, r) : Ha(s, "updateDoc", t._key, e)).toMutation(t._key, Oe.exists(!0)) ]);
}
 ...
 */ function Yc(t) {
    return Zc(Xu(t.firestore, da), [ new He(t._key, Oe.none()) ]);
}
 ...
 */ function Xc(t, e) {
    var n = Xu(t.firestore, da), r = sa(t), i = Mc(t.converter, e);
    return Zc(n, [ Ba(Ua(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, Oe.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function $c(t) {
    ...
    "object" != typeof s[c] || ha(s[c]) || (a = s[c], c++);
    var h, f, l, d = {
    ...
    if (t instanceof ea) f = Xu(t.firestore, da), l = ee(t._key.path), h = {
        next: function(e) {
            s[c] && s[c](th(f, t, e));
        },
        error: s[c + 1],
        ...
        var y = Xu(t, na);
        f = Xu(y.firestore, da), l = y._query;
        var v = new Bc(f);
        h = {
            next: function(t) {
                s[c] && s[c](new lc(f, v, y, t));
            },
            error: s[c + 1],
            complete: s[c + 2]
        }, yc(t._query);
    ...
    return function(t, e, i, o) {
        var s = this, u = new Iu(o), a = new Ds(e, u, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
 ...
 */ function th(t, e, n) {
    var r = n.docs.get(e._key), i = new Bc(t);
    return new hc(t, i, e._key, r, new cc(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var eh = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = qc(t, this._firestore), i = new Bc(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new hc(n._firestore, i, r._key, t._document, new cc(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = Ua(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = qc(t, this._firestore), r = new Fc(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return B();
            var i = t[0];
            if (i.isFoundDocument()) return new sc(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new sc(e._firestore, r, n._key, null, n.converter);
            throw B();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = qc(t, this._firestore), i = Mc(r.converter, e, n), o = Ba(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof ka ? Ya(this._dataReader, "Transaction.update", s._key, e, n, r) : Ha(this._dataReader, "Transaction.update", s._key, e), 
            ...
            return n(i, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return n = r.sent(), new Su(t.asyncQueue, n, e, o).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), o.promise;
 ...
 * writes.
 */ function ah(t) {
    return va(t = Xu(t, da)), new Vc(t, (function(e) {
        return Zc(t, e);
    }))
    /**
 * Cloud Firestore
...
x = u, a(new h("firestore-exp", (function(t, e) {
    var n = e.options, r = t.getProvider("app-exp").getImmediate(), i = new da(r, t.getProvider("auth-internal"));
    return n && i._setSettings(n), i;
}), "PUBLIC" /* PUBLIC */)), c("@firebase/firestore", "0.0.900-exp.d92a36260", undefined);

export { Pc as AbstractUserDataWriter, Ca as Bytes, la as CACHE_SIZE_UNLIMITED, ra as CollectionReference, ea as DocumentReference, hc as DocumentSnapshot, ka as FieldPath, Ra as FieldValue, da as FirebaseFirestore, O as FirestoreError, Oa as GeoPoint, fa as LoadBundleTask, na as Query, vc as QueryConstraint, fc as QueryDocumentSnapshot, lc as QuerySnapshot, cc as SnapshotMetadata, Y as Timestamp, eh as Transaction, Vc as WriteBatch, Xc as addDoc, sh as arrayRemove, oh as arrayUnion, Ia as clearIndexedDbPersistence, ia as collection, oa as collectionGroup, Yc as deleteDoc, rh as deleteField, Sa as disableNetwork, sa as doc, xa as documentId, ga as enableIndexedDbPersistence, wa as enableMultiTabIndexedDbPersistence, Ea as enableNetwork, xc as endAt, kc as endBefore, va as ensureFirestoreConfigured, Zc as executeWrite, Uc as getDoc, Kc as getDocFromCache, jc as getDocFromServer, Qc as getDocs, Gc as getDocsFromCache, zc as getDocsFromServer, ya as getFirestore, uh as increment, pa as initializeFirestore, Ec as limit, Sc as limitToLast, Na as loadBundle, Da as namedQuery, $c as onSnapshot, Jc as onSnapshotsInSync, Ic as orderBy, mc as query, aa as queryEqual, ua as refEqual, nh as runTransaction, ih as serverTimestamp, Wc as setDoc, M as setLogLevel, pc as snapshotEqual, Dc as startAfter, Nc as startAt, _a as terminate, Hc as updateDoc, ta as useFirestoreEmulator, Ta as waitForPendingWrites, wc as where, ah as writeBatch };
