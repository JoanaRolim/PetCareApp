...
/** Tests `left` and `right` for equality based on the backend semantics. */ function ct(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return k(t.arrayValue.values || [], e.arrayValue.values || [], ct);
...
class Vt extends class {} {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, n) : new Dt(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Ft(t, n) : "in" /* IN */ === e ? new kt(t, n) : "not-in" /* NOT_IN */ === e ? new Ot(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new $t(t, n) : new Vt(t, e, n);
    }
    static l(t, e, n) {
...
function Ae(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof _e && e instanceof _e || t instanceof ye && e instanceof ye ? k(t.elements, e.elements, ct) : t instanceof pe && e instanceof pe ? ct(t.A, e.A) : t instanceof we && e instanceof we;
 ...
 */ function lo(t) {
    ...
    t.Qr = function(t, e, n) {
        ...
        await to(t)) : (await t.Qr.stop(), t.kr.length > 0 && (b("RemoteStore", `Stopping write stream with ${t.kr.length} pending writes`), 
        t.kr = []));
    }))), t.Qr;
}
        ...
        const t = await function(t, e) {
            ...
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Mn.pn(t, i).next((i => {
                ...
                for (const t of e) {
                    ...
                    // exists=true
                    o.push(new Fe(t.key, e, Et(e.toProto().mapValue), be.exists(!0)));
                }
 ...
 */ function Xo(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Co.set(s, new Fo(n)), t.Do = t.Do.insert(n, s), qr(t.remoteStore, new $s(Zt(Wt(n.path)), s, 2 /* LimboResolution */ , E.o));
    }
}
...
class Hc {
    constructor(t) {
        ...
        const e = t => {
            b("FirebaseCredentialsProvider", "Auth detected"), this.auth = t, this.lc(), this.auth.addAuthTokenListener(this.ac);
        };
        t.onInit((t => e(t))), 
        ...
        setTimeout((() => {
            if (!this.auth) {
                ...
                // token
                b("FirebaseCredentialsProvider", "Auth not yet detected"), this.ac());
            }
        }), 0), this.lc();
    }
    getToken() {
 ...
 */ class Yc {
    ...
    getToken() {
        return Promise.resolve(new Jc(this.fc, this.dc, this.wc));
    }
    setChangeListener(t, e) {
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = fo.createAndSchedule(this, t, e, n, (t => this.Pc(t)));
...
/** A "context" object passed around while parsing user data. */ class ku {
    ...
    Bc(t) {
        return ea(t, this.settings.methodName, this.settings.qc || !1, this.path, this.settings.Uc);
    }
    ...
    $c(t) {
        ...
        if (Fu(this.xc) && Cu.test(t)) throw this.Bc('Document fields cannot begin and end with "__"');
    }
}
...
class Uu extends Su {
    ...
    _toFieldTransform(t) {
        const e = Bu(this, t, 
        /*array=*/ !0), n = this.Kc.map((t => zu(t, e))), s = new _e(n);
...
class Qu extends Su {
    ...
    _toFieldTransform(t) {
        const e = Bu(this, t, 
        /*array=*/ !0), n = this.Kc.map((t => zu(t, e))), s = new ye(n);
        return new Ie(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Ku extends Su {
    ...
    _toFieldTransform(t) {
        const e = new pe(t.R, ae(t.R, this.jc));
...
/** Parse update data from a list of field/value arguments. */ function Wu(t, e, n, s, i, r) {
    const o = t.Qc(1 /* Update */ , e, n), c = [ Xu(e, s, n) ], u = [ i ];
 ...
 */
    return function(t, e) {
        ...
        if (!Fu(e.xc)) throw e.Bc(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        throw e.Bc(`Unsupported field value: ${su(t)}`);
    }
    /**
 ...
 */ class ya extends da {
    ...
    _apply(t) {
        return new au(t.firestore, t.converter, te(t._query, this.Jc, this.Yc));
    }
}
 ...
 */ class ga extends da {
    ...
    _apply(t) {
        const e = Ea(t, this.type, this.Xc, this.Zc);
        return new au(t.firestore, t.converter, function(t, e) {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const $a = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.";
 ...
 */ class Ma {
    enableIndexedDbPersistence(t, e) {
        throw new I(T.FAILED_PRECONDITION, $a);
    }
...
class qa extends Ra {
    ...
    convertReference(t) {
        const e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Wa.nu(e, this.firestore, /* converter= */ null);
    }
}
 ...
 */ (this._delegate) : function(t) {
    ...
    withConverter(t) {
        return new Wa(this.firestore, t ? this._delegate.withConverter(ja.su(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
 ...
 */ (this._delegate) : "server" === (null == t ? void 0 : t.source) ? function(t) {
    ...
    withConverter(t) {
        return new Xa(this.firestore, t ? this._delegate.withConverter(ja.su(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
...
class eh extends Xa {
    ...
    withConverter(t) {
        return new eh(this.firestore, t ? this._delegate.withConverter(ja.su(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
...
export { $, Ba as B, Du as D, Eu as E, Ja as J, Ka as K, Ma as M, Oa as O, Qa as Q, Ua as U, Wa as W, Xa as X, Ya as Y, eh as e, ih as i, oh as o, pu as p, rh as r, sh as s, th as t };
//# sourceMappingURL=prebuilt.rn-4964d3ae.js.map
