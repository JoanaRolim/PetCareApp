...
import { XhrIo as f, EventType as d, ErrorCode as w, createWebChannelTransport as _, getStatEventTarget as m, WebChannel as y, Event as g, Stat as p } from "@firebase/webchannel-wrapper";
 ...
 * limitations under the License.
 */
const A = new h("@firebase/firestore");
 ...
 */ class bs {
    ...
    constructor(t, n, s) {
        ...
        // log on 12.2.
        12.2 === bs._t(e()) && v("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    ...
    /** Returns true if IndexedDB is available in the current environment. */    static yt() {
        ...
        // Check the UA string to find out the browser.
                const t = e(), n = bs._t(t), s = 0 < n && n < 10, i = bs.Et(t), r = 0 < i && i < 4.5;
        // IE 10
 ...
 */ class Bi {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.Cn(e, i);
            return (Gt(e) || zt(e)) && this.Nn(e.limitType, r, s, n) ? this.Dn(t, e) : (R() <= l.DEBUG && b("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), se(e)), 
    ...
    Dn(t, e) {
        return R() <= l.DEBUG && b("QueryEngine", "Using full collection scan to execute query:", se(e)), 
...
function lu(t, e, ...n) {
    if (t = a(t), Xc("collection", "path", e), t instanceof cu) {
 ...
 * Firestore database.
 */ function wu(t, e) {
    return t = a(t), e = a(e), (t instanceof uu || t instanceof hu) && (e instanceof uu || e instanceof hu) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function _u(t, e) {
    return t = a(t), e = a(e), t instanceof au && e instanceof au && (t.firestore === e.firestore && ee(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ function zu(t, e) {
    ...
    // from firestore-exp.
    t = a(t))) return Yu("Unsupported field value:", e, t), Hu(t, e);
    if (t instanceof Su) 
 ...
 */ function Xu(t, e, n) {
    ...
    // FieldPath.
    e = a(e)) instanceof Pu) return e._internalPath;
...
function Ea(t, e, n, s) {
    if (n[0] = a(n[0]), n[0] instanceof sa) return function(t, e, n, s, i) {
 ...
 */ class Pa {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = a(e)) || e instanceof Pu ? Wu(this._dataReader, "WriteBatch.update", i._key, e, n, s) : ju(this._dataReader, "WriteBatch.update", i._key, e), 
...
function Va(t, e) {
    if ((t = a(t)).firestore !== e) throw new I(T.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function Da(t, e, n, ...s) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = a(e)) || e instanceof Pu ? Wu(r, "updateDoc", t._key, e, n, s) : ju(r, "updateDoc", t._key, e);
 ...
 */ class ka extends class {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = a(e)) || e instanceof Pu ? Wu(this._dataReader, "Transaction.update", i._key, e, n, s) : ju(this._dataReader, "Transaction.update", i._key, e), 
...
class Wa {
    ...
    isEqual(t) {
        return (t = a(t)) instanceof uu && wu(this._delegate, t);
    }
    set(t, e) {
 ...
 */ class sh {
    ...
    isEqual(t) {
        return (t = a(t)) instanceof Pu && this._delegate._internalPath.isEqual(t._internalPath);
    }
}
...
export { Oa as Blob, pu as CACHE_SIZE_UNLIMITED, eh as CollectionReference, Wa as DocumentReference, Ja as DocumentSnapshot, Eu as ExpFirebaseFirestore, sh as FieldPath, ih as FieldValue, Ba as Firestore, Du as GeoPoint, La as IndexedDbPersistenceProvider, Ma as MemoryPersistenceProvider, Xa as Query, Ya as QueryDocumentSnapshot, th as QuerySnapshot, $ as Timestamp, Qa as Transaction, Ka as WriteBatch, rh as loadBundle, oh as namedQuery, Ua as setLogLevel };
