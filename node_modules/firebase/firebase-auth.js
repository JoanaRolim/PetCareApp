(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function initializeAuth(app$1, deps) {
        const provider = app._getProvider(app$1, 'auth-exp');
    ...
    function registerAuth(clientPlatform) {
        app._registerComponent(new Component("auth-exp" /* AUTH */, (container, { options: deps }) => {
        ...
        app._registerComponent(new Component("auth-internal" /* AUTH_INTERNAL */, container => {
