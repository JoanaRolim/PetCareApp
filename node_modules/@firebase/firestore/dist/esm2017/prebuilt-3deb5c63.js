...
class xr extends class {} {
    ...
    /** Gets an auth token and invokes the provided RPC. */    Ni(t, e, n) {
        return this.br(), this.credentials.getToken().then((s => this.Hi.Ni(t, e, n, s))).catch((t => {
            throw "FirebaseError" === t.name ? (t.code === p.UNAUTHENTICATED && this.credentials.invalidateToken(), 
            t) : new E(p.UNKNOWN, t.toString());
        }));
    }
 ...
 */ class su {
    /** @hideconstructor */
    constructor(t, e) {
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new nu({}), 
        this._settingsFrozen = !1, t instanceof qc ? (this._databaseId = t, this._credentials = new Kc) : (this._app = t, 
...
function au(t, e, ...n) {
    ...
    }
    {
        ...
        return Yc(s), new iu(t.firestore, t instanceof ou ? t.converter : null, new nt(s));
    }
}
 ...
 * Firestore database.
 */ function hu(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), (t instanceof iu || t instanceof ou) && (e instanceof iu || e instanceof ou) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function lu(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), t instanceof ru && e instanceof ru && (t.firestore === e.firestore && Xt(t._query, e._query) && t.converter === e.converter);
}
...
class mu extends su {
    /** @hideconstructor */
    constructor(t, e) {
        super(t, e), this.type = "firestore", this._queue = new fu, this._persistenceKey = "name" in t ? t.name : "[DEFAULT]";
    }
    _terminate() {
 ...
 */ class ra {
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new ia(this._firestore, this._userDataWriter, n.key, n, new na(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
        }));
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((s => {
                    const i = new ia(t._firestore, t._userDataWriter, s.doc.key, s.doc, new na(t._snapshot.mutatedKeys.has(s.doc.key), t._snapshot.fromCache), t.query.converter);
                    return e = s.doc, {
                        type: "added",
                        doc: i,
                        oldIndex: -1,
            ...
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new ia(t._firestore, t._userDataWriter, e.doc.key, e.doc, new na(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    let i = -1, r = -1;
 ...
 */
        ...
        return new ru(t.firestore, t.converter, function(t, e) {
 ...
 */ class da extends aa {
    ...
    _apply(t) {
        return new ru(t.firestore, t.converter, Yt(t._query, this.Gc, this.zc));
    }
}
 ...
 */ class Aa {
    ...
    set(t, e, n) {
        ...
        const s = Ra(t, this._firestore), i = Ta(s.converter, e, n), r = Fu(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
 ...
 */ function Sa(t, e, n) {
    ...
    return new sa(t, i, e._key, s, new na(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ class Da extends class {
     ...
     */    get(t) {
        ...
        return this._transaction.lookup([ e._key ]).then((t => {
            ...
            const s = t[0];
            if (s.isFoundDocument()) return new Zu(this._firestore, n, s.key, s, e.converter);
            if (s.isNoDocument()) return new Zu(this._firestore, n, e._key, null, e.converter);
            throw P();
        }));
    }
    set(t, e, n) {
        const s = Ra(t, this._firestore), i = Ta(s.converter, e, n), r = Fu(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
 ...
 */ class Ba {
    ...
    get(t) {
        const e = Za(t);
        return this._delegate.get(e).then((t => new Ga(this._firestore, new sa(this._firestore._delegate, this._userDataWriter, t._key, t._document, t.metadata, e.converter))));
    }
    set(t, e, n) {
        const s = Za(t);
...
class Qa {
    ...
    set(t, e) {
        ...
        try {
            return function(t, e, n) {
                t = tu(t, iu);
                const s = tu(t.firestore, mu), i = Ta(t.converter, e, n);
                return Va(s, [ Fu(xu(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Ie.none()) ]);
            }(this._delegate, t, e);
        } catch (t) {
 ...
 */    }
    onSnapshot(...t) {
        const e = ja(t), n = Wa(t, (t => new Ga(this.firestore, new sa(this.firestore._delegate, this._userDataWriter, t._key, t._document, t.metadata, this._delegate.converter))));
 ...
 */ (this._delegate) : function(t) {
        ...
        }(this._delegate), e.then((t => new Ga(this.firestore, new sa(this.firestore._delegate, this._userDataWriter, t._key, t._document, t.metadata, this._delegate.converter))));
    }
    withConverter(t) {
...
class Xa extends Ha {
    ...
    add(t) {
        return function(t, e) {
            const n = tu(t.firestore, mu), s = au(t), i = Ta(t.converter, e);
            return Va(n, [ Fu(xu(t.firestore), "addDoc", s._key, i, null !== t.converter, {}).toMutation(s._key, Ie.exists(!1)) ]).then((() => s));
...
//# sourceMappingURL=prebuilt-3deb5c63.js.map
