    ...
    ***************************************************************************** */
    ...
    class Q {
        constructor(t) {
            ...
            const e = t => {
                m("FirebaseCredentialsProvider", "Auth detected"), this.auth = t, this.l(), this.auth.addAuthTokenListener(this.u);
            };
            t.onInit((t => e(t))), 
            ...
            setTimeout((() => {
                if (!this.auth) {
                    ...
                    // with null token
                    m("FirebaseCredentialsProvider", "Auth not yet detected"), this.asyncQueue.enqueueRetryable((() => this.changeListener(this.currentUser))));
                }
            }), 0);
        }
        getToken() {
            ...
            this.getToken()) : e ? (v("string" == typeof e.accessToken), new M(e.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
        }
        invalidateToken() {
            this.forceRefresh = !0;
        }
     ...
     */ class z {
        constructor(t, e, n) {
            this.m = t, this.p = e, this.g = n, this.type = "FirstParty", this.user = f.FIRST_PARTY;
        }
        get authHeaders() {
            const t = {
     ...
     */ class W {
        ...
        getToken() {
            return Promise.resolve(new z(this.m, this.p, this.g));
        }
        setChangeListener(t, e) {
    ...
    /** A dot-separated path for navigating sub-objects within a document. */ class Z extends Y {
         ...
         */    static fromServerFormat(t) {
            ...
            for (;s < t.length; ) {
                const e = t[s];
                if ("\\" === e) {
                    if (s + 1 === t.length) throw new U(A, "Path has trailing escape character: " + t);
                    const e = t[s + 1];
                    if ("\\" !== e && "." !== e && "`" !== e) throw new U(A, "Path has invalid escape sequence: " + t);
                    n += e, s += 2;
                } else "`" === e ? (i = !i, s++) : "." !== e || i ? (n += e, s++) : (r(), s++);
            }
            if (r(), i) throw new U(A, "Unterminated ` in path: " + t);
            return new Z(e);
        }
        static emptyPath() {
            return new Z([]);
    ...
    class {
        ...
        I(t, e, n, s) {
            ...
            const i = {};
            return this.P(i, s), this.R(t, r, i, n).then((t => (m("RestConnection", "Received: ", t), 
            t)), (e => {
                throw y("RestConnection", `${t} failed with error: `, e, "url: ", r, "request:", n), 
                e;
            }));
        }
        V(t, e, n, s) {
          ...
          case 10 /* ObjectValue */ :
            return function(t, e) {
                ...
                for (let t = 0; t < s.length && t < i.length; ++t) {
                    const e = mt(s[t], i[t]);
                    if (0 !== e) return e;
                    const o = St(n[s[t]], r[i[t]]);
                    if (0 !== o) return o;
                }
                return mt(s.length, i.length);
            }
    ...
    function xt(t, e) {
        ...
        const n = It(t), s = It(e), r = mt(n.seconds, s.seconds);
        return 0 !== r ? r : mt(n.nanos, s.nanos);
    }
     ...
     */ class kt {
         ...
         */    field(t) {
            return kt.extractNestedValue(this.buildProto(), t);
        }
        ...
        isEqual(t) {
            return $t(this.buildProto(), t.buildProto());
        }
        /**
         ...
         */    applyOverlay(t, e) {
            let n = !1;
            const s = kt.extractNestedValue(this.partialValue, t), r = Ut(s) ? // If there is already data at the current path, base our
        ...
        static extractNestedValue(t, e) {
            if (e.isEmpty()) return t;
            {
                ...
                for (let t = 0; t < e.length - 1; ++t) {
                    ...
                    if (n = n.mapValue.fields[e.get(t)], !Ut(n)) return null;
                }
                return n = (n.mapValue.fields || {})[e.lastSegment()], n || null;
            }
        }
        clone() {
            return new kt(this.buildProto());
        }
    }
     ...
     * property.
     */ function Bt(t, e = null, n = [], s = [], r = null, i = null, o = null) {
        return new jt(t, e, n, s, r, i, o);
    }
    ...
    class Qt extends class {} {
         ...
         */    static create(t, e, n) {
            return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.S(t, e, n) : new zt(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Yt(t, n) : "in" /* IN */ === e ? new Kt(t, n) : "not-in" /* NOT_IN */ === e ? new Jt(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Zt(t, n) : new Qt(t, e, n);
        }
        static S(t, e, n) {
        ...
        matches(t) {
            ...
            // Types do not have to match in NOT_EQUAL filters.
                    return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.q(St(e, this.value)) : null !== e && Dt(this.value) === Dt(e) && this.q(St(e, this.value));
     ...
     */ function ae(t) {
        ...
        if (null === e.C) {
            ...
            t.isKeyField() || e.C.push(new te(t)), e.C.push(new te(Z.keyField(), "asc" /* ASCENDING */)); else {
                let t = !1;
     ...
     */ function ce(t) {
        const e = b(t);
        if (!e.L) if ("F" /* First */ === e.limitType) e.L = Bt(e.path, e.collectionGroup, ae(e), e.filters, e.limit, e.startAt, e.endAt); else {
            ...
            e.L = Bt(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
        }
        return e.L;
    }
    ...
    function he(t, e) {
        ...
        }(ce(t), ce(e)) && t.limitType === e.limitType;
    }
    ...
    function Se(t, e) {
        ...
        return new X((v((s = n).length > 4 && "documents" === s.get(4)), s.popFirst(5)));
        var s;
    ...
    function Ce(t, e) {
        return "found" in e ? function(t, e) {
            ...
            const n = Se(t, e.found.name), s = De(e.found.updateTime), r = new kt({
                mapValue: {
                    fields: e.found.fields
                }
            });
            return Mt.newFoundDocument(n, s, r);
        }(t, e) : "missing" in e ? function(t, e) {
            v(!!e.missing), v(!!e.readTime);
            const n = Se(t, e.missing), s = De(e.readTime);
            return Mt.newNoDocument(n, s);
        }(t, e) : g();
    }
    ...
    function Ue(t, e) {
        ...
        null !== e.collectionGroup ? (n.parent = xe(t, s), n.structuredQuery.from = [ {
            ...
            allDescendants: !0
        } ]) : (n.parent = xe(t, s.popLast()), n.structuredQuery.from = [ {
    ...
    class Ge {
         ...
         */    Z(t) {
            ...
            // Guard against lastAttemptTime being in the future due to a clock change.
                    s > 0 && m("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.H} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
    ...
    class He extends class {} {
        ...
        st() {
            if (this.nt) throw new U(F, "The client has already been terminated.");
        }
    ...
    async function Ye(t, e) {
        const n = b(t), s = qe(n.k) + "/documents", r = {
            writes: e.map((t => Le(n.k, t)))
        };
    ...
    async function Je(t, e) {
        const n = b(t), s = Ue(n.k, ce(e));
        return (await n.V("RunQuery", s.parent, {
            structuredQuery: s.structuredQuery
        })).filter((t => !!t.document)).map((t => function(t, e, n) {
            const s = Se(t, e.name), r = De(e.updateTime), i = new kt({
                mapValue: {
                    fields: e.fields
                }
            }), o = Mt.newFoundDocument(s, r, i);
    ...
    function Xe(t) {
        ...
        if (!Ze.has(t)) {
            ...
            new G(e, n, s, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling))), o = We(t._databaseId), u = function(t, e, n) {
                return new He(t, e, n);
            }(t._credentials, i, o);
            Ze.set(t, u);
        }
    ...
    class tn {
        constructor(t) {
            ...
            function(t, e, n, s) {
                if (!0 === e && !0 === s) throw new U(A, `${t} and ${n} cannot be used together.`);
    ...
    function nn(e, n) {
        const s = app._getProvider(e, "firestore/lite");
        if (s.isInitialized()) throw new U(F, "Firestore can only be initialized once per app.");
        return s.initialize({
            options: n
        });
    }
     ...
     * Security Rules.
     */ function rn(t, e, n, s = {}) {
        const r = (t = rt(t, en))._getSettings();
        if ("firestore.googleapis.com" !== r.host && r.host !== e && y("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
        t._setSettings(Object.assign(Object.assign({}, r), {
            ...
            t._credentials = new B(new M(e, new f(n)));
        }
    }
     ...
     * terminated.
     */ function on(t) {
        return t = rt(t, en), app._removeServiceInstance(t.app, "firestore/lite"), t._delete();
    }
     ...
     */ class cn extends an {
        ...
        withConverter(t) {
            return new cn(this.firestore, t, this._path);
        }
    }

    function hn(t, e, ...n) {
        if (t = getModularInstance(t), tt("collection", "path", e), t instanceof en) {
            const s = K.fromString(e, ...n);
            return nt(s), new cn(t, /* converter= */ null, s);
        }
        {
            if (!(t instanceof un || t instanceof cn)) throw new U(A, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
            const s = K.fromString(t.path, ...n).child(K.fromString(e));
            return nt(s), new cn(t.firestore, 
            /* converter= */ null, s);
        }
    }
     ...
     */ function ln(t, e) {
        if (t = rt(t, en), tt("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new U(A, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
        return new an(t, 
        /* converter= */ null, 
        /**
    ...
    function fn(t, e, ...n) {
        ...
        // 'undefined' and 'null'.
        1 === arguments.length && (e = wt.$()), tt("doc", "path", e), t instanceof en) {
            const s = K.fromString(e, ...n);
            return et(s), new un(t, 
            /* converter= */ null, new X(s));
        }
        {
            if (!(t instanceof un || t instanceof cn)) throw new U(A, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
            const s = t._path.child(K.fromString(e, ...n));
            return et(s), new un(t.firestore, t instanceof cn ? t.converter : null, new X(s));
        }
    }
     ...
     * Firestore database.
     */ function dn(t, e) {
        return t = getModularInstance(t), e = getModularInstance(e), (t instanceof un || t instanceof cn) && (e instanceof un || e instanceof cn) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
    }
     ...
     * Firestore database.
     */ function wn(t, e) {
        return t = getModularInstance(t), e = getModularInstance(e), t instanceof an && e instanceof an && (t.firestore === e.firestore && he(t._query, e._query) && t.converter === e.converter);
    }
     ...
     */ class yn {
         ...
         */    static fromBase64String(t) {
            try {
                return new yn(Et.fromBase64String(t));
            } catch (t) {
         ...
         */    static fromUint8Array(t) {
            return new yn(Et.fromUint8Array(t));
        }
        /**
    ...
    /** The result of parsing document data (e.g. for a setData call). */ class bn {
        ...
        toMutation(t, e) {
            return null !== this.fieldMask ? new be(t, this.data, this.fieldMask, e, this.fieldTransforms) : new ve(t, this.data, e, this.fieldTransforms);
        }
    }
    ...
    /** The result of parsing "update" data (i.e. for an updateData call). */ class En {
        ...
        toMutation(t, e) {
            return new be(t, this.data, this.fieldMask, e, this.fieldTransforms);
        }
    }
    ...
    /** A "context" object passed around while parsing user data. */ class In {
        ...
        /** Returns a new context with the specified settings overwritten. */    ot(t) {
            return new In(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.k, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
        }
        ut(t) {
            var e;
        ...
        ft(t) {
            return Qn(t, this.settings.methodName, this.settings.dt || !1, this.path, this.settings.wt);
        }
        ...
        ct(t) {
            ...
            if (Tn(this.it) && vn.test(t)) throw this.ft('Document fields cannot begin and end with "__"');
        }
    }
     ...
     */ class An {
        constructor(t, e, n) {
            this.databaseId = t, this.ignoreUndefinedProperties = e, this.k = n || We(t);
        }
    ...
    /** Parse document data from a set() call. */ function Rn(t, e, n, s, r, i = {}) {
        const o = t.yt(i.merge || i.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, r);
        kn("Data must be an object, but it was:", o, s);
        const u = Ln(s, o);
        let a, c;
        if (i.merge) a = new bt(o.fieldMask), c = o.fieldTransforms; else if (i.mergeFields) {
            const t = [];
            for (const s of i.mergeFields) {
                const r = Mn(e, s, n);
                if (!o.contains(r)) throw new U(A, `Field '${r}' is specified in your field mask but missing from your input data.`);
                zn(t, r) || t.push(r);
            }
            a = new bt(t), c = o.fieldTransforms.filter((t => a.covers(t.field)));
        } else a = null, c = o.fieldTransforms;
        return new bn(new kt(u), a, c);
    }
    ...
    class $n extends _n {
        ...
        _toFieldTransform(t) {
            const e = Nn(this, t, 
            /*array=*/ !0), n = this._t.map((t => Cn(t, e))), s = new we(n);
    ...
    class Fn extends _n {
        ...
        _toFieldTransform(t) {
            const e = Nn(this, t, 
            /*array=*/ !0), n = this._t.map((t => Cn(t, e))), s = new me(n);
            return new ye(t.path, s);
        }
        isEqual(t) {
            // TODO(mrschmidt): Implement isEquals
    ...
    class Sn extends _n {
        ...
        _toFieldTransform(t) {
            const e = new pe(t.k, le(t.k, this.gt));
    ...
    /** Parse update data from an update() call. */ function xn(t, e, n, s) {
        const r = t.yt(1 /* Update */ , e, n);
        kn("Data must be an object, but it was:", r, s);
        const i = [], o = kt.empty();
        vt(s, ((t, s) => {
            const u = Bn(e, t, n);
        ...
        const u = new bt(i);
        return new En(o, u, r.fieldTransforms);
    }

    /** Parse update data from a list of field/value arguments. */ function qn(t, e, n, s, r, i) {
        const o = t.yt(1 /* Update */ , e, n), u = [ Mn(e, s, n) ], c = [ r ];
     ...
     */ function On(t, e, n, s = !1) {
        return Cn(n, t.yt(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
    }
     ...
     */ function Cn(t, e) {
        ...
        // from firestore-exp.
        t = getModularInstance(t))) return kn("Unsupported field value:", e, t), Ln(t, e);
        if (t instanceof _n) 
     ...
     */
        return function(t, e) {
            ...
            if (!Tn(e.it)) throw e.ft(`${t._methodName}() can only be used with update() and set()`);
     ...
     */ (t, e), null;
        ...
        return function(t, e) {
            ...
            if ("number" == typeof t) return le(e.k, t);
            ...
            throw e.ft(`Unsupported field value: ${st(t)}`);
        }
        /**
    ...
    function Un(t) {
        return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof yt || t instanceof gn || t instanceof yn || t instanceof un || t instanceof _n);
    }
     ...
     * evaluated.
     */ function Bn(t, e, n) {
        if (e.search(jn) >= 0) throw Qn(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
        try {
     ...
     */ function Yn(t, e) {
        return t = getModularInstance(t), e = getModularInstance(e), t instanceof Wn && e instanceof Wn ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof Hn && e instanceof Hn && (wn(t.query, e.query) && pt(t.docs, e.docs, Yn));
    }
    ...
    class Xn extends Jn {
        ...
        _apply(t) {
            const e = Pn(t.firestore), n = function(t, e, n, s, r, i, o) {
                let u;
                if (r.isKeyField()) {
                    ...
                    if ("in" /* IN */ === i || "not-in" /* NOT_IN */ === i) {
                        ws(o, i);
                        const e = [];
                        for (const n of o) e.push(ds(s, t, n));
                        u = {
                            arrayValue: {
                                values: e
                            }
     ...
     * @returns The created `Query`.
     */ function rs(t) {
        return it("limit", t), new ss("limit", t, "F" /* First */);
    }
     ...
     * @returns The created `Query`.
     */ function is(t) {
        return it("limitToLast", t), new ss("limitToLast", t, "L" /* Last */);
    }
    ...
    class os extends Jn {
        ...
        _apply(t) {
            const e = fs(t, this.type, this.Pt, this.Rt);
            return new an(t.firestore, t.converter, function(t, e) {
    ...
    function us(...t) {
        return new os("startAt", t, /*before=*/ !0);
    }

    function as(...t) {
        return new os("startAfter", t, 
        /*before=*/ !1);
    }
    ...
    /** Helper function to create a bound from a document or fields */ function fs(t, e, n, s) {
        if (n[0] = getModularInstance(n[0]), n[0] instanceof Wn) return function(t, e, n, s, r) {
            if (!s) throw new U(R, `Can't use a DocumentSnapshot that doesn't exist for ${n}().`);
            const i = [];
            ...
            // results.
                    for (const n of ae(t)) if (n.field.isKeyField()) i.push(qt(e, s.key)); else {
     ...
     */ (t._query, t.firestore._databaseId, e, n[0]._document, s);
        {
            const r = Pn(t.firestore);
            return function(t, e, n, s, r, i) {
                // Use explicit order by's because it has to match the query the user made
                const o = t.explicitOrderBy;
                if (r.length > o.length) throw new U(A, `Too many arguments provided to ${s}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
                const u = [];
                for (let i = 0; i < r.length; i++) {
                    const a = r[i];
                    if (o[i].field.isKeyField()) {
                        if ("string" != typeof a) throw new U(A, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof a}`);
                        if (!ue(t) && -1 !== a.indexOf("/")) throw new U(A, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
                        const n = t.path.child(K.fromString(a));
                        if (!X.isDocumentKey(n)) throw new U(A, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                        const r = new X(n);
                        u.push(qt(e, r));
                    } else {
                        const t = On(n, s, a);
    ...
    function ds(t, e, n) {
        if ("string" == typeof (n = getModularInstance(n))) {
            ...
            if (!ue(e) && -1 !== n.indexOf("/")) throw new U(A, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
            const s = e.path.child(K.fromString(n));
            if (!X.isDocumentKey(s)) throw new U(A, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
            return qt(t, new X(s));
        }
        if (n instanceof un) return qt(t, n._key);
        throw new U(A, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${st(n)}.`);
    }
    ...
    class ys extends class {
        ...
        convertObject(t, e) {
            const n = {};
            return vt(t.fields || {}, ((t, s) => {
                n[t] = this.convertValue(s, e);
            })), n;
        }
        convertGeoPoint(t) {
            return new gn(At(t.latitude), At(t.longitude));
        }
        convertArray(t, e) {
        ...
        convertDocumentKey(t, e) {
            ...
            v(ze(n));
            const s = new H(n.get(1), n.get(3)), r = new X(n.popFirst(5));
            return s.isEqual(e) || 
            // TODO(b/64130202): Somehow support foreign references.
            p(`Document ${r} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`), 
            r;
        }
    } {
        constructor(t) {
     ...
     * document contents.
     */ function _s(t) {
        const e = Xe((t = rt(t, un)).firestore), n = new ys(t.firestore);
        return Ke(e, [ t._key ]).then((e => {
            v(1 === e.length);
            const s = e[0];
            return new Wn(t.firestore, n, t._key, s.isFoundDocument() ? s : null, t.converter);
        }));
    }
     ...
     */ function gs(t) {
        !function(t) {
            if (re(t) && 0 === t.explicitOrderBy.length) throw new U(q, "limitToLast() queries require specifying at least one orderBy() clause");
        }((t = rt(t, an))._query);
        const e = Xe(t.firestore), n = new ys(t.firestore);
        return Je(e, t._query).then((e => {
            const s = e.map((e => new Gn(t.firestore, n, e.key, e, t.converter)));
            return re(t._query) && 
            // Limit to last queries reverse the orderBy constraint that was
            // specified by the user. As such, we need to reverse the order of the
            // results to return the documents in the expected order.
            s.reverse(), new Hn(t, s);
        }));
    }

    function vs(t, e, n) {
        const s = ps((t = rt(t, un)).converter, e, n), r = Rn(Pn(t.firestore), "setDoc", t._key, s, null !== t.converter, n);
        return Ye(Xe(t.firestore), [ r.toMutation(t._key, _e.none()) ]);
    }

    function bs(t, e, n, ...s) {
        const r = Pn((t = rt(t, un)).firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
            let i;
        i = "string" == typeof (e = getModularInstance(e)) || e instanceof mn ? qn(r, "updateDoc", t._key, e, n, s) : xn(r, "updateDoc", t._key, e);
     ...
     */ function Ts(t, e) {
        const n = fn(t = rt(t, cn)), s = ps(t.converter, e), r = Rn(Pn(t.firestore), "addDoc", n._key, s, null !== n.converter, {});
        return Ye(Xe(t.firestore), [ r.toMutation(n._key, _e.exists(!1)) ]).then((() => n));
    }
     ...
     */ class Ns {
        ...
        set(t, e, n) {
            ...
            const s = Ds(t, this._firestore), r = ps(s.converter, e, n), i = Rn(this._dataReader, "WriteBatch.set", s._key, r, null !== s.converter, n);
            return this._mutations.push(i.toMutation(s._key, _e.none())), this;
        }
        update(t, e, n, ...s) {
            this._verifyNotCommitted();
            ...
            // performing validation.
                    let i;
            return i = "string" == typeof (e = getModularInstance(e)) || e instanceof mn ? qn(this._dataReader, "WriteBatch.update", r._key, e, n, s) : xn(this._dataReader, "WriteBatch.update", r._key, e), 
            this._mutations.push(i.toMutation(r._key, _e.exists(!0))), this;
        }
        /**
    ...
    class Ss {
        constructor(t, e, n, s) {
            ...
            this.Vt = 5, this.Nt = new Ge(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
        }
        ...
        Dt() {
            this.Nt.Z((async () => {
                const t = new Fs(this.datastore), e = this.$t(t);
                e && e.then((e => {
     ...
     * limitations under the License.
     */
    /** The Platform's 'document' implementation or null if not available. */ function xs() {
     ...
     */ class qs {
         ...
         */    static createAndSchedule(t, e, n, s, r) {
            const i = Date.now() + n, o = new qs(t, e, i, s, r);
            return o.start(n), o;
        }
        /**
     ...
     */ class Os {
        constructor() {
            ...
            this.Nt = new Ge(this, "async_queue_retry" /* AsyncQueueRetry */), 
            // Visibility handler that triggers an immediate retry of all retryable
            // operations. Meant to speed up recovery when we regain file system access
            // after page comes into foreground.
            this.Mt = () => {
                const t = xs();
                t && m("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.Nt.tt();
            };
            const t = xs();
     ...
     */ (t)), t;
        ...
        enqueueAfterDelay(t, e, n) {
            ...
            const s = qs.createAndSchedule(this, t, e, n, (t => this.zt(t)));
    ...
    class Cs {
         ...
         */    get(t) {
            const e = Ds(t, this._firestore), n = new ys(this._firestore);
            return this._transaction.lookup([ e._key ]).then((t => {
                if (!t || 1 !== t.length) return g();
                const s = t[0];
                if (s.isFoundDocument()) return new Wn(this._firestore, n, s.key, s, e.converter);
                if (s.isNoDocument()) return new Wn(this._firestore, n, e._key, null, e.converter);
                throw g();
            }));
        }
        set(t, e, n) {
            const s = Ds(t, this._firestore), r = ps(s.converter, e, n), i = Rn(this._dataReader, "Transaction.set", s._key, r, null !== s.converter, n);
        ...
        update(t, e, n, ...s) {
            ...
            // performing validation.
                    let i;
            return i = "string" == typeof (e = getModularInstance(e)) || e instanceof mn ? qn(this._dataReader, "Transaction.update", r._key, e, n, s) : xn(this._dataReader, "Transaction.update", r._key, e), 
     ...
     */ function Ls(t, e) {
        const n = Xe(t = rt(t, en)), s = new k;
        return new Ss(new Os, n, (n => e(new Cs(t, n))), s).run(), s.promise;
    }
     ...
     */ !function(t) {
        l = t;
    }(`${app.SDK_VERSION}_lite`), app._registerComponent(new Component("firestore/lite", ((t, {options: e}) => {
        const n = t.getProvider("app-exp").getImmediate(), s = new en(n, t.getProvider("auth-internal"));
        return e && s._setSettings(e), s;
    }), "PUBLIC" /* PUBLIC */)), app.registerVersion("firestore-lite", "0.0.900-exp.d92a36260", "node");

    exports.Bytes = yn;
    exports.CollectionReference = cn;
    exports.DocumentReference = un;
    exports.DocumentSnapshot = Wn;
    exports.FieldPath = mn;
    exports.FieldValue = _n;
    exports.FirebaseFirestore = en;
    exports.FirestoreError = U;
    exports.GeoPoint = gn;
    exports.Query = an;
    exports.QueryConstraint = Jn;
    exports.QueryDocumentSnapshot = Gn;
    exports.QuerySnapshot = Hn;
    exports.Timestamp = yt;
    exports.Transaction = Cs;
    exports.WriteBatch = Ns;
    exports.addDoc = Ts;
    exports.arrayRemove = Rs;
    exports.arrayUnion = Ps;
    exports.collection = hn;
    exports.collectionGroup = ln;
    exports.deleteDoc = Es;
    exports.deleteField = Is;
    exports.doc = fn;
    exports.documentId = pn;
    exports.endAt = ls;
    exports.endBefore = hs;
    exports.getDoc = _s;
    exports.getDocs = gs;
    exports.getFirestore = sn;
    exports.increment = Vs;
    exports.initializeFirestore = nn;
    exports.limit = rs;
    exports.limitToLast = is;
    exports.orderBy = ns;
    exports.query = Zn;
    exports.queryEqual = wn;
    exports.refEqual = dn;
    exports.runTransaction = Ls;
    exports.serverTimestamp = As;
    exports.setDoc = vs;
    exports.setLogLevel = w;
    exports.snapshotEqual = Yn;
    exports.startAfter = as;
    exports.startAt = us;
    exports.terminate = on;
    exports.updateDoc = bs;
    exports.useFirestoreEmulator = rn;
    exports.where = ts;
