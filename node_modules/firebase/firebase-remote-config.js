(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    const ERROR_FACTORY$1 = new ErrorFactory('remoteconfig' /* service */, 'Remote Config' /* service name */, ERROR_DESCRIPTION_MAP$1);
    ...
    class RestClient {
        ...
        async fetch(request) {
            ...
            try {
                ...
                throw ERROR_FACTORY$1.create(errorCode, {
            ...
            if (response.status === 200) {
                ...
                try {
                    ...
                    throw ERROR_FACTORY$1.create("fetch-client-parse" /* FETCH_PARSE */, {
                        originalErrorMessage: originalError.message
                    });
                }
            ...
            if (status !== 304 && status !== 200) {
                throw ERROR_FACTORY$1.create("fetch-status" /* FETCH_STATUS */, {
                    httpStatus: status
                });
            }
    ...
    function toFirebaseError(event, errorCode) {
        ...
        return ERROR_FACTORY$1.create(errorCode, {
        ...
        async get(key) {
            ...
            return new Promise((resolve, reject) => {
                ...
                try {
                    ...
                    reject(ERROR_FACTORY$1.create("storage-get" /* STORAGE_GET */, {
        ...
        async set(key, value) {
            ...
            return new Promise((resolve, reject) => {
                ...
                try {
                    ...
                    reject(ERROR_FACTORY$1.create("storage-set" /* STORAGE_SET */, {
                        originalErrorMessage: e && e.message
                    }));
                }
            });
        ...
        async delete(key) {
            ...
            return new Promise((resolve, reject) => {
                ...
                try {
                    ...
                    reject(ERROR_FACTORY$1.create("storage-delete" /* STORAGE_DELETE */, {
                        originalErrorMessage: e && e.message
                    }));
                }
            });
    ...
    function registerRemoteConfig() {
        ...
        function remoteConfigFactory(container, { instanceIdentifier: namespace }) {
            ...
            if (typeof window === 'undefined') {
                throw ERROR_FACTORY$1.create("registration-window" /* REGISTRATION_WINDOW */);
            }
            // Normalizes optional inputs.
            const { projectId, apiKey, appId } = app$1.options;
            if (!projectId) {
                throw ERROR_FACTORY$1.create("registration-project-id" /* REGISTRATION_PROJECT_ID */);
            }
            if (!apiKey) {
                throw ERROR_FACTORY$1.create("registration-api-key" /* REGISTRATION_API_KEY */);
            }
            if (!appId) {
                throw ERROR_FACTORY$1.create("registration-app-id" /* REGISTRATION_APP_ID */);
            }
