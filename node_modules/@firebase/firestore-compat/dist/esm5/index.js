...
import { useFirestoreEmulator as o, enableNetwork as i, disableNetwork as a, waitForPendingWrites as u, onSnapshotsInSync as s, collection as c, doc as f, collectionGroup as l, runTransaction as p, ensureFirestoreConfigured as h, WriteBatch as d, executeWrite as g, Bytes as y, AbstractUserDataWriter as m, DocumentSnapshot as _, QueryDocumentSnapshot as v, DocumentReference as w, refEqual as b, setDoc as P, updateDoc as S, deleteDoc as I, onSnapshot as D, getDocFromCache as E, getDocFromServer as O, getDoc as j, snapshotEqual as F, query as x, where as A, orderBy as C, limit as T, limitToLast as B, startAt as N, startAfter as R, endBefore as q, endAt as Q, queryEqual as W, getDocsFromCache as L, getDocsFromServer as U, getDocs as k, QuerySnapshot as V, addDoc as K, FieldPath as z, serverTimestamp as M, deleteField as G, arrayUnion as Z, arrayRemove as $, increment as J, loadBundle as H, namedQuery as Y, GeoPoint as X, Timestamp as ee, CACHE_SIZE_UNLIMITED as te, enableIndexedDbPersistence as re, enableMultiTabIndexedDbPersistence as ne, clearIndexedDbPersistence as oe } from "@firebase/firestore";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var he = "invalid-argument", de = "failed-precondition", ge = "unimplemented", ye = /** @class */ function(t) {
    /** @hideconstructor */
    function r(
    /**
    ...
    function e(e, t, r) {
        void 0 === t ? t = 0 : t > e.length && pe(), void 0 === r ? r = e.length - t : r > e.length - t && pe(), 
    ...
    r.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var a = i[o];
            if (a.indexOf("//") >= 0) throw new ye(he, "Invalid segment (" + a + "). Paths must not contain // in them.");
    ...
    r.fromServerFormat = function(e) {
        for (var t = [], n = "", o = 0, i = function() {
            if (0 === n.length) throw new ye(he, "Invalid field path (" + e + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            t.push(n), n = "";
        }, a = !1; o < e.length; ) {
            var u = e[o];
            if ("\\" === u) {
                if (o + 1 === e.length) throw new ye(he, "Path has trailing escape character: " + e);
                var s = e[o + 1];
                if ("\\" !== s && "." !== s && "`" !== s) throw new ye(he, "Path has invalid escape sequence: " + e);
                n += s, o += 2;
            } else "`" === u ? (a = !a, o++) : "." !== u || a ? (n += u, o++) : (i(), o++);
        }
        if (i(), a) throw new ye(he, "Unterminated ` in path: " + e);
        return new r(t);
    }, r.emptyPath = function() {
        return new r([]);
    }, r;
...
function Pe(e, t) {
    ...
    if (void 0 !== t.mergeFields && void 0 !== t.merge) throw new ye(he, "Invalid options passed to function " + e + '(): You cannot specify both "merge" and "mergeFields".');
    return t;
}
...
t) {
    ...
    e = e._delegate), !(e instanceof t)) {
        if (t.name === e.constructor.name) throw new ye(he, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var r = 
        ...
        function(e) {
            ...
            return "function" == typeof e ? "a function" : pe();
        }(e);
        throw new ye(he, "Expected type '" + t.name + "', but it was: " + r);
    }
    return e;
}
...
var je = /** @class */ function() {
    ...
    return Object.defineProperty(e.prototype, "_databaseId", {
        ...
        delete (e = Object.assign(Object.assign({}, this._delegate._getSettings()), e)).merge, 
        ...
        return e && function(e, t, r, n) {
            if (!0 === t && !0 === n) throw new ye(he, e + " and " + r + " cannot be used together.");
        ...
        try {
            ...
            throw Ne(e, "collection()", "Firestore.collection()");
        }
    }, e.prototype.doc = function(e) {
        try {
            return new Be(this, f(this._delegate, e));
        } catch (e) {
            throw Ne(e, "doc()", "Firestore.doc()");
        }
    }, e.prototype.collectionGroup = function(e) {
        try {
            return new Le(this, l(this._delegate, e));
        } catch (e) {
            throw Ne(e, "collectionGroup()", "Firestore.collectionGroup()");
        }
    }, e.prototype.runTransaction = function(e) {
        var t = this;
        return p(this._delegate, (function(r) {
            return e(new Ae(t, r));
        }));
    }, e.prototype.batch = function() {
        var e = this;
        return h(this._delegate), new Ce(new d(this._delegate, (function(t) {
    ...
    return e(r, t), r.prototype.convertBytes = function(e) {
        ...
        return Be.forKey(t, this.firestore, /* converter= */ null);
    }, r;
}(m);
...
var Ae = /** @class */ function() {
    ...
    return e.prototype.get = function(e) {
        ...
        return this._delegate.get(r).then((function(e) {
            return new Qe(t._firestore, new _(t._firestore._delegate, t._userDataWriter, e._key, e._document, e.metadata, r.converter));
        }));
    ...
    return e.prototype.fromFirestore = function(e, t) {
        var r = new v(this._firestore._delegate, this._userDataWriter, e._key, e._document, e.metadata, 
        /* converter= */ null);
...
var Be = /** @class */ function() {
    ...
    return e.forPath = function(t, r, n) {
        if (t.length % 2 != 0) throw new ye(he, "Invalid document reference. Document references must have an even number of segments, but " + t.canonicalString() + " has " + t.length);
        return new e(r, new w(r._delegate, n, new be(t)));
    }, e.forKey = function(t, r, n) {
        return new e(r, new w(r._delegate, n, t));
        ...
        try {
            ...
            throw Ne(e, "collection()", "DocumentReference.collection()");
        }
    }, e.prototype.isEqual = function(e) {
        return (e = n(e)) instanceof w && b(this._delegate, e);
    }, e.prototype.set = function(e, t) {
        t = Pe("DocumentReference.set", t);
        try {
            return P(this._delegate, e, t);
        } catch (e) {
            throw Ne(e, "setDoc()", "DocumentReference.set()");
        }
    }, e.prototype.update = function(e, r) {
        for (var n = [], o = 2; o < arguments.length; o++) n[o - 2] = arguments[o];
        try {
            return 1 === arguments.length ? S(this._delegate, e) : S.apply(void 0, t([ this._delegate, e, r ], n));
        } catch (e) {
            throw Ne(e, "updateDoc()", "DocumentReference.update()");
        }
        ...
        var n = Re(t), o = qe(t, (function(t) {
            return new Qe(e.firestore, new _(e.firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, e._delegate.converter));
        }));
        return D(this._delegate, n, o);
    }, e.prototype.get = function(e) {
        var t = this;
        return ("cache" === (null == e ? void 0 : e.source) ? E(this._delegate) : "server" === (null == e ? void 0 : e.source) ? O(this._delegate) : j(this._delegate)).then((function(e) {
            return new Qe(t.firestore, new _(t.firestore._delegate, t._userDataWriter, e._key, e._document, e.metadata, t._delegate.converter));
        }));
    }, e.prototype.withConverter = function(t) {
        return new e(this.firestore, t ? this._delegate.withConverter(Te.getInstance(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}();
...
var Qe = /** @class */ function() {
    ...
    return Object.defineProperty(e.prototype, "ref", {
        get: function() {
            return new Be(this._firestore, this._delegate.ref);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(e.prototype, "id", {
    ...
    return e.prototype.where = function(t, r, n) {
        try {
            ...
            return new e(this.firestore, x(this._delegate, A(t, r, n)));
        } catch (e) {
            throw Ne(e, /(orderBy|where)\(\)/, "Query.$1()");
        }
        ...
        try {
            ...
            // FieldPath Compat type as input, but is not typed as such in order to
            // not expose this via our public typings file.
            return new e(this.firestore, x(this._delegate, C(t, r)));
        } catch (e) {
            throw Ne(e, /(orderBy|where)\(\)/, "Query.$1()");
        }
    }, e.prototype.limit = function(t) {
        try {
            return new e(this.firestore, x(this._delegate, T(t)));
        } catch (e) {
            throw Ne(e, "limit()", "Query.limit()");
        }
    }, e.prototype.limitToLast = function(t) {
        try {
            return new e(this.firestore, x(this._delegate, B(t)));
        } catch (e) {
            throw Ne(e, "limitToLast()", "Query.limitToLast()");
        }
    }, e.prototype.startAt = function() {
        for (var t = [], r = 0; r < arguments.length; r++) t[r] = arguments[r];
        try {
            return new e(this.firestore, x(this._delegate, N.apply(void 0, t)));
        } catch (e) {
            throw Ne(e, "startAt()", "Query.startAt()");
        }
    }, e.prototype.startAfter = function() {
        for (var t = [], r = 0; r < arguments.length; r++) t[r] = arguments[r];
        try {
            return new e(this.firestore, x(this._delegate, R.apply(void 0, t)));
        } catch (e) {
            throw Ne(e, "startAfter()", "Query.startAfter()");
        }
    }, e.prototype.endBefore = function() {
        for (var t = [], r = 0; r < arguments.length; r++) t[r] = arguments[r];
        try {
            return new e(this.firestore, x(this._delegate, q.apply(void 0, t)));
        } catch (e) {
            throw Ne(e, "endBefore()", "Query.endBefore()");
        }
        ...
        try {
            ...
            throw Ne(e, "endAt()", "Query.endAt()");
        }
    }, e.prototype.isEqual = function(e) {
        return W(this._delegate, e._delegate);
    }, e.prototype.get = function(e) {
        var t = this;
        return ("cache" === (null == e ? void 0 : e.source) ? L(this._delegate) : "server" === (null == e ? void 0 : e.source) ? U(this._delegate) : k(this._delegate)).then((function(e) {
            return new ke(t.firestore, new V(t.firestore._delegate, t._userDataWriter, t._delegate, e._snapshot));
        }));
    }, e.prototype.onSnapshot = function() {
        for (var e = this, t = [], r = 0; r < arguments.length; r++) t[r] = arguments[r];
        var n = Re(t), o = qe(t, (function(t) {
            return new ke(e.firestore, new V(e.firestore._delegate, e._userDataWriter, e._delegate, t._snapshot));
        }));
        return D(this._delegate, n, o);
    }, e.prototype.withConverter = function(t) {
        return new e(this.firestore, t ? this._delegate.withConverter(Te.getInstance(this.firestore, t)) : this._delegate.withConverter(null));
    ...
    return e(r, t), Object.defineProperty(r.prototype, "id", {
        ...
        get: function() {
            ...
            return e ? new Be(this.firestore, e) : null;
        },
        enumerable: !1,
        configurable: !0
    }), r.prototype.doc = function(e) {
        try {
            return new Be(this.firestore, void 0 === e ? f(this._delegate) : f(this._delegate, e));
        } catch (e) {
            throw Ne(e, "doc()", "CollectionReference.doc()");
        }
    }, r.prototype.add = function(e) {
        var t = this;
        return K(this._delegate, e).then((function(e) {
            return new Be(t.firestore, e);
        }));
    }, r.prototype.isEqual = function(e) {
        return b(this._delegate, e._delegate);
    }, r.prototype.withConverter = function(e) {
        return new r(this.firestore, e ? this._delegate.withConverter(Te.getInstance(this.firestore, e)) : this._delegate.withConverter(null));
    }, r;
}(Le);
 ...
 * limitations under the License.
 */ function ze(e) {
    return H(this._delegate, e);
}

function Me(e) {
    var t = this;
    return Y(this._delegate, e).then((function(e) {
        return e ? new Le(t, 
 ...
 */
    function(e, t) {
        ...
        return new Fe(e, t, new je);
    })), e.registerVersion("@firebase/firestore-compat", "0.0.900-exp.d92a36260");
}

He(r), (Je = Fe).prototype.loadBundle = ze, Je.prototype.namedQuery = Me;

export { He as registerFirestore };
