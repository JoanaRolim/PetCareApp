 ...
 */ function A(t) {
    ...
    if (N.logLevel <= h.DEBUG) {
        var r = e.map(C);
        N.debug.apply(N, b([ "Firestore (8.4.3): " + t ], r));
    }
}
...
function k(t) {
    ...
    if (N.logLevel <= h.ERROR) {
        var r = e.map(C);
        N.error.apply(N, b([ "Firestore (8.4.3): " + t ], r));
    }
}
...
function x(t) {
    ...
    if (N.logLevel <= h.WARN) {
        var r = e.map(C);
        N.warn.apply(N, b([ "Firestore (8.4.3): " + t ], r));
    }
}
 ...
 */ function R(t) {
    ...
    // exception is swallowed.
        var e = "FIRESTORE (8.4.3) INTERNAL ASSERTION FAILED: " + t;
 ...
 */ var U = /** @class */ function() {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new S(E.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new S(E.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new S(E.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new S(E.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
 ...
 */ var Q = /** @class */ function() {
    ...
    e.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var s = o[i];
            if (s.indexOf("//") >= 0) throw new S(E.INVALID_ARGUMENT, "Invalid segment (" + s + "). Paths must not contain // in them.");
    ...
    e.fromServerFormat = function(t) {
        for (var n = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new S(E.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            n.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new S(E.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new S(E.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new S(E.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new e(n);
    }, e.emptyPath = function() {
        return new e([]);
    }, e;
...
var kt = /** @class */ function(t) {
     ...
     */    return w(e, t), e.create = function(t, n, r) {
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.l(t, n, r) : new xt(t, n, r) : "array-contains" /* ARRAY_CONTAINS */ === n ? new Pt(t, r) : "in" /* IN */ === n ? new Lt(t, r) : "not-in" /* NOT_IN */ === n ? new Ft(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new Mt(t, r) : new e(t, n, r);
    }, e.l = function(t, e, n) {
...
/** A Filter that implements the array-contains operator. */ var Pt = /** @class */ function(t) {
    function e(e, n) {
 ...
 */ function De(t, e, n) {
    t instanceof Re ? function(t, e, n) {
        ...
        if (Se(t.precondition, e)) {
            ...
            i.setAll(Pe(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Ae(t, e, n) {
    t instanceof Re ? function(t, e, n) {
        ...
        if (Se(t.precondition, e)) {
            ...
            i.setAll(Pe(t)), i.setAll(r), e.convertToFoundDocument(Ce(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        Se(t.precondition, e) && 
...
/** A mutation that deletes the document at the given key. */ var Me, Ve, qe = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
 ...
 */ function Ke(t) {
    ...
    return k("GRPC error has no .code"), E.UNKNOWN;
    switch (t) {
      case Me.OK:
        return E.OK;
 ...
 *     Code.UNKNOWN.
 */ (Ve = Me || (Me = {}))[Ve.OK = 0] = "OK", Ve[Ve.CANCELLED = 1] = "CANCELLED", 
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.rt = function(t) {
        ...
        if (r) {
            ...
            if (At(i)) if (0 === n) {
                ...
                // queries.
                var o = new ut(i.path);
                this.tt(e, o, _t.newNoDocument(o, B.min()));
    ...
    t.prototype.ut = function(t) {
        ...
        return this.H = Xe(), this.J = dn(), this.Y = new We(M), i;
    }, 
    /**
    ...
    t.prototype.U = function(t) {
        ...
        var e = this.J.get(t);
        return e || (e = new We(M), this.J = this.J.insert(t, e)), e;
    }, 
    /**
...
function Sn(t, e) {
    var n = _n(e);
    if (n.get(1) !== t.databaseId.projectId) throw new S(E.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
    if (n.get(3) !== t.databaseId.database) throw new S(E.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
    return new ut(kn(n));
}
...
function On(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Ee.updateTime(In(t.updateTime)) : void 0 !== t.exists ? Ee.exists(t.exists) : Ee.none();
                  ...
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, r) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            "VersionError" === n.name ? r(new S(E.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r(new Tr(t, n));
...
/** Decodes a remote document from storage locally to a Document. */ function Pr(t, e) {
    if (e.document) return Cn(t.Lt, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        var n = ut.fromSegments(e.noDocument.path), r = qr(e.noDocument.readTime), i = _t.newNoDocument(n, r);
...
/** Encodes a document for storage locally. */ function Lr(t, e, n) {
    var r = Fr(n), i = e.key.path.popLast().toArray();
...
function jr(t, e) {
    ...
    n = At(e.target) ? Pn(t.Lt, e.target) : Ln(t.Lt, e.target);
...
var ei = /** @class */ function() {
    ...
    t.prototype.jt = function(t, e) {
        ...
        var n = this, r = e.path, i = r.length + 1, o = nr.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new We(M);
        return ii(t).Ot({
            range: s
        }, (function(t, e, o) {
 ...
 */ function fi(t) {
    return I(this, void 0, void 0, (function() {
        return T(this, (function(e) {
            if (t.code !== E.FAILED_PRECONDITION || t.message !== yr) throw t;
            ...
            return I(e, void 0, void 0, (function() {
                ...
                return T(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return _r(e = n.sent()) ? (A("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return w(e, t), e.prototype.applyChanges = function(t) {
        ...
        return this.changes.forEach((function(o, s) {
            ...
            if (s.document.isValidDocument()) {
                ...
                var h = Lr(e.Ie.R, _t.newNoDocument(o, B.min()), e.getReadTime(o));
...
var Di = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Ai = /** @class */ function() {
    ...
    h) {
        ...
        }, !t.yt()) throw new S(E.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new S(E.FAILED_PRECONDITION, Di);
    ...
    t.prototype.fn = function() {
        ...
        return this.Be.runTransaction(t, o, pr, (function(o) {
            return i = new Ar(o, r.Ne ? r.Ne.next() : _.o), "readwrite-primary" === e ? r.Je(i).next((function(t) {
                return !!t || r.Ye(i);
            })).next((function(e) {
                if (!e) throw k("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Se.enqueueRetryable((function() {
                    return r.Me(!1);
                })), new S(E.FAILED_PRECONDITION, yr);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.dn = function(t) {
        var e = this;
        return ki(t).get(Zn.key).next((function(t) {
            if (null !== t && e.sn(t.leaseTimestampMs, 5e3) && !e.cn(t.ownerId) && !e.tn(t) && !(e.Ce || e.allowTabSynchronization && t.allowTabSynchronization)) throw new S(E.FAILED_PRECONDITION, Di);
        }));
    }, 
    /**
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Rn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    h = _t.newInvalidDocument(c), r = r.insert(c, h)), Ae(a, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
...
function Hi(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = P(t), i = Xe(), o = Fr(n), s = _i(e), u = IDBKeyRange.lowerBound(o, !0);
            return s.Ot({
 ...
 */ function Xi(t, e, n, r) {
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(p) {
            switch (p.label) {
              case 0:
                for (i = P(t), o = nn(), s = Xe(), u = tn(), a = 0, c = n; a < c.length; a++) h = c[a], 
 ...
 */ var $i = /** @class */ function() {
    ...
    return t.Gn = function(t, e) {
        return ut.comparator(t.key, e.key) || M(t.ns, e.ns);
    }, 
    /** Compare by ID then by key */ t.Hn = function(t, e) {
        return M(t.ns, e.ns) || ut.comparator(t.key, e.key);
    }, t;
}(), eo = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.checkEmpty = function(t) {
        ...
        var o = new to(new ut(i), 0), s = new We(M);
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return gr.resolve(n ? n.document.clone() : _t.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = Xe();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
...
var lo = /** @class */ function() {
    ...
    function t(t, e, n, r, i) {
        ...
        this.ks = new Ge(M), this.started = !1, 
        /**
    ...
    return w(u, t), u.prototype.ki = function(t, e, n, r) {
            ...
            s.listenOnce(l.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case d.TIMEOUT:
                        A("Connection", 'RPC "' + t + '" timed out'), o(new S(E.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case d.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new S(u, r.message));
                            } else o(new S(E.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new S(E.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var d = c.createWebChannel(l, f), w = !1, b = !1, I = new _o({
            Ei: function(t) {
        ...
        return T(d, v.EventType.OPEN, (function() {
            ...
            b || (b = !0, x("Connection", "WebChannel transport errored:", t), I.Vi(new S(E.UNAVAILABLE, "The operation could not be completed")));
 ...
 */ var Ao = /** @class */ function() {
    ...
    t.prototype.ar = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new S(E.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.dr(e);
            }));
        }));
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    var e = void 0 === t.code ? E.UNKNOWN : Ke(t.code);
            ...
            i = Sn(t, r.document), o = r.readTime ? In(r.readTime) : B.min(), u = _t.newNoDocument(i, o), 
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (O(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        n = In(e)), new _e(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
    ...
    return w(e, t), e.prototype.br = function() {
        if (this.Rr) throw new S(E.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ e.prototype.Ni = function(t, e, n) {
        ...
        return this.br(), this.credentials.getToken().then((function(i) {
            ...
            throw "FirebaseError" === t.name ? (t.code === E.UNAUTHENTICATED && r.credentials.invalidateToken(), 
            t) : new S(E.UNKNOWN, t.toString());
        }));
    }, 
                        ...
                        [ 4 /*yield*/ , function(t) {
                            return I(this, void 0, void 0, (function() {
                                ...
                                return T(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = P(t)).$r.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Fo(e) ];
        ...
        return T(this, (function(i) {
            switch (i.label) {
              case 0:
                ...
                return t.$r.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Fo(t) ];
...
function Xo(t) {
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(s) {
            switch (s.label) {
              case 0:
                e = P(t), n = os(e), r = e.kr.length > 0 ? e.kr[e.kr.length - 1].batchId : -1, s.label = 1;
                ...
                return e && os(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return I(this, void 0, void 0, (function() {
                        ...
                        return T(this, (function(i) {
                            switch (i.label) {
                              case 0:
                                return je(r = e.code) && r !== E.ABORTED ? (n = t.kr.shift(), 
 ...
 */ function rs(t, e) {
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(i) {
            switch (i.label) {
              case 0:
                return n = P(t), e ? (n.$r.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Lo(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return i.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (r = e) ? [ 3 /*break*/ , 4 ] : (n.$r.add(2 /* IsSecondary */), [ 4 /*yield*/ , Fo(n) ]);
...
var ss = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new S(E.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
 ...
 */ function us(t, e) {
    if (k("AsyncQueue", e + ": " + t), _r(t)) return new S(E.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ function ds(t, e) {
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(c) {
            switch (c.label) {
              case 0:
                if (n = P(t), r = e.query, i = !1, (o = n.queries.get(r)) || (i = !0, o = new fs), 
                !i) return [ 3 /*break*/ , 4 ];
                c.label = 1;
 ...
 */ var gs = /** @class */ function() {
    ...
    t.prototype.Un = function(t) {
        return t.metadata.exists ? Cn(this.R, t.document, !1) : _t.newNoDocument(this.qn(t.metadata.name), this.Qn(t.metadata.readTime));
        ...
        return I(this, void 0, void 0, (function() {
            ...
            return T(this, (function(o) {
                switch (o.label) {
                  ...
                  case 2:
                    return n < r.length ? (i = r[n], [ 4 /*yield*/ , Ji(this.localStore, i, e.get(i.name)) ]) : [ 3 /*break*/ , 5 ];
            ...
            switch (u.label) {
              ...
              case 1:
                return u.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = P(t), i = U.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), nn());
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Mn.pn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                ...
                                // exists=true
                                s.push(new Oe(c.key, h, Tt(h.toProto().mapValue), Ee.exists(!0)));
                            }
              ...
              case 2:
                return i = u.sent(), r.sharedClientState.addPendingMutation(i.batchId), function(t, e, n) {
                    ...
                    r || (r = new Ge(M)), r = r.insert(e, n), t.xo[t.currentUser.toKey()] = r;
        ...
        return T(this, (function(c) {
            switch (c.label) {
              case 0:
                ...
                (o = i && i.key) ? (s = (s = new Ge(ut.comparator)).insert(o, _t.newNoDocument(o, B.min())), 
                u = nn().add(o), a = new sn(B.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new We(M), s, u), [ 4 /*yield*/ , Os(r, a) ]) : [ 3 /*break*/ , 2 ];
 ...
 */ function Vs(t, e) {
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(u) {
            switch (u.label) {
              case 0:
                Ko((n = P(t)).remoteStore) || A("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                u.label = 1;
...
function Ks(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof _s ? (t.No.addReference(o.key, e), Gs(t, o)) : o instanceof Es ? (A("SyncEngine", "Document no longer in limbo: " + o.key), 
 ...
 */ function Qs(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Co.set(r, new Ds(n)), t.Do = t.Do.insert(n, r), Mo(t.remoteStore, new Rr(Zt(zt(n.path)), r, 2 /* LimboResolution */ , _.o));
    }
}
...
function Ws(t, e) {
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(i) {
            switch (i.label) {
              case 0:
                return (n = P(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (A("SyncEngine", "User change. New user:", e.toKey()), 
              ...
              case 1:
                ...
                function(t, e) {
                    t.Fo.forEach((function(t) {
                        t.forEach((function(t) {
                            t.reject(new S(E.CANCELLED, "'waitForPendingWrites' promise is rejected due to a user change."));
                        }));
                    })), t.Fo.clear();
                }(n), 
 ...
 */ function Ys(t, e) {
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(o) {
            switch (o.label) {
              case 0:
                return [ 4 /*yield*/ , zi((n = P(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];
...
function Xs(t) {
    return I(this, void 0, void 0, (function() {
        var e;
        return T(this, (function(n) {
            return [ 2 /*return*/ , Hi((e = P(t)).localStore).then((function(t) {
                return zs(e, t);
            })) ];
        }));
    }));
...
function $s(t, e) {
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(h) {
            switch (h.label) {
              case 0:
                return iu(n = P(t)), ou(n), !0 !== e || !0 === n.Oo ? [ 3 /*break*/ , 3 ] : (r = n.sharedClientState.getAllActiveQueryTargets(), 
...
function iu(t) {
    ...
    e.remoteStore.remoteSyncer.rejectListen = Ls.bind(null, e), e.vo._r = ys.bind(null, e.eventManager), 
    e.vo.Mo = vs.bind(null, e.eventManager), e;
}

function ou(t) {
    var e = P(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = Fs.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = Ms.bind(null, e), 
    e
    /**
...
var uu = /** @class */ function() {
    ...
    return w(e, t), e.prototype.initialize = function(e) {
        ...
        var e = So();
        if (!go.yt(e)) throw new S(E.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
    ...
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return Ps(n.syncEngine, t, 1 /* SharedClientState */);
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return Ps(s.syncEngine, t, 0 /* RemoteStore */);
        }, o = Io.yt() ? new Io : new bo, new Po(e, n, r, i, o);
        ...
        return function(t) {
            return I(this, void 0, void 0, (function() {
                ...
                return T(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = P(t), A("RemoteStore", "RemoteStore shutting down."), e.$r.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , Fo(e) ];
 ...
 */ var lu = /** @class */ function() {
    ...
    return t.prototype.lookup = function(t) {
        return I(this, void 0, void 0, (function() {
            ...
            return T(this, (function(r) {
                switch (r.label) {
                  case 0:
                    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new S(E.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, e) {
                        return I(this, void 0, void 0, (function() {
                            var n, r, i, o, s, u;
                            return T(this, (function(a) {
                                switch (a.label) {
                                  case 0:
                                    return n = P(t), r = An(n.R) + "/documents", i = {
        ...
        if (n) {
            ...
            throw new S(E.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.preconditionForUpdate = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new S(E.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    e, n) {
        ...
        this.clientId = F.u(), this.credentialListener = function() {
            return Promise.resolve();
    ...
    t.prototype.verifyNotTerminated = function() {
        if (this.asyncQueue.isShuttingDown) throw new S(E.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.terminate = function() {
        var t = this;
                    ...
                    return function(t, e) {
                        return I(this, void 0, void 0, (function() {
                            ...
                            return T(this, (function(i) {
                                switch (i.label) {
                                  case 0:
                                    return (n = P(t)).asyncQueue.verifyOperationInProgress(), A("RemoteStore", "RemoteStore received new credentials"), 
                                    r = Ko(n), 
                                    // Tear down and re-create our network streams. This will ensure we get a
                                    // fresh auth token for the new user and re-fill the write pipeline with
                                    // new mutations from the LocalStore (since mutations are per-user).
                                    n.$r.add(3 /* CredentialChange */), [ 4 /*yield*/ , Fo(n) ];
                    ...
                    return r = function(t, e, n, r, i) {
                        var o = new lu({
                            next: function(n) {
                                ...
                                e.enqueueAndForget((function() {
                                    return ps(t, s);
                                })), n.fromCache && "server" === r.source ? i.reject(new S(E.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
...
function(t, e, n, r, i, o, s) {
    ...
    function t(t) {
        ...
        this.ac = function() {
            e.cc++, e.oc.resolve(), e.currentUser = e.hc(), e.uc && e.asyncQueue.enqueueRetryable((function() {
                return e.changeListener(e.currentUser);
            }));
        }, this.cc = 0;
        var n = function(t) {
            A("FirebaseCredentialsProvider", "Auth detected"), e.auth = t, e.lc(), e.auth.addAuthTokenListener(e.ac);
        };
        t.onInit((function(t) {
            return n(t);
        })), 
        ...
        setTimeout((function() {
            if (!e.auth) {
                ...
                // token
                A("FirebaseCredentialsProvider", "Auth not yet detected"), e.ac());
            }
        }), 0), this.lc();
    }
    return t.prototype.getToken = function() {
    ...
    t.prototype.lc = function() {
        ...
        // Prevent double-firing of the listener
            ...
            e.promise.then((function() {
                return e.resolve();
            })), this.oc = e, this.asyncQueue.enqueueRetryable((function() {
                return I(t, void 0, void 0, (function() {
                    return T(this, (function(t) {
                        switch (t.label) {
                          case 0:
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Lu(this.fc, this.dc, this.wc));
    }, t.prototype.setChangeListener = function(t, e) {
 ...
 */
function Mu(t, e, n) {
    if (!n) throw new S(E.INVALID_ARGUMENT, "Function " + t + "() cannot be called with an empty " + e + ".");
}
...
function Vu(t, e) {
    ...
    if (void 0 !== e.mergeFields && void 0 !== e.merge) throw new S(E.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
 ...
 */ function qu(t, e, n, r) {
    if (!0 === e && !0 === r) throw new S(E.INVALID_ARGUMENT, t + " and " + n + " cannot be used together.");
}
 ...
 */ function Uu(t) {
    if (!ut.isDocumentKey(t)) throw new S(E.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function Bu(t) {
    if (ut.isDocumentKey(t)) throw new S(E.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new S(E.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = ju(t);
        throw new S(E.INVALID_ARGUMENT, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function Gu(t, e) {
    if (e <= 0) throw new S(E.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */ var Qu = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new S(E.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new S(E.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    ...
    function t(t, e) {
        ...
        this._databaseId = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new S(E.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
            return new ku(t.options.projectId);
        }(t), this._credentials = new Pu(e));
    }
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this._app) throw new S(E.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this._app;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this._settingsFrozen) throw new S(E.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this._settings = new Qu(t), void 0 !== t.credentials && (this._credentials = function(t) {
            ...
            switch (t.type) {
              case "gapi":
                ...
                new Fu(e, t.sessionIndex || "0", t.iamToken || null);
 ...
 */ function Xu(t, e) {
    ...
    if (t = u(t), Mu("collection", "path", e), t instanceof zu) return Bu(n = z.fromString.apply(z, b([ e ], r))), 
    new Yu(t, /* converter= */ null, n);
    if (!(t instanceof Wu || t instanceof Yu)) throw new S(E.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
 ...
 */ function Ju(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = F.u()), Mu("doc", "path", e), t instanceof zu) return Uu(n = z.fromString.apply(z, b([ e ], r))), 
    new Wu(t, 
 ...
 */
function aa(t) {
    if (t._initialized || t._terminated) throw new S(E.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ var ca = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new S(E.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
     ...
     */    return t.fromBase64String = function(e) {
        try {
            ...
            throw new S(E.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
...
function(t) {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new S(E.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new S(E.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
...
/** A "context" object passed around while parsing user data. */ var ma = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Fc = function(e) {
        ...
        return Ma(t, this.settings.methodName, this.settings.qc || !1, this.path, this.settings.Uc);
    }, 
...
/** Parse document data from a set() call. */ function ba(t, e, n, r, i, o) {
    ...
    if (o.merge) u = new Y(s.fieldMask), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var d = Pa(e, l[f], n);
            if (!s.contains(d)) throw new S(E.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            Va(h, d) || h.push(d);
        }
...
/** Parse update data from a list of field/value arguments. */ function Aa(t, e, n, r, i, o) {
    var s = t.Qc(1 /* Update */ , e, n), a = [ Pa(e, r, n) ], c = [ i ];
    if (o.length % 2 != 0) throw new S(E.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var h = 0; h < o.length; h += 2) a.push(Pa(e, o[h])), c.push(o[h + 1]);
 ...
 */ function Pa(t, e, n) {
    ...
    throw Ma("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function Fa(t, e, n) {
    if (e.search(La) >= 0) throw Ma("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return (new (ca.bind.apply(ca, b([ void 0 ], e.split(".")))))._internalPath;
    } catch (r) {
        throw Ma("Invalid field path (" + e + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}
...
function Ma(t, e, n, r, i) {
    ...
    a += ")"), new S(E.INVALID_ARGUMENT, (u += ". ") + t + a)
 ...
 */
function Ba(t, e) {
    return "string" == typeof e ? Fa(t, e) : e instanceof ca ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var ja = /** @class */ function() {
    ...
    t.prototype.docChanges = function(t) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new S(E.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 * limitations under the License.
 */ function Ha(t) {
    if (Ht(t) && 0 === t.explicitOrderBy.length) throw new S(E.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var Ja = /** @class */ function(t) {
    ...
    return w(e, t), e.prototype._apply = function(t) {
        var e = wa(t.firestore), n = function(t, e, n, r, i, o, s) {
            var u;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new S(E.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            return function(t, e) {
                if (e.g()) {
                    var n = Xt(t);
                    if (null !== n && !n.isEqual(e.field)) throw new S(E.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = Yt(t);
 ...
 */
                ...
                throw i === e.op ? new S(E.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new S(E.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, l), l;
    ...
    return w(e, t), e.prototype._apply = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new S(E.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new S(E.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new Ut(e, n);
            return function(t, e) {
                if (null === Yt(t)) {
...
function nc(t, e, n, r) {
    if (n[0] = u(n[0]), n[0] instanceof qa) return function(t, e, n, r, i) {
        if (!r) throw new S(E.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        for (var o = [], s = 0, u = $t(t); s < u.length; s++) {
            ...
            if (a.field.isKeyField()) o.push(yt(e, r.key)); else {
                ...
                if (et(c)) throw new S(E.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var h = a.field.canonicalString();
                    throw new S(E.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    return function(t, e, n, r, i, o) {
        ...
        if (i.length > s.length) throw new S(E.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var u = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (s[a].field.isKeyField()) {
                if ("string" != typeof c) throw new S(E.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!Jt(t) && -1 !== c.indexOf("/")) throw new S(E.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(z.fromString(c));
                if (!ut.isDocumentKey(h)) throw new S(E.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var f = new ut(h);
                u.push(yt(e, f));
            } else {
                var l = ka(n, r, c);
...
function rc(t, e, n) {
    if ("string" == typeof (n = u(n))) {
        if ("" === n) throw new S(E.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!Jt(e) && -1 !== n.indexOf("/")) throw new S(E.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(z.fromString(n));
        if (!ut.isDocumentKey(r)) throw new S(E.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return yt(t, new ut(r));
    }
    if (n instanceof Wu) return yt(t, n._key);
    throw new S(E.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ju(n) + ".");
}
 ...
 * array requirements.
 */ function ic(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new S(E.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new S(E.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function oc(t, e, n) {
    if (!n.isEqual(e)) throw new S(E.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
...
var ac = /** @class */ function(t) {
    ...
    t.prototype.delete = function(t) {
        ...
        return this._mutations = this._mutations.concat(new qe(e._key, Ee.none())), this;
    }, 
    /**
    ...
    t.prototype.commit = function() {
        ...
        if (this._committed) throw new S(E.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();
 ...
 * called.
 */ function hc(t, e) {
    if ((t = u(t)).firestore !== e) throw new S(E.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function lc(t, e, n) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = u(e)) || e instanceof ca ? Aa(s, "updateDoc", t._key, e, n, r) : Da(s, "updateDoc", t._key, e)).toMutation(t._key, Ee.exists(!0)) ]);
}
...
/** Helper function to assert Uint8Array is available at runtime. */ function mc() {
    if ("undefined" == typeof Uint8Array) throw new S(E.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function gc() {
    if ("undefined" == typeof atob) throw new S(E.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
...
/** Immutable class holding a blob (binary data) */ var wc = /** @class */ function() {
    ...
    return t.prototype.enableIndexedDbPersistence = function(t, e) {
        ...
        return function(t) {
            var e = this;
            if (t._initialized && !t._terminated) throw new S(E.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
            var n = new mr;
    ...
    return Object.defineProperty(t.prototype, "_databaseId", {
        ...
        void 0 === n && (n = {}), function(t, e, n, r) {
            ...
            t._setSettings(Object.assign(Object.assign({}, i), {
                ...
                if (!s) throw new S(E.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
                            ...
                            return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                                return I(this, void 0, void 0, (function() {
                                    ...
                                    return T(this, (function(n) {
                                        switch (n.label) {
                                          case 0:
                                            return (e = P(t)).$r.add(0 /* UserDisabled */), [ 4 /*yield*/ , Fo(e) ];
 ...
 */;
        ...
        get: function() {
            if (!this.eu) throw new S(E.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.eu;
        },
        enumerable: !1,
        configurable: !0
        ...
        try {
            return new Fc(this, Xu(this._delegate, t));
        } catch (t) {
        ...
        try {
            return new Oc(this, function(t, e) {
                if (t = Ku(t, zu), Mu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new S(E.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new Hu(t, 
                /* converter= */ null, 
                /**
 ...
 */
        ...
        throw new S(E.FAILED_PRECONDITION, '"loadBundle()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, t.prototype.namedQuery = function(t) {
        throw new S(E.FAILED_PRECONDITION, '"namedQuery()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, t;
}(), Tc = /** @class */ function(t) {
    function e(e) {
        var n = this;
    ...
    return w(e, t), e.prototype.convertBytes = function(t) {
        ...
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Dc.nu(e, this.firestore, /* converter= */ null);
    }, e;
}(sc);
...
var Dc = /** @class */ function() {
    ...
    return t.ru = function(e, n, r) {
        if (e.length % 2 != 0) throw new S(E.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + e.canonicalString() + " has " + e.length);
        ...
        get: function() {
            return new Fc(this.firestore, this._delegate.parent);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "path", {
        ...
        try {
            return new Fc(this.firestore, Xu(this._delegate, t));
        } catch (t) {
            throw Ac(t, "collection()", "DocumentReference.collection()");
        }
    }, t.prototype.isEqual = function(t) {
        return (t = u(t)) instanceof Wu && $u(this._delegate, t);
    }, t.prototype.set = function(t, e) {
        ...
        try {
            return function(t, e, n) {
                ...
                return pc(r, [ ba(wa(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Ee.none()) ]);
            }(this._delegate, t, e);
        } catch (t) {
        ...
        return pc(Ku((t = this._delegate).firestore, ia), [ new qe(t._key, Ee.none()) ]);
        var t;
        /**
 ...
 */    }, t.prototype.onSnapshot = function() {
                                    ...
                                    return I(this, void 0, void 0, (function() {
                                        ...
                                        return T(this, (function(o) {
                                            switch (o.label) {
                                              ...
                                              case 1:
                                                return (i = o.sent()).isFoundDocument() ? n.resolve(i) : i.isNoDocument() ? n.resolve(null) : n.reject(new S(E.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                [ 3 /*break*/ , 3 ];
        ...
        return new t(this.firestore, e ? this._delegate.withConverter(Nc.su(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
var Cc = /** @class */ function() {
     ...
     */
        function(t) {
            ...
            return new Lc(e.firestore, new Qa(e.firestore._delegate, e._userDataWriter, e._delegate, t._snapshot));
        }));
    }, t.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = kc(e), i = xc(e, (function(e) {
            return new Lc(t.firestore, new Qa(t.firestore._delegate, t._userDataWriter, t._delegate, e._snapshot));
        }));
        return dc(this._delegate, r, i);
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(Nc.su(this.firestore, e)) : this._delegate.withConverter(null));
    ...
    return w(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        return function(t, e) {
            ...
            return pc(n, [ ba(wa(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, Ee.exists(!1)) ]).then((function() {
                return r;
            }));
        ...
        return new e(this.firestore, t ? this._delegate.withConverter(Nc.su(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}(Oc);
...
export { Cc as H, Rc as J, Ic as L, bc as M, U as O, Sc as Q, Ec as U, la as V, Oc as Y, Lc as Z, ia as g, Uc as i, Dc as j, wc as k, Vc as n, _c as q, Bc as r, qc as s, Fc as t, ra as y };
//# sourceMappingURL=prebuilt-ea6fb71d-c15c065b.js.map
