...
function loadBundle(data) {
    return databaseCe00c8b4.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return databaseCe00c8b4.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new databaseCe00c8b4.Query$1(this, 
...
registerBundle(databaseCe00c8b4.Firestore);
