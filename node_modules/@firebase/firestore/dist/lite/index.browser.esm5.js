...
import { _getProvider as i, getApp as o, _removeServiceInstance as s, SDK_VERSION as a, _registerComponent as u, registerVersion as c } from "@firebase/app";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var I = "ok", k = "cancelled", P = "unknown", V = "invalid-argument", D = "deadline-exceeded", N = "not-found", O = "permission-denied", F = "unauthenticated", q = "resource-exhausted", L = "failed-precondition", R = "aborted", U = "out-of-range", C = "unimplemented", j = "internal", x = "unavailable", B = /** @class */ function(e) {
    /** @hideconstructor */
    function n(
    /**
    ...
    function t(t) {
        var e = this;
        /** Tracks the current User. */        this.currentUser = m.UNAUTHENTICATED, 
        ...
        }, this.o = !1, this.forceRefresh = !1, this.auth = null, this.asyncQueue = null, 
        this.u = function() {
            e.i++, e.currentUser = e.h(), e.t.resolve(), e.o && e.asyncQueue.enqueueRetryable((function() {
                return e.changeListener(e.currentUser);
            }));
        };
        var n = function(t) {
            w("FirebaseCredentialsProvider", "Auth detected"), e.auth = t, e.l(), e.auth.addAuthTokenListener(e.u);
        };
        t.onInit((function(t) {
            return n(t);
        })), 
        ...
        setTimeout((function() {
            if (!e.auth) {
                ...
                // with null token
                w("FirebaseCredentialsProvider", "Auth not yet detected"), e.asyncQueue.enqueueRetryable((function() {
                    return e.changeListener(e.currentUser);
                })));
            }
        }), 0);
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            t.getToken()) : n ? (S("string" == typeof n.accessToken), new G(n.accessToken, t.currentUser)) : null;
        ...
        this.auth && this.auth.removeAuthTokenListener(this.u), this.changeListener = function() {
            return Promise.resolve();
        };
    }, 
    ...
    t.prototype.h = function() {
        ...
        return S(null === t || "string" == typeof t), new m(t);
    }, 
    /**
            ...
            return e(t, void 0, void 0, (function() {
                return n(this, (function(t) {
                    switch (t.label) {
                      ...
                      case 2:
                        return t.sent(), this.o = !0, [ 2 /*return*/ ];
                    }
                }));
            }));
        })));
    ...
    function t(t, e, n) {
        this.m = t, this.p = e, this.g = n, this.type = "FirstParty", this.user = m.FIRST_PARTY;
    }
...
function(t, e, n, r, i, o, s) {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var s = o[i];
            if (s.indexOf("//") >= 0) throw new B(V, "Invalid segment (" + s + "). Paths must not contain // in them.");
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new B(V, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var a = t[i];
            if ("\\" === a) {
                ...
                var u = t[i + 1];
                if ("\\" !== u && "." !== u && "`" !== u) throw new B(V, "Path has invalid escape sequence: " + t);
                r += u, i += 2;
            } else "`" === a ? (s = !s, i++) : "." !== a || s ? (r += a, i++) : (o(), i++);
        }
        if (o(), s) throw new B(V, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.emptyPath = function() {
        return new n([]);
    }, n;
 ...
 */
function nt(t, e, n) {
    if (!n) throw new B(V, "Function " + t + "() cannot be called with an empty " + e + ".");
}
 ...
 */ function rt(t) {
    if (!et.isDocumentKey(t)) throw new B(V, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function it(t) {
    if (et.isDocumentKey(t)) throw new B(V, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        ...
        var n = ot(t);
        throw new B(V, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function at(t, e) {
    if (e <= 0) throw new B(V, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
...
function dt(t) {
    ...
    // https://github.com/googleapis/googleapis/blob/master/google/rpc/code.proto
      ...
      default:
        return t >= 200 && t < 300 ? I : t >= 400 && t < 500 ? L : t >= 500 && t < 600 ? j : P;
    }
}
...
var pt = /** @class */ function(r) {
    ...
    function i(t, e) {
        var n = this;
        return (n = r.call(this, t) || this).N = e, n;
    }
    /**
     * Base class for all Rest-based connections to the backend (WebChannel and
     * HTTP).
     */
    return t(i, r), i.prototype.D = function(t, e) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.N(r, {
                        method: "POST",
                        headers: i,
                        body: t
                    }) ];
                  ...
                  case 3:
                    throw s = n.sent(), new B(dt(s.status), "Request failed with error: " + s.statusText);
    ...
    return t.prototype.I = function(t, e, n, r) {
        var i = this.A(t, e);
        w("RestConnection", "Sending: ", i, n);
        var o = {};
        return this.P(o, r), this.R(t, i, o, n).then((function(t) {
    ...
    t.prototype.P = function(t, e) {
        if (t["X-Goog-Api-Client"] = "gl-js/ fire/" + y, 
...
/** Extracts the backend's type order for the provided value. */ function Ot(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? Vt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : E();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Ft(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return gt(t.arrayValue.values || [], e.arrayValue.values || [], Ft);
 ...
 */ var Mt = /** @class */ function() {
    ...
    /** Returns the full protobuf representation. */ t.prototype.toProto = function() {
        return this.field(tt.emptyPath());
    }, 
    /**
    ...
    t.prototype.buildProto = function() {
        var t = this.applyOverlay(tt.emptyPath(), this.overlayMap);
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , bt.min(), Mt.empty(), 0 /* SYNCED */);
    }, 
    /**
...
var zt = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.S(t, e, r) : new Wt(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Jt(t, r) : "in" /* IN */ === e ? new Zt(t, r) : "not-in" /* NOT_IN */ === e ? new $t(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new te(t, r) : new n(t, e, r);
    }, n.S = function(t, e, n) {
        return "in" /* IN */ === e ? new Yt(t, n) : new Kt(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.q(Lt(e, this.value)) : null !== e && Ot(this.value) === Ot(e) && this.q(Lt(e, this.value));
 ...
 */ function le(t) {
    var e = A(t);
    if (!e.L) if ("F" /* First */ === e.limitType) e.L = Qt(e.path, e.collectionGroup, fe(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = fe(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new ne(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var a = e.endAt ? new ee(e.endAt.position, !e.endAt.before) : null, u = e.startAt ? new ee(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.L = Qt(e.path, e.collectionGroup, n, e.filters, e.limit, a, u);
    }
    return e.L;
}
...
/** Used to represent a field transform on a mutation. */ var de = function() {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).k = t, r.M = n, r;
    }
    return t(n, e), n;
}(de), ge = function(t, e) {
 ...
 */
function Pe(t, e) {
    return t.U ? new Date(1e3 * e.seconds).toISOString().replace(/\.\d*/, "").replace("Z", "") + "." + ("000000000" + e.nanoseconds).slice(-9) + "Z" : {
        seconds: "" + e.seconds,
        nanos: e.nanoseconds
    };
}
 ...
 */ var Qe = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.j = t, this.timerId = e, this.B = n, this.W = r, this.G = i, this.H = 0, this.Y = null, 
    ...
    t.prototype.Z = function(t) {
        ...
        // honored as such).
        var n = Math.floor(this.H + this.X()), r = Math.max(0, Date.now() - this.K), i = Math.max(0, n - r);
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && w("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.H + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).credentials = t, i.et = n, i.k = r, i.nt = !1, 
        i;
    }
    return t(n, e), n.prototype.st = function() {
        if (this.nt) throw new B(L, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.I = function(t, e, n) {
        var r = this;
        return this.st(), this.credentials.getToken().then((function(i) {
            return r.et.I(t, e, n, i);
        })).catch((function(t) {
...
function We(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = A(t), i = Re(e.k) + "/documents", o = {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                ...
                }(e.k, le(r)), [ 4 /*yield*/ , e.V("RunQuery", i.parent, {
 ...
 */ function Je(t) {
    ...
    if (!Xe.has(t)) {
        ...
        new K(i, o, s, a.host, a.ssl, a.experimentalForceLongPolling, a.experimentalAutoDetectLongPolling))), n = He(t._databaseId), r = function(t, e, n) {
            return new ze(t, e, n);
        }(t._credentials, e, n);
        Xe.set(t, r);
    }
 ...
 */ var Ze = /** @class */ function() {
    function t(t) {
        ...
        function(t, e, n, r) {
            if (!0 === e && !0 === r) throw new B(V, "experimentalForceLongPolling and experimentalAutoDetectLongPolling cannot be used together.");
    ...
    function t(t, e) {
        ...
        this._settingsFrozen = !1, t instanceof X ? (this._databaseId = t, this._credentials = new H) : (this._app = t, 
    ...
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new Ze(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new H;
            switch (t.type) {
              case "gapi":
                var e = t.client;
              ...
              default:
                throw new B(V, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */ function nn(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, i), {
        ...
        t._credentials = new Q(new G(o, new m(s)));
    }
}
 ...
 * terminated.
 */ function rn(t) {
    return t = st(t, $e), s(t.app, "firestore/lite"), t._delete()
    /**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 */ function un(t, e) {
    ...
    if (t = h(t), nt("collection", "path", e), t instanceof $e) {
        var o = Z.fromString.apply(Z, r([ e ], n));
        return it(o), new an(t, /* converter= */ null, o);
    }
    if (!(t instanceof on || t instanceof an)) throw new B(V, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = Z.fromString.apply(Z, r([ t.path ], n)).child(Z.fromString(e));
    return it(s), new an(t.firestore, 
    /* converter= */ null, s);
}
 ...
 */ function cn(t, e) {
    if (t = st(t, $e), nt("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new B(V, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new sn(t, 
    /* converter= */ null, 
    /**
...
function fn(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = mt.$()), nt("doc", "path", e), t instanceof $e) {
        var o = Z.fromString.apply(Z, r([ e ], n));
        return rt(o), new on(t, 
        /* converter= */ null, new et(o));
    }
    if (!(t instanceof on || t instanceof an)) throw new B(V, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(Z.fromString.apply(Z, r([ e ], n)));
    return rt(s), new on(t.firestore, t instanceof an ? t.converter : null, new et(s));
}
 ...
 * Firestore database.
 */ function ln(t, e) {
    return t = h(t), e = h(e), (t instanceof on || t instanceof an) && (e instanceof on || e instanceof an) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function(t) {
    ...
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Te(t, this.data, this.fieldMask, e, this.fieldTransforms) : new _e(t, this.data, e, this.fieldTransforms);
    }, t;
}(), bn = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Tn = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.ot = function(e) {
        ...
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.ot({
            path: n,
            at: !1
        });
        return r.ct(t), r;
        ...
        return Mn(t, this.settings.methodName, this.settings.dt || !1, this.path, this.settings.wt);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (_n(this.it) && gn.test(t)) throw this.ft('Document fields cannot begin and end with "__"');
    }, t;
}(), En = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.prototype.yt = function(t, e, n, r) {
...
/** Parse document data from a set() call. */ function An(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.yt(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Cn("Data must be an object, but it was:", s, r);
    var a, u, c = Rn(r, s);
    if (o.merge) a = new Et(s.fieldMask), u = s.fieldTransforms; else if (o.mergeFields) {
        for (var f = [], l = 0, h = o.mergeFields; l < h.length; l++) {
            var d = jn(e, h[l], n);
            if (!s.contains(d)) throw new B(V, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            Gn(f, d) || f.push(d);
        }
        a = new Et(f), u = s.fieldTransforms.filter((function(t) {
            return a.covers(t.field);
        }));
    } else a = null, u = s.fieldTransforms;
    return new wn(new Mt(c), a, u);
}
...
var Pn = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        return new ge(t.path, new pe);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(mn), Vn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = kn(this, t, 
        /*array=*/ !0), n = this._t.map((function(t) {
            return Ln(t, e);
        })), r = new ye(n);
...
}(mn), Nn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).gt = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new ve(t.k, he(t.k, this.gt));
...
/** Parse update data from an update() call. */ function On(t, e, n, r) {
    var i = t.yt(1 /* Update */ , e, n);
    Cn("Data must be an object, but it was:", i, r);
    var o = [], s = Mt.empty();
    Tt(r, (function(t, r) {
        var a = Bn(e, t, n);
    ...
    var a = new Et(o);
    return new bn(s, a, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Fn(t, e, n, r, i, o) {
    var s = t.yt(1 /* Update */ , e, n), a = [ jn(e, r, n) ], u = [ i ];
    if (o.length % 2 != 0) throw new B(V, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) a.push(jn(e, o[c])), u.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var f = [], l = Mt.empty(), d = a.length - 1; d >= 0; --d) if (!Gn(f, a[d])) {
        var p = a[d], y = u[d];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        y = h(y);
    ...
    var g = new Et(f);
    return new bn(l, g, s.fieldTransforms);
}
 ...
 */ function qn(t, e, n, r) {
    return void 0 === r && (r = !1), Ln(n, t.yt(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Ln(t, e) {
    ...
    // from firestore-exp.
    t = h(t))) return Cn("Unsupported field value:", e, t), Rn(t, e);
    if (t instanceof mn) 
    ...
    return function(t, e) {
        ...
        if (!_n(e.it)) throw e.ft(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return he(e.k, t);
        ...
        if (t instanceof yn) return {
            bytesValue: Ve(e.k, t._byteString)
        };
        if (t instanceof on) {
            var i = e.databaseId, o = t.firestore._databaseId;
            if (!o.isEqual(i)) throw e.ft("Document reference is for database " + o.projectId + "/" + o.database + " but should be for database " + i.projectId + "/" + i.database);
            return {
                referenceValue: Oe(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.ft("Unsupported field value: " + ot(t));
    }(t, e);
}
...
function Un(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof wt || t instanceof vn || t instanceof yn || t instanceof on || t instanceof mn);
}
...
function Cn(t, e, n) {
    if (!Un(n) || !function(t) {
        ...
        var r = ot(n);
        throw "an object" === r ? e.ft(t + " a custom object") : e.ft(t + " " + r);
    }
}
 ...
 * evaluated.
 */ function Bn(t, e, n) {
    if (e.search(xn) >= 0) throw Mn("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
 ...
 */
function Wn(t, e) {
    return t = h(t), e = h(e), t instanceof Hn && e instanceof Hn ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof zn && e instanceof zn && hn(t.query, e.query) && gt(t.docs, e.docs, Wn)
    /**
 * Helper that calls fromDotSeparatedString() but wraps any error thrown.
 */;
}
...
var Jn = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).vt = t, i.bt = n, i.Et = r, i.type = "where", 
        i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Sn(t.firestore), n = function(t, e, n, r, i, o, s) {
            var a;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new B(V, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
                if ("in" /* IN */ === o || "not-in" /* NOT_IN */ === o) {
                    hr(s, o);
                    for (var u = [], c = 0, f = s; c < f.length; c++) {
                        var l = f[c];
                        u.push(lr(r, t, l));
                    }
                    a = {
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || hr(s, o), 
            a = qn(n, "where", s, 
            /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
            var h = zt.create(i, o, a);
            return function(t, e) {
                if (e.O()) {
                    var n = ue(t);
                    if (null !== n && !n.isEqual(e.field)) throw new B(V, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = ae(t);
 ...
 */
                ...
                throw i === e.op ? new B(V, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new B(V, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, h), h;
        }(t._query, 0, e, t.firestore._databaseId, this.vt, this.bt, this.Et);
...
var $n = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).vt = t, r.Tt = n, r.type = "orderBy", r;
    }
    return t(n, e), n.prototype._apply = function(t) {
...
var ir = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.Pt = n, i.Rt = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = fr(t, this.type, this.Pt, this.Rt);
        return new sn(t.firestore, t.converter, function(t, e) {
...
/** Helper function to create a bound from a document or fields */ function fr(t, e, n, r) {
    if (n[0] = h(n[0]), n[0] instanceof Hn) return function(t, e, n, r, i) {
        ...
        // results.
        for (var o = [], s = 0, a = fe(t); s < a.length; s++) {
            var u = a[s];
            if (u.field.isKeyField()) o.push(Ut(e, r.key)); else {
                var c = r.data.field(u.field);
                if (Vt(c)) throw new B(V, 'Invalid query. You are trying to start or end a query using a document for which the field "' + u.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var f = u.field.canonicalString();
                    throw new B(V, "Invalid query. You are trying to start or end a query using a document for which the field '" + f + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    var i = Sn(t.firestore);
    return function(t, e, n, r, i, o) {
        // Use explicit order by's because it has to match the query the user made
        var s = t.explicitOrderBy;
        if (i.length > s.length) throw new B(V, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var a = [], u = 0; u < i.length; u++) {
            var c = i[u];
            if (s[u].field.isKeyField()) {
                if ("string" != typeof c) throw new B(V, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!ce(t) && -1 !== c.indexOf("/")) throw new B(V, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var f = t.path.child(Z.fromString(c));
                if (!et.isDocumentKey(f)) throw new B(V, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + f + "' is not because it contains an odd number of segments.");
                var l = new et(f);
                a.push(Ut(e, l));
            } else {
                var h = qn(n, r, c);
...
function lr(t, e, n) {
    if ("string" == typeof (n = h(n))) {
        if ("" === n) throw new B(V, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!ce(e) && -1 !== n.indexOf("/")) throw new B(V, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(Z.fromString(n));
        if (!et.isDocumentKey(r)) throw new B(V, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Ut(t, new et(r));
    }
    if (n instanceof on) return Ut(t, n._key);
    throw new B(V, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ot(n) + ".");
}
 ...
 * array requirements.
 */ function hr(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new B(V, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new B(V, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function dr(t, e, n) {
    if (!n.isEqual(e)) throw new B(V, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
...
var yr = /** @class */ function(e) {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new vn(kt(t.latitude), kt(t.longitude));
 ...
 * document contents.
 */ function mr(t) {
    var e = Je((t = st(t, on)).firestore), n = new yr(t.firestore);
 ...
 */ function vr(t) {
    ...
    return Ke(e, t._query).then((function(e) {
...
function gr(t, e, n) {
    var r = pr((t = st(t, on)).converter, e, n), i = An(Sn(t.firestore), "setDoc", t._key, r, null !== t.converter, n);
    return We(Je(t.firestore), [ i.toMutation(t._key, we.none()) ]);
}

function wr(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    var o, s = Sn((t = st(t, on)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        return o = "string" == typeof (e = h(e)) || e instanceof dn ? Fn(s, "updateDoc", t._key, e, n, r) : On(s, "updateDoc", t._key, e), 
    We(Je(t.firestore), [ o.toMutation(t._key, we.exists(!0)) ]);
}
 ...
 */ function br(t) {
    return We(Je((t = st(t, on)).firestore), [ new Ee(t._key, we.none()) ]);
}
 ...
 */ function _r(t, e) {
    var n = fn(t = st(t, an)), r = pr(t.converter, e), i = An(Sn(t.firestore), "addDoc", n._key, r, null !== n.converter, {});
    return We(Je(t.firestore), [ i.toMutation(n._key, we.exists(!1)) ]).then((function() {
        return n;
    }));
}
 ...
 */ var kr = /** @class */ function() {
    ...
    function t(t, e) {
        ...
        this._dataReader = Sn(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = Pr(t, this._firestore), i = pr(r.converter, e, n), o = An(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, we.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, s = Pr(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = h(e)) || e instanceof dn ? Fn(this._dataReader, "WriteBatch.update", s._key, e, n, r) : On(this._dataReader, "WriteBatch.update", s._key, e), 
    ...
    t.prototype.delete = function(t) {
        ...
        return this._mutations = this._mutations.concat(new Ee(e._key, we.none())), this;
    }, 
    /**
...
function Pr(t, e) {
    if ((t = h(t)).firestore !== e) throw new B(V, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ var Dr = /** @class */ function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = et.fromPath(n);
                        e.mutations.push(new Se(r, e.precondition(r)));
    ...
    function t(t, e, n, r) {
        ...
        this.Vt = 5, this.Nt = new Qe(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.Nt.Z((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new Dr(this.datastore), (e = this.$t(t)) && e.then((function(e) {
        ...
        var e = this;
        this.Vt > 0 && this.St(t) ? (this.Vt -= 1, this.asyncQueue.enqueueAndForget((function() {
            return e.Dt(), Promise.resolve();
 ...
 */ var Fr = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new B(k, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.Nt = new Qe(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Mt = function() {
            var e = Or();
            e && w("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.Nt.tt();
        };
        var e = Or();
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.jt(), this.Ot ? new Promise((function(t) {})) : this.Bt(t);
    }, t.prototype.enqueueRetryable = function(t) {
        var e = this;
        this.enqueueAndForget((function() {
            return e.qt.push(t), e.Qt();
        }));
    }, 
    /**
    ...
    t.prototype.Qt = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.qt.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.qt[0]() ];

                  case 2:
                    return n.sent(), this.qt.shift(), this.Nt.reset(), [ 3 /*break*/ , 4 ];
        ...
        var e = this, n = this.xt.then((function() {
            return e.Ut = !0, t().catch((function(t) {
                // Re-throw the error so that this.tail becomes a rejected Promise and
                // all further attempts to chain (via .then) will just short-circuit
                // and return the rejected Promise.
                throw e.Lt = t, e.Ut = !1, b("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
    ...
    t.prototype.Gt = function(t) {
        for (var e = 0, n = this.Ct; e < n.length; e++) {
    ...
    t.prototype.Ht = function(t) {
        ...
        // Note that draining may generate more delayed ops, so we do that first.
                return this.Wt().then((function() {
            // Run ops in the same order they'd run if they ran naturally.
            e.Ct.sort((function(t, e) {
                return t.targetTimeMs - e.targetTimeMs;
            }));
            for (var n = 0, r = e.Ct; n < r.length; n++) {
                var i = r[n];
    ...
    /** Called once a DelayedOperation is run or canceled. */ t.prototype.zt = function(t) {
        ...
        var e = this.Ct.indexOf(t);
        this.Ct.splice(e, 1);
    }, t;
}(), Lr = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = Sn(t)
        /**
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Pr(t, this._firestore), r = new yr(this._firestore);
        ...
        var r = Pr(t, this._firestore), i = pr(r.converter, e, n), o = An(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = h(e)) || e instanceof dn ? Fn(this._dataReader, "Transaction.update", s._key, e, n, r) : On(this._dataReader, "Transaction.update", s._key, e), 
...
y = a + "_lite", u(new f("firestore/lite", (function(t, e) {
    var n = e.options, r = t.getProvider("app-exp").getImmediate(), i = new $e(r, t.getProvider("auth-internal"));
    return n && i._setSettings(n), i;
}), "PUBLIC" /* PUBLIC */)), c("firestore-lite", "0.0.900-exp.d92a36260", "node");

export { yn as Bytes, an as CollectionReference, on as DocumentReference, Hn as DocumentSnapshot, dn as FieldPath, mn as FieldValue, $e as FirebaseFirestore, B as FirestoreError, vn as GeoPoint, sn as Query, Kn as QueryConstraint, Qn as QueryDocumentSnapshot, zn as QuerySnapshot, wt as Timestamp, Lr as Transaction, kr as WriteBatch, _r as addDoc, Ar as arrayRemove, Sr as arrayUnion, un as collection, cn as collectionGroup, br as deleteDoc, Tr as deleteField, fn as doc, pn as documentId, cr as endAt, ur as endBefore, mr as getDoc, vr as getDocs, en as getFirestore, Ir as increment, tn as initializeFirestore, nr as limit, rr as limitToLast, tr as orderBy, Xn as query, hn as queryEqual, ln as refEqual, Rr as runTransaction, Er as serverTimestamp, gr as setDoc, g as setLogLevel, Wn as snapshotEqual, sr as startAfter, or as startAt, rn as terminate, wr as updateDoc, nn as useFirestoreEmulator, Zn as where, Vr as writeBatch };
