...
class Ac {
    ...
    e, n) {
        ...
        this.clientId = x.u(), this.credentialListener = () => {}, this.oc = new Is, this.credentials.setChangeListener((t => {
...
class Hc {
    ...
    getToken() {
        ...
        this.uc !== t ? (b("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
...
/** A "context" object passed around while parsing user data. */ class Fu {
    ...
    Fc(t) {
        ...
        if (ku(this.Cc) && Cu.test(t)) throw this.Mc('Document fields cannot begin and end with "__"');
    }
}
...
class Ku extends Su {
    ...
    _toFieldTransform(t) {
        const e = new pe(t.R, ae(t.R, this.Qc));
 ...
 */
    return function(t, e) {
        ...
        if (!ku(e.Cc)) throw e.Mc(`${t._methodName}() can only be used with update() and set()`);
...
class qa extends Ra {
    ...
    convertReference(t) {
        const e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Wa.tu(e, this.firestore, /* converter= */ null);
    }
}
 ...
 */ (this._delegate) : function(t) {
    ...
    withConverter(t) {
        return new Wa(this.firestore, t ? this._delegate.withConverter(ja.eu(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
 ...
 */ (this._delegate) : "server" === (null == t ? void 0 : t.source) ? function(t) {
    ...
    withConverter(t) {
        return new Xa(this.firestore, t ? this._delegate.withConverter(ja.eu(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
...
class eh extends Xa {
    ...
    withConverter(t) {
        return new eh(this.firestore, t ? this._delegate.withConverter(ja.eu(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
...
//# sourceMappingURL=prebuilt.rn-350d6db4.js.map
