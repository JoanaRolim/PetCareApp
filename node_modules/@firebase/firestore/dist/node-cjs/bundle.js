...
function loadBundle(data) {
    return databaseC03f3b82.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return databaseC03f3b82.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new databaseC03f3b82.Query$1(_this, 
...
registerBundle(databaseC03f3b82.Firestore);
