 ...
 */ function N(t) {
    ...
    if (I.logLevel <= a.DEBUG) {
        var r = e.map(k);
        I.debug.apply(I, b([ "Firestore (8.4.3): " + t ], r));
    }
}
...
function S(t) {
    ...
    if (I.logLevel <= a.ERROR) {
        var r = e.map(k);
        I.error.apply(I, b([ "Firestore (8.4.3): " + t ], r));
    }
}
...
function D(t) {
    ...
    if (I.logLevel <= a.WARN) {
        var r = e.map(k);
        I.warn.apply(I, b([ "Firestore (8.4.3): " + t ], r));
    }
}
...
/** Extracts the backend's type order for the provided value. */ function it(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? J(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : R();
}
...
function ut(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = F(X(t.latitude), X(e.latitude));
            return 0 !== n ? n : F(X(t.longitude), X(e.longitude));
...
function at(t, e) {
    ...
    var n = Y(t), r = Y(e), i = F(n.seconds, r.seconds);
...
function Tt(t, e) {
    ...
    for (var n = 0; n < t.orderBy.length; n++) if (!Mt(t.orderBy[n], e.orderBy[n])) return !1;
...
var At = /** @class */ function(t) {
     ...
     */    return m(e, t), e.create = function(t, n, r) {
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.l(t, n, r) : new Nt(t, n, r) : "array-contains" /* ARRAY_CONTAINS */ === n ? new Rt(t, r) : "in" /* IN */ === n ? new Ct(t, r) : "not-in" /* NOT_IN */ === n ? new Lt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new Ot(t, r) : new e(t, n, r);
    }, e.l = function(t, e, n) {
...
var Nt = /** @class */ function(t) {
    ...
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, "in" /* IN */ , n) || this).keys = kt("in" /* IN */ , n), 
        r;
    }
    return m(e, t), e.prototype.matches = function(t) {
    ...
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, "not-in" /* NOT_IN */ , n) || this).keys = kt("not-in" /* NOT_IN */ , n), 
        r;
    }
    return m(e, t), e.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** A Filter that implements the array-contains operator. */ var Rt = /** @class */ function(t) {
    function e(e, n) {
 ...
 */ function Wt(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new Vt(n)), e.p.push(new Vt(Q.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function Ee(t, e, n) {
    t instanceof Se ? function(t, e, n) {
        ...
        // must have held.
        var r = t.value.clone(), i = Re(t.fieldTransforms, e, n.transformResults);
        ...
        if (be(t.precondition, e)) {
            var r = Re(t.fieldTransforms, e, n.transformResults), i = e.data;
            i.setAll(ke(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Te(t, e, n) {
    t instanceof Se ? function(t, e, n) {
        ...
        if (be(t.precondition, e)) {
            ...
            i.setAll(ke(t)), i.setAll(r), e.convertToFoundDocument(Ne(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        be(t.precondition, e) && 
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && V(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof he && e instanceof he || t instanceof fe && e instanceof fe ? V(t.elements, e.elements, ot) : t instanceof pe && e instanceof pe ? ot(t.A, e.A) : t instanceof ce && e instanceof ce;
 ...
 */ var tn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, en.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(U.min(), r, Ze(), Qe(), $e());
    }, t;
}(), en = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(W.EMPTY_BYTE_STRING, n, $e(), $e(), $e());
    }, t;
}(), nn = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.ut = function(t) {
        ...
        return this.H = Qe(), this.J = an(), this.Y = new je(F), i;
    }, 
    /**
    ...
    t.prototype.U = function(t) {
        ...
        var e = this.J.get(t);
        return e || (e = new je(F), this.J = this.J.insert(t, e)), e;
    }, 
    /**
...
function Sn(t, e) {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = Rn(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = Rn(e.endAt)), n;
}
...
function Dn(t) {
    ...
    var s = [];
    n.where && (s = kn(n.where));
    var u = [];
    n.orderBy && (u = n.orderBy.map((function(t) {
        return function(t) {
            return new Vt(Fn(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
...
function kn(t) {
    return t ? void 0 !== t.unaryFilter ? [ Mn(t) ] : void 0 !== t.fieldFilter ? [ Vn(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return kn(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : R() : [];
...
function Vn(t) {
    return At.create(Fn(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
 ...
 */
        ...
        for (var r = $e(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
    ...
    return t.Pn = function(e, n) {
        for (var r = $e(), i = $e(), o = 0, s = n.docChanges; o < s.length; o++) {
            var u = s[o];
            switch (u.type) {
              case 0 /* Added */ :
                r = r.add(u.doc.key);
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (jt(e) || Gt(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (A() <= a.DEBUG && N("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Jt(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return A() <= a.DEBUG && N("QueryEngine", "Using full collection scan to execute query:", Jt(e)), 
 ...
 */ function pr(t, e, n) {
    ...
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            ...
            return r.xn.getDocumentsMatchingQuery(t, e, n ? i : U.min(), n ? o : $e());
        })).next((function(t) {
            return {
                documents: t,
                Bn: o
 ...
 */ function yr(t, e, n, r) {
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(p) {
            switch (p.label) {
              case 0:
                for (i = L(t), o = $e(), s = Qe(), u = Ye(), a = 0, c = n; a < c.length; a++) h = c[a], 
 ...
 */ function vr(t, e, n) {
    return void 0 === n && (n = $e()), g(this, void 0, void 0, (function() {
        var r, i;
 ...
 */ var mr = /** @class */ function() {
    ...
    t.prototype.Zn = function(t) {
        ...
        var e = new rt(new G([])), n = new wr(e, t), r = new wr(e, t + 1), i = $e();
    ...
    return t.prototype.checkEmpty = function(t) {
        ...
        var o = new wr(new rt(i), 0), s = new je(F);
    ...
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this._s = new gr, this.targetCount = 0, this.ys = $n.Jt();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.ys = new $n(e), this.highestTargetId = e), t.sequenceNumber > this.ws && (this.ws = t.sequenceNumber);
    ...
    return m(e, t), e.prototype.wr = function(t) {
        ...
        var e = function(t, e) {
            ...
            n = new nn([], o, i, null); else {
                ...
                e.filter;
                var h = e.filter;
                h.targetId, r = h.count || 0, i = new Ve(r), o = h.targetId, n = new rn(o, i);
            }
            return n;
        ...
        n.enqueueAndForget((function() {
            return g(o, void 0, void 0, (function() {
                return w(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return Jr(this) ? (N("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return g(this, void 0, void 0, (function() {
                                var e;
                                return w(this, (function(n) {
 ...
 */ function Wr(t, e) {
    var n = L(t), r = di(n);
    n.Or.delete(e), r.er() && Yr(n, e), 0 === n.Or.size && (r.er() ? r.ir() : Jr(n) && 
...
function $r(t) {
    return Jr(t) && !di(t).tr() && t.Or.size > 0;
}
...
function si(t) {
    return Jr(t) && !pi(t).tr() && t.kr.length > 0;
}
                ...
                return e && pi(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return g(this, void 0, void 0, (function() {
                        ...
                        return w(this, (function(i) {
                            switch (i.label) {
                              case 0:
                                return Me(r = e.code) && r !== E.ABORTED ? (n = t.kr.shift(), 
    ...
    t.Ur = function(t, e, n) {
        ...
        return g(e, void 0, void 0, (function() {
            return w(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n ? (t.Ur.sr(), $r(t) ? Xr(t) : t.Br.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
    ...
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(c) {
            switch (c.label) {
              ...
              case 3:
                return u = c.sent(), a = vi(u, "Initialization of query '" + Jt(e.query) + "' failed"), 
    ...
    t.prototype.complete = function() {
        return g(this, void 0, void 0, (function() {
            ...
            return w(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return [ 4 /*yield*/ , yr(this.localStore, new ki(this.R), this.documents, this.ro.id) ];
 ...
 */ var Li = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = $e(), this.lo = te(t), this.fo = new mi(this.lo);
    }
    ...
    t.prototype.po = function(t) {
        ...
        // updating many documents.
                var e = this.ho;
        this.ho = $e(), this.fo.forEach((function(e) {
...
n) {
    ...
    r, i, o) {
        ...
        this.Fo = new Map, this.ko = $n.Yt(), this.onlineState = "Unknown" /* Unknown */ , 
        ...
        return w(this, (function(h) {
            switch (h.label) {
                            ...
                            return w(this, (function(u) {
                                switch (u.label) {
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, o), [ 2 /*return*/ , (Ji(t, e.targetId, s.To), 
                                    s.snapshot) ];
                                }
                            }));
                        }));
              ...
              case 1:
                ...
                a = o.applyChanges(s, 
                /* updateLimboDocuments= */ t.isPrimaryClient, u), Ji(t, n, a.To), c = new Fi(e, n, o), 
 ...
 */;
              ...
              case 1:
                return u.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = L(t), i = M.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), $e());
              ...
              case 2:
                return i = u.sent(), r.sharedClientState.addPendingMutation(i.batchId), function(t, e, n) {
                    ...
                    r || (r = new xe(F)), r = r.insert(e, n), t.xo[t.currentUser.toKey()] = r;
        ...
        return w(this, (function(c) {
            switch (c.label) {
              case 0:
                ...
                u = $e().add(o), a = new tn(U.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new je(F), s, u), [ 4 /*yield*/ , ji(r, a) ]) : [ 3 /*break*/ , 2 ];
 ...
 */ function Wi(t, e) {
    return g(this, void 0, void 0, (function() {
        ...
        return w(this, (function(u) {
            switch (u.label) {
              case 0:
                Jr((n = L(t)).remoteStore) || N("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                u.label = 1;
 ...
 */ function to(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Co.set(r, new Vi(n)), t.Do = t.Do.insert(n, r), zr(t.remoteStore, new zn(Ht(Bt(n.path)), r, 2 /* LimboResolution */ , _.o));
    }
}
...
function ro(t, e) {
    ...
    if (r && r.bo) return $e().add(r.key);
    var i = $e(), o = n.Vo.get(e);
    if (!o) return i;
        ...
        return g(this, void 0, void 0, (function() {
            ...
            return w(this, (function(c) {
                switch (c.label) {
                  ...
                  case 4:
                    return n._updateProgress(Ci(r)), i = new Ri(r, t.localStore, e.R), [ 4 /*yield*/ , e.Lo() ];
...
var oo = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return g(this, void 0, void 0, (function() {
            return w(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.R = Vr(t.databaseInfo.databaseId), this.sharedClientState = this.Bo(t), 
    ...
    return t.prototype.initialize = function(t, e) {
        ...
        var e, n = Vr(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Pr(e));
        ...
        }, o = Cr.yt() ? new Cr : new Rr, new Gr(e, n, r, i, o);
    }, t.prototype.createSyncEngine = function(t, e) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, s) {
            var u = new Mi(t, e, n, r, i, o);
            return s && (u.Oo = !0), u;
 ...
 */ var ao = /** @class */ function() {
    ...
    return t.prototype.run = function() {
        ...
        if ("FirebaseError" === t.name) {
            ...
            var e = t.code;
            return "aborted" === e || "failed-precondition" === e || !Me(e);
        }
        return !1;
    }, t;
}(), fo = /** @class */ function() {
...
function(t, e, n, r, i, o, s) {
    ...
    function t(t, e, n) {
        this.ac = t, this.hc = e, this.lc = n, this.type = "FirstParty", this.user = Sr.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Co(this.ac, this.hc, this.lc));
    }, t.prototype.setChangeListener = function(t) {
 ...
 */ var Bo = /** @class */ function() {
    ...
    /** @hideconstructor */
    function t(t, e) {
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new Bo({}), 
        this._settingsFrozen = !1, t instanceof No ? (this._databaseId = t, this._credentials = new ko) : (this._app = t, 
        ...
        this._settings = new Bo(t), void 0 !== t.credentials && (this._credentials = function(t) {
            ...
            switch (t.type) {
              case "gapi":
                ...
                new Lo(e, t.sessionIndex || "0", t.iamToken || null);
 ...
 */
    ...
    return Object.defineProperty(t.prototype, "_path", {
         ...
         */
        get: function() {
            return new Qo(this.firestore, this.converter, this._key.path.popLast());
        },
        enumerable: !1,
        configurable: !0
    ...
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this, e, n, Bt(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
 ...
 */ function zo(t, e) {
    ...
    if (t = s(t), Oo("collection", "path", e), t instanceof jo) return Mo(n = G.fromString.apply(G, b([ e ], r))), 
    ...
    return Mo(n = G.fromString.apply(G, b([ t.path ], r)).child(G.fromString(e))), new Qo(t.firestore, 
    /* converter= */ null, n);
}
 ...
 */ function Wo(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = P.u()), Oo("doc", "path", e), t instanceof jo) return Vo(n = G.fromString.apply(G, b([ e ], r))), 
    new Go(t, 
    /* converter= */ null, new rt(n));
    if (!(t instanceof Go || t instanceof Qo)) throw new T(E.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Vo(n = t._path.child(G.fromString.apply(G, b([ e ], r)))), new Go(t.firestore, t instanceof Qo ? t.converter : null, new rt(n));
}
 ...
 * Firestore database.
 */ function Ho(t, e) {
    return t = s(t), e = s(e), (t instanceof Go || t instanceof Qo) && (e instanceof Go || e instanceof Qo) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function Yo(t, e) {
    return t = s(t), e = s(e), t instanceof Ko && e instanceof Ko && t.firestore === e.firestore && Xt(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
    ...
    t.prototype.Ac = function() {
        ...
        var e = this, n = this.fc.then((function() {
            return e.yc = !0, t().catch((function(t) {
                ...
                throw e.mc = t, e.yc = !1, S("INTERNAL UNHANDLED ERROR: ", 
                /**
...
var Jo = /** @class */ function() {
    ...
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, n) || this).type = "firestore", r._queue = new Xo, r._persistenceKey = "name" in e ? e.name : "[DEFAULT]", 
        r;
    }
...
/** A "context" object passed around while parsing user data. */ var ls = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Cc = function(e) {
        ...
        return Cs(t, this.settings.methodName, this.settings.Mc || !1, this.path, this.settings.Lc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (hs(this.Dc) && us.test(t)) throw this.$c('Document fields cannot begin and end with "__"');
    }, t;
}(), fs = /** @class */ function() {
    function t(t, e, n) {
 ...
 * classes.
 */ function ds(t) {
    var e = t._freezeSettings(), n = Vr(t._databaseId);
...
var ms = /** @class */ function(t) {
    ...
    return m(e, t), e.prototype._toFieldTransform = function(t) {
        var e = new pe(t.R, ie(t.R, this.Uc));
...
/** Parse update data from a list of field/value arguments. */ function Es(t, e, n, r, i, o) {
    var u = t.Bc(1 /* Update */ , e, n), a = [ Ds(e, r, n) ], c = [ i ];
 ...
 */ function Ts(t, e, n, r) {
    return void 0 === r && (r = !1), Is(n, t.Bc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Is(t, e) {
    ...
    return function(t, e) {
        ...
        if (!hs(e.Dc)) throw e.$c(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if (t instanceof M) {
            ...
            n = new M(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
                timestampValue: dn(e.R, n)
            };
        }
        ...
        throw e.$c("Unsupported field value: " + Uo(t));
    }(t, e);
}
...
function Ns(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof M || t instanceof ss || t instanceof is || t instanceof Go || t instanceof os);
}
 ...
 */ function Ds(t, e, n) {
    ...
    if ("string" == typeof e) return Rs(t, e);
 ...
 * evaluated.
 */ function Rs(t, e, n) {
    if (e.search(ks) >= 0) throw Cs("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
 ...
 */ var Os = /** @class */ function() {
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(Fs("DocumentSnapshot.get", t));
 ...
 */
function Fs(t, e) {
    return "string" == typeof e ? Rs(t, e) : e instanceof rs ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var Vs = /** @class */ function() {
    ...
    e.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(Fs("DocumentSnapshot.get", t));
...
}(Ms), xs = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new Vs(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new Us(n._firestore, n._userDataWriter, r.key, r, new Vs(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    var r = new Us(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Vs(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new Us(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Vs(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
...
var Qs = /** @class */ function(t) {
    ...
    return m(e, t), e.prototype._apply = function(t) {
        var e = ds(t.firestore), n = function(t, e, n, r, i, o, s) {
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || Js(s, o), 
            u = Ts(n, "where", s, 
 ...
 */
        ...
        return new Ko(t.firestore, t.converter, function(t, e) {
    ...
    return m(e, t), e.prototype._apply = function(t) {
        return new Ko(t.firestore, t.converter, Yt(t._query, this.Gc, this.zc));
    }, e;
    ...
    return m(e, t), e.prototype._apply = function(t) {
        var e = Xs(t, this.type, this.Hc, this.Jc);
        return new Ko(t.firestore, t.converter, function(t, e) {
    ...
    if (n[0] = s(n[0]), n[0] instanceof Os) return function(t, e, n, r, i) {
        ...
        for (var o = [], s = 0, u = Wt(t); s < u.length; s++) {
            ...
            if (a.field.isKeyField()) o.push(lt(e, r.key)); else {
                ...
                if (J(c)) throw new T(E.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
...
var nu = /** @class */ function(t) {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = iu(t, this._firestore), i = eu(r.converter, e, n), o = ps(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
 ...
 */ function uu(t) {
    ...
    "object" != typeof i[a] || $o(i[a]) || (u = i[a], a++);
    var c, h, l, f = {
 ...
 */ function cu(t, e, n) {
    ...
    return new Ms(t, i, e._key, r, new Vs(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var hu = /** @class */ function(t) {
     ...
     */    return m(e, t), e.prototype.get = function(e) {
        ...
        return t.prototype.get.call(this, e).then((function(t) {
            return new Ms(n._firestore, i, r._key, t._document, new Vs(
            /* hasPendingWrites= */ !1, 
    ...
    return t.prototype.get = function(t) {
        ...
        return this._transaction.lookup([ n._key ]).then((function(t) {
            ...
            var i = t[0];
            if (i.isFoundDocument()) return new Os(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new Os(e._firestore, r, n._key, null, n.converter);
            throw R();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = iu(t, this._firestore), i = eu(r.converter, e, n), o = ps(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
 ...
 */
    ...
    return m(e, t), e.prototype.convertBytes = function(t) {
        ...
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Eu.Zc(e, this.firestore, /* converter= */ null);
    }, e;
}(tu);
 ...
 */ var wu = /** @class */ function() {
    ...
    return t.prototype.get = function(t) {
        ...
        return this._delegate.get(n).then((function(t) {
            return new Nu(e._firestore, new Ms(e._firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, n.converter));
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Lu(t);
...
var Eu = /** @class */ function() {
    ...
    return t.nu = function(e, n, r) {
        ...
        try {
            return function(t, e, n) {
                t = xo(t, Go);
                var r = xo(t.firestore, ts), i = eu(t.converter, e, n);
                return au(r, [ ps(ds(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, we.none()) ]);
            }(this._delegate, t, e);
        } catch (t) {
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        var r = Iu(e), i = Au(e, (function(e) {
            return new Nu(t.firestore, new Ms(t.firestore._delegate, t._userDataWriter, e._key, e._document, e.metadata, t._delegate.converter));
        }));
        ...
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            ...
            return function(t, e) {
                ...
                return new Ms(e, r, t._key, n, new Vs(null !== n && n.hasLocalMutations, 
            ...
            return new Nu(e.firestore, new Ms(e.firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, e._delegate.converter));
        }));
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(_u.tu(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
function Iu(t) {
    for (var e = 0, n = t; e < n.length; e++) {
        var r = n[e];
        if ("object" == typeof r && !$o(r)) return r;
    }
    return {};
}
 ...
 */ function Au(t, e) {
    ...
    return {
        ...
        error: null === (n = (i = $o(t[0]) ? t[0] : $o(t[1]) ? t[1] : "function" == typeof t[0] ? {
            next: t[0],
            error: t[1],
            complete: t[2]
        } : {
...
var Nu = /** @class */ function() {
     ...
     */
        function(t) {
            ...
            return new Ru(e.firestore, new xs(e.firestore._delegate, e._userDataWriter, e._delegate, t._snapshot));
        }));
    }, t.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = Iu(e), i = Au(e, (function(e) {
            return new Ru(t.firestore, new xs(t.firestore._delegate, t._userDataWriter, t._delegate, e._snapshot));
        }));
        return uu(this._delegate, r, i);
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(_u.tu(this.firestore, e)) : this._delegate.withConverter(null));
    ...
    return m(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        var e = this;
        return function(t, e) {
            var n = xo(t.firestore, ts), r = Wo(t), i = eu(t.converter, e);
            return au(n, [ ps(ds(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, we.exists(!1)) ]).then((function() {
                return r;
            }));
        ...
        return new e(this.firestore, t ? this._delegate.withConverter(_u.tu(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}(Du);
...
export { vu as $, wu as B, Nu as G, Du as H, gu as L, Eu as Q, Cu as X, Ru as Y, Zo as _, M as a, Pu as e, yu as k, ts as m, Fu as n, bu as q, Vu as s, Ou as t, ss as v, du as x, Su as z };
//# sourceMappingURL=prebuilt-8467d073-42df4e6a.js.map
