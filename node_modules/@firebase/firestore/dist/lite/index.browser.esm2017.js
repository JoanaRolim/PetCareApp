...
import { createMockUserToken as u, getModularInstance as a } from "@firebase/util";
 ...
 * terminated.
 */ function on(t) {
    return t = rt(t, en), n(t.app, "firestore/lite"), t._delete();
}
...
function hn(t, e, ...n) {
    if (t = a(t), tt("collection", "path", e), t instanceof en) {
 ...
 * Firestore database.
 */ function dn(t, e) {
    return t = a(t), e = a(e), (t instanceof un || t instanceof cn) && (e instanceof un || e instanceof cn) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function wn(t, e) {
    return t = a(t), e = a(e), t instanceof an && e instanceof an && (t.firestore === e.firestore && he(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ function Cn(t, e) {
    ...
    // from firestore-exp.
    t = a(t))) return kn("Unsupported field value:", e, t), Ln(t, e);
    if (t instanceof _n) 
 ...
 */ function Yn(t, e) {
    return t = a(t), e = a(e), t instanceof Wn && e instanceof Wn ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof Hn && e instanceof Hn && (wn(t.query, e.query) && pt(t.docs, e.docs, Yn));
}
...
/** Helper function to create a bound from a document or fields */ function fs(t, e, n, s) {
    if (n[0] = a(n[0]), n[0] instanceof Wn) return function(t, e, n, s, r) {
...
function bs(t, e, n, ...s) {
    ...
    // performing validation.
        let i;
    i = "string" == typeof (e = a(e)) || e instanceof mn ? qn(r, "updateDoc", t._key, e, n, s) : xn(r, "updateDoc", t._key, e);
 ...
 */ class Ns {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = a(e)) || e instanceof mn ? qn(this._dataReader, "WriteBatch.update", r._key, e, n, s) : xn(this._dataReader, "WriteBatch.update", r._key, e), 
...
function Ds(t, e) {
    if ((t = a(t)).firestore !== e) throw new U(A, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
class Cs {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = a(e)) || e instanceof mn ? qn(this._dataReader, "Transaction.update", r._key, e, n, s) : xn(this._dataReader, "Transaction.update", r._key, e), 
