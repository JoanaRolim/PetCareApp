 ...
 */ function S(t) {
    ...
    if (A.logLevel <= c.DEBUG) {
        var r = e.map(R);
        A.debug.apply(A, _([ "Firestore (8.4.3): " + t ], r));
    }
}
...
function D(t) {
    ...
    if (A.logLevel <= c.ERROR) {
        var r = e.map(R);
        A.error.apply(A, _([ "Firestore (8.4.3): " + t ], r));
    }
}
...
function k(t) {
    ...
    if (A.logLevel <= c.WARN) {
        var r = e.map(R);
        A.warn.apply(A, _([ "Firestore (8.4.3): " + t ], r));
    }
}
...
function at(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = V(J(t.latitude), J(e.latitude));
            return 0 !== n ? n : V(J(t.longitude), J(e.longitude));
...
function ct(t, e) {
    ...
    var n = X(t), r = X(e), i = V(n.seconds, r.seconds);
 ...
 */ function Ht(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new Mt(n)), e.p.push(new Mt(W.keyField(), "asc" /* ASCENDING */)); else {
...
/** A mutation that deletes the document at the given key. */ var Oe, Pe, Fe = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
...
var Je = new Ge(it.comparator);

function $e() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = Je, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.add(o);
    }
    return n;
 ...
 */ var en = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, nn.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(x.min(), r, tn(), We(), $e());
    }, t;
}(), nn = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(H.EMPTY_BYTE_STRING, n, $e(), $e(), $e());
    }, t;
}(), rn = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.ut = function(t) {
        ...
        return this.H = We(), this.J = cn(), this.Y = new Ge(V), i;
    }, 
    /**
    ...
    t.prototype.U = function(t) {
        ...
        var e = this.J.get(t);
        return e || (e = new Ge(V), this.J = this.J.insert(t, e)), e;
    }, 
    /**
...
function Mn(t) {
    return Nt.create(Vn(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
 ...
 */ function yr(t, e, n) {
    ...
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            ...
            return r.xn.getDocumentsMatchingQuery(t, e, n ? i : x.min(), n ? o : $e());
        })).next((function(t) {
            return {
                documents: t,
                Bn: o
 ...
 */ function vr(t, e, n, r) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(p) {
            switch (p.label) {
              case 0:
                for (i = O(t), o = $e(), s = We(), u = Xe(), a = 0, c = n; a < c.length; a++) h = c[a], 
 ...
 */ function mr(t, e, n) {
    return void 0 === n && (n = $e()), w(this, void 0, void 0, (function() {
        var r, i;
 ...
 */ var gr = /** @class */ function() {
    ...
    t.prototype.Zn = function(t) {
        ...
        var e = new it(new K([])), n = new br(e, t), r = new br(e, t + 1), i = $e();
    ...
    return t.Gn = function(t, e) {
        return it.comparator(t.key, e.key) || V(t.ns, e.ns);
    }, 
    /** Compare by ID then by key */ t.Hn = function(t, e) {
        return V(t.ns, e.ns) || it.comparator(t.key, e.key);
    }, t;
}(), _r = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.checkEmpty = function(t) {
        ...
        var o = new br(new it(i), 0), s = new Ge(V);
    ...
    t.prototype.removeEntry = function(t) {
        ...
        for (var r = We(), i = new it(e.path.child("")), o = this.docs.getIteratorFrom(i)
    ...
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this._s = new wr, this.targetCount = 0, this.ys = $n.Jt();
    }
                        ...
                        [ 4 /*yield*/ , function(t) {
                            return w(this, void 0, void 0, (function() {
                                ...
                                return b(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = O(t)).$r.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Wr(e) ];
        ...
        return b(this, (function(i) {
            switch (i.label) {
              case 0:
                ...
                return t.$r.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Wr(t) ];
...
function li(t, e, n) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(o) {
            switch (o.label) {
              case 0:
                return r = t.kr.shift(), i = Wn.from(r, e, n), [ 4 /*yield*/ , oi(t, (function() {
    ...
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(i) {
            switch (i.label) {
              ...
              case 2:
                return (r = e) ? [ 3 /*break*/ , 4 ] : (n.$r.add(2 /* IsSecondary */), [ 4 /*yield*/ , Wr(n) ]);
    ...
    t.Ur = function(t, e, n) {
        ...
        return w(e, void 0, void 0, (function() {
            return b(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n ? (t.Ur.sr(), $r(t) ? Jr(t) : t.Br.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
 ...
 */ var gi = /** @class */ function() {
    ...
    return t.fromInitialDocuments = function(e, n, r, i) {
        ...
        if (!(this.fromCache === t.fromCache && this.syncStateChanged === t.syncStateChanged && this.mutatedKeys.isEqual(t.mutatedKeys) && Jt(this.query, t.query) && this.docs.isEqual(t.docs) && this.oldDocs.isEqual(t.oldDocs))) return !1;
    ...
    this.queries = new tr((function(t) {
        return $t(t);
    }), Jt), this.onlineState = "Unknown" /* Unknown */ , this.Gr = new Set;
};
 ...
 */ var Oi = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = $e(), this.lo = ee(t), this.fo = new gi(this.lo);
    }
    ...
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(h) {
            switch (h.label) {
              ...
              case 1:
                return i = h.sent(), o = new Fi(e, i.Bn), s = o._o(i.documents), u = nn.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" /* Offline */ !== t.onlineState), 
                a = o.applyChanges(s, 
                /* updateLimboDocuments= */ t.isPrimaryClient, u), Zi(t, n, a.To), c = new Vi(e, n, o), 
    ...
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(o) {
            switch (o.label) {
              ...
              case 3:
                return Ji(n, r.targetId), [ 4 /*yield*/ , pr(n.localStore, r.targetId, 
        ...
        return b(this, (function(u) {
            switch (u.label) {
              case 0:
                r = function(t) {
                    var e = O(t);
                    return e.remoteStore.remoteSyncer.applySuccessfulWrite = Wi.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = zi.bind(null, e), 
                    e
                    /**
 ...
 */;
              ...
              case 2:
                return i = u.sent(), r.sharedClientState.addPendingMutation(i.batchId), function(t, e, n) {
                    ...
                    r || (r = new qe(V)), r = r.insert(e, n), t.xo[t.currentUser.toKey()] = r;
        ...
        return b(this, (function(c) {
            switch (c.label) {
              case 0:
                ...
                u = $e().add(o), a = new en(x.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new Ge(V), s, u), [ 4 /*yield*/ , Gi(r, a) ]) : [ 3 /*break*/ , 2 ];
 ...
 */ function eo(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Co.set(r, new Mi(n)), t.Do = t.Do.insert(n, r), zr(t.remoteStore, new zn(Yt(jt(n.path)), r, 2 /* LimboResolution */ , E.o));
    }
}
...
var so = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t, e) {
        ...
        var e, n = Mr(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Fr(e));
        ...
        this.clientId = F.u(), this.credentialListener = function() {
            ...
            return w(r, void 0, void 0, (function() {
                return b(this, (function(e) {
                    switch (e.label) {
                      case 0:
                        return S("FirestoreClient", "Received user=", t.uid), [ 4 /*yield*/ , this.credentialListener(t) ];
                ...
                return o.sent(), r = n.initialUser, t.setCredentialChangeListener((function(t) {
                    return w(i, void 0, void 0, (function() {
                        return b(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return r.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , ur(e.localStore, t) ];
                            ...
                            return b(this, (function(i) {
                                switch (i.label) {
                                  case 0:
                                    ...
                                    n.$r.add(3 /* CredentialChange */), [ 4 /*yield*/ , Wr(n) ];
...
function(t, e, n, r, i, o, s) {
    ...
    function t(t) {
        var e = this;
        /** Tracks the current User. */        this.currentUser = Dr.UNAUTHENTICATED, 
        /**
        ...
        var n = function(t) {
            S("FirebaseCredentialsProvider", "Auth detected"), e.auth = t, e.lc(), e.auth.addAuthTokenListener(e.ac);
        };
        t.onInit((function(t) {
            return n(t);
        })), 
        ...
        setTimeout((function() {
            if (!e.auth) {
                ...
                // token
                S("FirebaseCredentialsProvider", "Auth not yet detected"), e.ac());
            }
        }), 0), this.lc();
    }
    return t.prototype.getToken = function() {
    ...
    function t(t, e, n) {
        this.fc = t, this.dc = e, this.wc = n, this.type = "FirstParty", this.user = Dr.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Oo(this.fc, this.dc, this.wc));
    }, t.prototype.setChangeListener = function(t, e) {
 ...
 */
    ...
    return Object.defineProperty(t.prototype, "_path", {
         ...
         */
        get: function() {
            return new zo(this.firestore, this.converter, this._key.path.popLast());
        },
        enumerable: !1,
        configurable: !0
 ...
 */ function Ho(t, e) {
    ...
    if (t = s(t), Fo("collection", "path", e), t instanceof Ko) return xo(n = K.fromString.apply(K, _([ e ], r))), 
    new zo(t, /* converter= */ null, n);
    if (!(t instanceof Qo || t instanceof zo)) throw new I(T.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return xo(n = K.fromString.apply(K, _([ t.path ], r)).child(K.fromString(e))), new zo(t.firestore, 
    /* converter= */ null, n);
}
 ...
 */ function Yo(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = F.u()), Fo("doc", "path", e), t instanceof Ko) return Uo(n = K.fromString.apply(K, _([ e ], r))), 
    new Qo(t, 
    /* converter= */ null, new it(n));
    if (!(t instanceof Qo || t instanceof zo)) throw new I(T.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Uo(n = t._path.child(K.fromString.apply(K, _([ e ], r)))), new Qo(t.firestore, t instanceof zo ? t.converter : null, new it(n));
}
 ...
 * Firestore database.
 */ function Xo(t, e) {
    return t = s(t), e = s(e), (t instanceof Qo || t instanceof zo) && (e instanceof Qo || e instanceof zo) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function Jo(t, e) {
    return t = s(t), e = s(e), t instanceof Wo && e instanceof Wo && t.firestore === e.firestore && Jt(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
    ...
    t.prototype.vc = function() {
        ...
        var e = this, n = this._c.then((function() {
            return e.Tc = !0, t().catch((function(t) {
                ...
                throw e.Ec = t, e.Tc = !1, D("INTERNAL UNHANDLED ERROR: ", 
                /**
...
var ts = /** @class */ function() {
    ...
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, n) || this).type = "firestore", r._queue = new $o, r._persistenceKey = "name" in e ? e.name : "[DEFAULT]", 
        r;
    }
...
/** A "context" object passed around while parsing user data. */ var ds = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Fc = function(e) {
        ...
        return Os(t, this.settings.methodName, this.settings.qc || !1, this.path, this.settings.Uc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (fs(this.xc) && cs.test(t)) throw this.Bc('Document fields cannot begin and end with "__"');
    }, t;
}(), ps = /** @class */ function() {
    function t(t, e, n) {
...
var ws = /** @class */ function(t) {
    ...
    return g(e, t), e.prototype._toFieldTransform = function(t) {
        var e = new ye(t.R, oe(t.R, this.jc));
...
/** Parse update data from a list of field/value arguments. */ function Is(t, e, n, r, i, o) {
    var u = t.Qc(1 /* Update */ , e, n), a = [ Rs(e, r, n) ], c = [ i ];
 ...
 */ function As(t, e, n, r) {
    return void 0 === r && (r = !1), Ns(n, t.Qc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Ns(t, e) {
    ...
    return function(t, e) {
        ...
        if (!fs(e.xc)) throw e.Bc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.Bc("Unsupported field value: " + qo(t));
    }(t, e);
}
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new Vs(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
 ...
 */
        ...
        return new Wo(t.firestore, t.converter, function(t, e) {
    ...
    return g(e, t), e.prototype._apply = function(t) {
        return new Wo(t.firestore, t.converter, Xt(t._query, this.Jc, this.Yc));
    }, e;
...
function $s(t, e, n, r) {
    if (n[0] = s(n[0]), n[0] instanceof Fs) return function(t, e, n, r, i) {
    ...
    return function(t, e, n, r, i, o) {
        ...
        for (var u = [], a = 0; a < i.length; a++) {
            ...
            if (s[a].field.isKeyField()) {
                ...
                if (!zt(t) && -1 !== c.indexOf("/")) throw new I(T.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
...
function Zs(t, e, n) {
    if ("string" == typeof (n = s(n))) {
        ...
        if (!zt(e) && -1 !== n.indexOf("/")) throw new I(T.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
 ...
 */ var nu = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new as(J(t.latitude), J(t.longitude));
...
var iu = /** @class */ function(t) {
    ...
    t.prototype.delete = function(t) {
        ...
        return this._mutations = this._mutations.concat(new Fe(e._key, be.none())), this;
    }, 
    /**
 ...
 */ var fu = /** @class */ function(t) {
    ...
    return t.prototype.get = function(t) {
        ...
        return this._transaction.lookup([ n._key ]).then((function(t) {
            ...
            var i = t[0];
            if (i.isFoundDocument()) return new Fs(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new Fs(e._firestore, r, n._key, null, n.converter);
            throw C();
        }));
                            ...
                            return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                                return w(this, void 0, void 0, (function() {
                                    ...
                                    return b(this, (function(n) {
                                        switch (n.label) {
                                          case 0:
                                            return (e = O(t)).$r.add(0 /* UserDisabled */), [ 4 /*yield*/ , Wr(e) ];
 ...
 */;
        ...
        get: function() {
            if (!this.eu) throw new I(T.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.eu;
        },
        enumerable: !1,
        configurable: !0
        ...
        try {
            return new Ru(this, function(t, e) {
                if (t = Bo(t, Ko), Fo("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new I(T.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new Wo(t, 
                /* converter= */ null, 
                /**
 ...
 */
    ...
    return g(e, t), e.prototype.convertBytes = function(t) {
        ...
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Iu.nu(e, this.firestore, /* converter= */ null);
    }, e;
}(nu);
 ...
 */ var _u = /** @class */ function() {
    ...
    return t.prototype.get = function(t) {
        ...
        var r = Pu(t);
        return n ? (Vo("Transaction.set", n), this._delegate.set(r, e, n)) : this._delegate.set(r, e), 
        this;
    }, t.prototype.update = function(t, e, n) {
    ...
    return t.prototype.set = function(t, e, n) {
        var r = Pu(t);
        return n ? (Vo("WriteBatch.set", n), this._delegate.set(r, e, n)) : this._delegate.set(r, e), 
        this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i = [], o = 3; o < arguments.length; o++) i[o - 3] = arguments[o];
        var s = Pu(t);
...
var Iu = /** @class */ function() {
    ...
    return t.ru = function(e, n, r) {
        ...
        return hu(Bo((t = this._delegate).firestore, ns), [ new Fe(t._key, be.none()) ]);
        var t;
        /**
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        return new t(this.firestore, e ? this._delegate.withConverter(Tu.su(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
var Du = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        try {
            ...
            return new t(this.firestore, Ws(this._delegate, function(t, e, n) {
        ...
        try {
            ...
            // FieldPath Compat type as input, but is not typed as such in order to
            // not expose this via our public typings file.
            return new t(this.firestore, Ws(this._delegate, function(t, e) {
                void 0 === e && (e = "asc");
        ...
        try {
            return new t(this.firestore, Ws(this._delegate, function(t) {
        ...
        try {
            return new t(this.firestore, Ws(this._delegate, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        ...
        try {
            return new t(this.firestore, Ws(this._delegate, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new Js("endBefore", t, /*before=*/ !0);
            }.apply(void 0, e)));
        } catch (e) {
        ...
        try {
            return new t(this.firestore, Ws(this._delegate, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new Js("endAt", t, /*before=*/ !1);
            }.apply(void 0, e)));
        } catch (e) {
            throw Au(e, "endAt()", "Query.endAt()");
        }
    }, t.prototype.isEqual = function(t) {
        return Jo(this._delegate, t._delegate);
    }, t.prototype.get = function(t) {
        var e = this;
                                    ...
                                    return w(this, void 0, void 0, (function() {
                                        ...
                                        return b(this, (function(a) {
                                            switch (a.label) {
                                              ...
                                              case 1:
                                                return u = a.sent(), r = new Fi(e, u.Bn), i = r._o(u.documents), o = r.applyChanges(i, 
    ...
    return g(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        return new e(this.firestore, t ? this._delegate.withConverter(Tu.su(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}(Ru);
...
function Uu(t) {
    ...
    return (e = this._delegate, n = t, function(t, e) {
        ...
        return t ? new Wo(e, null, t.query) : null;
    }))).then((function(t) {
        return t ? new Ru(r, t) : null;
    }));
}

export { mu as $, Du as H, ku as J, gu as L, U as O, Eu as Q, _u as U, as as V, Ru as Y, Lu as Z, ns as g, Mu as i, Iu as j, yu as k, Fu as n, bu as q, Uu as r, Vu as s, Ou as t, es as y };
//# sourceMappingURL=prebuilt-ee5e03aa-ee45e82f.js.map
