...
import { __extends as w, __spreadArray as b, __awaiter as I, __generator as E } from "tslib";
...
var kt = /** @class */ function(t) {
     ...
     */    return w(e, t), e.create = function(t, n, r) {
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.l(t, n, r) : new Ct(t, n, r) : "array-contains" /* ARRAY_CONTAINS */ === n ? new Lt(t, r) : "in" /* IN */ === n ? new Pt(t, r) : "not-in" /* NOT_IN */ === n ? new Mt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new Ft(t, r) : new e(t, n, r);
    }, e.l = function(t, e, n) {
        return "in" /* IN */ === e ? new xt(t, n) : new Rt(t, n);
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var Ee = function(t, e) {
 ...
 */ function Ae(t, e, n) {
    t instanceof Re ? function(t, e, n) {
        ...
        if (Se(t.precondition, e)) {
            ...
            i.setAll(Le(t)), i.setAll(r), e.convertToFoundDocument(xe(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        Se(t.precondition, e) && 
    ...
    t.prototype.rt = function(t) {
        ...
        if (r) {
            ...
            if (At(i)) if (0 === n) {
                ...
                // queries.
                var o = new ut(i.path);
                this.tt(e, o, Tt.newNoDocument(o, B.min()));
        ...
        this.G.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && At(o.target)) {
                    ...
                    null !== e.H.get(s) || e.at(i, s) || e.tt(i, s, Tt.newNoDocument(s, t));
                }
                r.O && (n.set(i, r.M()), r.L());
            }
        }));
...
var pr = b(b([], b(b([], b(b([], b(b([], [ tr.store, er.store, nr.store, or.store, ur.store, Zn.store, cr.store, ar.store ]), [ fr.store ])), [ sr.store ])), [ hr.store ])), [ lr.store, dr.store ]), yr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", vr = /** @class */ function() {
    ...
    function t(t, e) {
        ...
        this.ft = new mr, this.transaction.oncomplete = function() {
            ...
            e.error ? n.ft.reject(new Er(t, e.error)) : n.ft.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Dr(e.target.error);
            n.ft.reject(new Er(t, r));
        };
    }
                  ...
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, r) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            r(new Er(t, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
                        }, i.onerror = function(e) {
                            var n = e.target.error;
                            "VersionError" === n.name ? r(new S(_.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r(new Er(t, n));
 ...
 * on persistence.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Tr(t) {
...
/** Decodes a remote document from storage locally to a Document. */ function Lr(t, e) {
    ...
    if (e.noDocument) {
        var n = ut.fromSegments(e.noDocument.path), r = qr(e.noDocument.readTime), i = Tt.newNoDocument(n, r);
    ...
    if (e.unknownDocument) {
        ...
        return Tt.newUnknownDocument(o, r);
    }
    return R();
}
...
var ei = /** @class */ function() {
    ...
    return t.Kt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(u) {
            O("number" == typeof u);
            for (var a = new Cr(u, e, n, r), c = function(t, e, n) {
            ...
            return I(e, void 0, void 0, (function() {
                ...
                return E(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Tr(e = n.sent()) ? (A("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
 ...
 */ var gi = /** @class */ function() {
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return Ti(t).get(_i(e)).next((function(t) {
            return n.ye(e, t);
        }));
    }, 
    /**
    ...
    t.prototype.Ee = function(t, e) {
        ...
        return Ti(t).Ot(s, (function(t, n, s) {
        ...
        return Ei(t).get(sr.key).next((function(t) {
            return O(!!t), t;
        }));
    }, t.prototype.me = function(t, e) {
        return Ei(t).put(sr.key, e);
    }, 
    /**
    ...
    return w(e, t), e.prototype.applyChanges = function(t) {
        ...
        return this.changes.forEach((function(o, s) {
            ...
            if (s.document.isValidDocument()) {
                ...
                var h = Pr(e.Ie.R, Tt.newNoDocument(o, B.min()), e.getReadTime(o));
...
var Di = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Ai = /** @class */ function() {
    ...
    t.prototype.je = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return Ci(e).put(new fr(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
    ...
    t.prototype.Ye = function(t) {
        ...
        return this.Ce ? gr.resolve(!0) : ki(t).get(Zn.key).next((function(n) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || Ci(t).Nt().next((function(t) {
    ...
    t.prototype.fn = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return Ci(e).Nt().next((function(e) {
        ...
        return this.Be.runTransaction(t, o, pr, (function(o) {
            return i = new Ar(o, r.Ne ? r.Ne.next() : T.o), "readwrite-primary" === e ? r.Je(i).next((function(t) {
                return !!t || r.Ye(i);
            })).next((function(e) {
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Rn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    h = Tt.newInvalidDocument(c), r = r.insert(c, h)), Ae(a, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
...
function Hi(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = L(t), i = Xe(), o = Mr(n), s = Ti(e), u = IDBKeyRange.lowerBound(o, !0);
            return s.Ot({
 ...
 */ var $i = /** @class */ function() {
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return gr.resolve(n ? n.document.clone() : Tt.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = Xe();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.clone() : Tt.newInvalidDocument(t));
        })), gr.resolve(r);
    }, t.prototype.getDocumentsMatchingQuery = function(t, e, n) {
...
var lo = /** @class */ function() {
                    ...
                    return E(this, (function(u) {
                        if (this.started) {
                            if (null !== n.key) if (this.Ls.test(n.key)) {
                                ...
                                return e;
                            }(n.newValue)) !== T.o && this.sequenceNumberHandler(s); else if (n.key === this.Qs) return [ 2 /*return*/ , this.syncEngine.ci() ];
                        } else this.Os.push(n);
                        return [ 2 /*return*/ ];
                    }));
                }));
    ...
    return w(u, t), u.prototype.ki = function(t, e, n, r) {
        ...
        var d = c.createWebChannel(l, f), w = !1, b = !1, I = new To({
            Ei: function(t) {
        ...
        return E(d, v.EventType.OPEN, (function() {
            b || A("Connection", "WebChannel transport opened.");
        })), E(d, v.EventType.CLOSE, (function() {
            b || (b = !0, A("Connection", "WebChannel transport closed"), I.Vi());
        })), E(d, v.EventType.ERROR, (function(t) {
            b || (b = !0, C("Connection", "WebChannel transport errored:", t), I.Vi(new S(_.UNAVAILABLE, "The operation could not be completed")));
        })), E(d, v.EventType.MESSAGE, (function(t) {
            var e;
            if (!b) {
                var n = t.data[0];
                O(!!n);
    ...
    return w(e, t), e.prototype.wr = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                }), a = (s = Tt.newFoundDocument(i, o, u), r.targetIds || []), c = r.removedTargetIds || [];
                n = new an(a, c, s.key, s);
            } else if ("documentDelete" in e) e.documentDelete, (r = e.documentDelete).document, 
            i = Sn(t, r.document), o = r.readTime ? In(r.readTime) : B.min(), u = Tt.newNoDocument(i, o), 
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (O(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        n = In(e)), new Te(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
...
function es(t, e, n) {
    return I(this, void 0, void 0, (function() {
        ...
        return E(this, (function(o) {
            switch (o.label) {
              case 0:
                return r = t.kr.shift(), i = xr.from(r, e, n), [ 4 /*yield*/ , Yo(t, (function() {
 ...
 */ function us(t, e) {
    if (k("AsyncQueue", e + ": " + t), Tr(t)) return new S(_.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var gs = /** @class */ function() {
    ...
    t.prototype.Un = function(t) {
        return t.metadata.exists ? xn(this.R, t.document, !1) : Tt.newNoDocument(this.qn(t.metadata.name), this.Qn(t.metadata.readTime));
    ...
    function t(t, e, n) {
        ...
        this.documents = [], this.progress = Es(t)
        /**
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Mn.pn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                ...
                                // exists=true
                                s.push(new Oe(c.key, h, Et(h.toProto().mapValue), _e.exists(!0)));
                            }
        ...
        return E(this, (function(c) {
            switch (c.label) {
              case 0:
                ...
                (o = i && i.key) ? (s = (s = new Ge(ut.comparator)).insert(o, Tt.newNoDocument(o, B.min())), 
...
function Ks(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Ts ? (t.No.addReference(o.key, e), Gs(t, o)) : o instanceof _s ? (A("SyncEngine", "Document no longer in limbo: " + o.key), 
 ...
 */ function Qs(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Co.set(r, new Ds(n)), t.Do = t.Do.insert(n, r), Fo(t.remoteStore, new Rr(Zt(zt(n.path)), r, 2 /* LimboResolution */ , T.o));
    }
}
    ...
    return I(this, void 0, void 0, (function() {
        ...
        return E(this, (function(v) {
            switch (v.label) {
              ...
              case 9:
                return a = v.sent(), [ 4 /*yield*/ , Cs(n, tu(y), u, 
                /*current=*/ !1) ];
    ...
    return I(this, void 0, void 0, (function() {
        ...
        return E(this, (function(d) {
            switch (d.label) {
              ...
              case 3:
                return a = d.sent(), [ 4 /*yield*/ , Cs(r, tu(u), a.targetId, 
                /*current=*/ !1) ];
        ...
        return I(this, void 0, void 0, (function() {
            ...
            return E(this, (function(c) {
                switch (c.label) {
                  ...
                  case 4:
                    return n._updateProgress(Es(r)), i = new Is(r, t.localStore, e.R), [ 4 /*yield*/ , e.Lo() ];
 ...
 */ var lu = /** @class */ function() {
    ...
    e, n) {
        ...
        this.clientId = M.u(), this.credentialListener = function() {}, this.oc = new mr, 
...
function(t, e, n, r, i, o, s) {
    ...
    function t(t) {
        ...
        this.currentUser = ao.UNAUTHENTICATED, this.oc = !1, 
        /**
        ...
        this.changeListener = null, this.forceRefresh = !1, this.cc = function() {
            e.uc++, e.currentUser = e.ac(), e.oc = !0, e.changeListener && e.changeListener(e.currentUser);
        }, this.uc = 0, this.auth = t.getImmediate({
            optional: !0
        }), this.auth ? this.auth.addAuthTokenListener(this.cc) : (
        // if auth is not available, invoke tokenListener once with null token
        this.cc(null), t.get().then((function(t) {
            e.auth = t, e.cc && 
            // tokenListener can be removed by removeChangeListener()
            e.auth.addAuthTokenListener(e.cc);
        }), (function() {})));
    }
    return t.prototype.getToken = function() {
        var t = this, e = this.uc, n = this.forceRefresh;
        ...
        // request is outstanding.
            ...
            return t.uc !== e ? (A("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (O("string" == typeof n.accessToken), new xu(n.accessToken, t.currentUser)) : null;
    ...
    function t(t, e, n) {
        this.hc = t, this.lc = e, this.fc = n, this.type = "FirstParty", this.user = ao.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Pu(this.hc, this.lc, this.fc));
    }, t.prototype.setChangeListener = function(t) {
 ...
 */
        return t = this, (e = Cu.get(t)) && (A("ComponentProvider", "Removing Datastore"), 
        Cu.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}(), Wu = /** @class */ function() {
    /** @hideconstructor */
...
/** A "context" object passed around while parsing user data. */ var ma = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Nc = function(e) {
        ...
        return Fa(t, this.settings.methodName, this.settings.Lc || !1, this.path, this.settings.Bc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (va(this.Cc) && da.test(t)) throw this.Mc('Document fields cannot begin and end with "__"');
    }, t;
}(), ga = /** @class */ function() {
    function t(t, e, n) {
...
var Ta = /** @class */ function(t) {
    ...
    return w(e, t), e.prototype._toFieldTransform = function(t) {
        var e = new we(t.R, ce(t.R, this.Qc));
 ...
 */ function ka(t, e, n, r) {
    return void 0 === r && (r = !1), Ca(n, t.qc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Ca(t, e) {
    ...
    // from firestore-exp.
    t = u(t))) return Oa("Unsupported field value:", e, t), xa(t, e);
    if (t instanceof fa) 
    ...
    return function(t, e) {
        ...
        if (!va(e.Cc)) throw e.Mc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.Mc("Unsupported field value: " + ju(t));
    }(t, e);
}
...
var Ja = /** @class */ function(t) {
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this) || this).Kc = e, i.jc = n, i.Wc = r, i.type = "where", 
        i;
    }
 ...
 */
        ...
        }(t._query, 0, e, t.firestore._databaseId, this.Kc, this.jc, this.Wc);
    ...
    function e(e, n) {
        var r = this;
        return (r = t.call(this) || this).Kc = e, r.Gc = n, r.type = "orderBy", r;
    }
    return w(e, t), e.prototype._apply = function(t) {
    ...
    return w(e, t), e.prototype._apply = function(t) {
        return new Hu(t.firestore, t.converter, te(t._query, this.zc, this.Hc));
    }, e;
    ...
    return w(e, t), e.prototype._apply = function(t) {
        var e = nc(t, this.type, this.Jc, this.Yc);
        return new Hu(t.firestore, t.converter, function(t, e) {
    ...
    return Object.defineProperty(t.prototype, "_databaseId", {
        ...
        void 0 === n && (n = {}), function(t, e, n, r) {
            ...
            t._setSettings(Object.assign(Object.assign({}, i), {
                ...
                t._credentials = new Ou(new xu(o, new ao(s)));
            }
 ...
 */;
        ...
        get: function() {
            if (!this.Zc) throw new S(_.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Zc;
        },
        enumerable: !1,
        configurable: !0
 ...
 */
    ...
    return w(e, t), e.prototype.convertBytes = function(t) {
        ...
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Dc.tu(e, this.firestore, /* converter= */ null);
    }, e;
}(sc);
 ...
 */ var _c = /** @class */ function() {
    function t(t, e) {
        this._firestore = t, this._delegate = e, this._userDataWriter = new Ec(t);
    }
    return t.prototype.get = function(t) {
        var e = this, n = Fc(t);
        return this._delegate.get(n).then((function(t) {
            return new xc(e._firestore, new Ka(e._firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, n.converter));
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Fc(t);
    ...
    t.eu = function(e, n) {
        ...
        var o = i.get(n);
        return o || (o = new t(e, new Ec(e), n), i.set(n, o)), o;
    }, t;
}();
...
var Dc = /** @class */ function() {
    function t(t, e) {
        this.firestore = t, this._delegate = e, this._userDataWriter = new Ec(t);
    }
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        var r = kc(e), i = Cc(e, (function(e) {
            return new xc(t.firestore, new Ka(t.firestore._delegate, t._userDataWriter, e._key, e._document, e.metadata, t._delegate.converter));
        }));
        ...
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            ...
            return new xc(e.firestore, new Ka(e.firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, e._delegate.converter));
        }));
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(Nc.eu(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
var xc = /** @class */ function() {
    ...
    return w(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        return new e(this.firestore, t ? this._delegate.withConverter(Nc.eu(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}(Oc);
...
export { xc as H, Rc as J, Ic as L, bc as M, U as O, Sc as Q, _c as U, la as V, Oc as Y, Pc as Z, ia as g, Uc as i, Dc as j, wc as k, Vc as n, Tc as q, Bc as r, qc as s, Mc as t, ra as y };
//# sourceMappingURL=prebuilt-5742bb11-de9e772d.js.map
