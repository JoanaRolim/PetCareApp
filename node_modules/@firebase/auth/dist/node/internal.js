...
var register = require('./register-2a5ac87a.js');
...
var BrowserLocalPersistence = /** @class */ (function (_super) {
    ...
    function BrowserLocalPersistence() {
        ...
        _this.safariLocalStorageNotSynced = _iframeCannotSyncWebStorage() && register._isIframe();
        // Whether to use polling instead of depending on window events
        _this.fallbackToPolling = register._isMobileBrowser();
...
function _getProjectConfig(auth) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_a) {
            return [2 /*return*/, register._performApiRequest(auth, "GET" /* GET */, "/v1/projects" /* GET_PROJECT_CONFIG */, {})];
        });
    });
}
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    register._fail(auth, "unauthorized-domain" /* INVALID_ORIGIN */);
                    return [2 /*return*/];
            }
        });
    });
...
function matchDomain(expected) {
    var currentUrl = register._getCurrentUrl();
 ...
 * limitations under the License.
 */
var NETWORK_TIMEOUT = new register.Delay(30000, 60000);
/**
        ...
        function loadGapiIframe() {
            ...
            gapi.load('gapi.iframes', {
                ...
                ontimeout: function () {
                    ...
                    resetUnloadedGapiModules();
                    reject(register._createError(auth, "network-request-failed" /* NETWORK_REQUEST_FAILED */));
                },
 ...
 * limitations under the License.
 */
var PING_TIMEOUT = new register.Delay(5000, 15000);
...
function getIframeUrl(auth) {
    ...
    register._assert(config.authDomain, auth, "auth-domain-config-required" /* MISSING_AUTH_DOMAIN */);
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    context = _a.sent();
                    gapi = _window().gapi;
                    register._assert(gapi, auth, "internal-error" /* INTERNAL_ERROR */);
                            ...
                            return new Promise(function (resolve, reject) { return tslib.__awaiter(_this, void 0, void 0, function () {
                                ...
                                return tslib.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            _a.sent();
                                            networkError = register._createError(auth, "network-request-failed" /* NETWORK_REQUEST_FAILED */);
...
function _open(auth, url, name, width, height) {
    ...
    register._assert(newWin, auth, "popup-blocked" /* POPUP_BLOCKED */);
...
function _withDefaultResolver(auth, resolverOverride) {
    ...
    register._assert(auth._popupRedirectResolver, auth, "argument-error" /* ARGUMENT_ERROR */);
...
function _reauth(params) {
    ...
    register._assert(user, auth, "internal-error" /* INTERNAL_ERROR */);
...
function _link(params) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_a) {
            ...
            register._assert(user, auth, "internal-error" /* INTERNAL_ERROR */);
            return [2 /*return*/, register._link(user, new IdpCredential(params), params.bypassAuthState)];
        });
    });
}
    ...
    AbstractPopupRedirectOperation.prototype.getIdpTask = function (type) {
        switch (type) {
            ...
            case "reauthViaRedirect" /* REAUTH_VIA_REDIRECT */:
                return _reauth;
            default:
                register._fail(this.auth, "internal-error" /* INTERNAL_ERROR */);
        }
    };
...
function _signInWithRedirect(auth, provider, resolver) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    authInternal = register._castAuth(auth);
                    register._assert(provider instanceof register.FederatedAuthProvider, auth, "argument-error" /* ARGUMENT_ERROR */);
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    register._assert(provider instanceof register.FederatedAuthProvider, userInternal.auth, "argument-error" /* ARGUMENT_ERROR */);
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    register._assert(provider instanceof register.FederatedAuthProvider, userInternal.auth, "argument-error" /* ARGUMENT_ERROR */);
                    resolverInternal = _withDefaultResolver(userInternal.auth, resolver);
                    return [4 /*yield*/, register._assertLinkedStatus(false, userInternal, provider.providerId)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, _setPendingRedirectStatus(resolverInternal, userInternal.auth)];
                case 2:
...
function getRedirectResult(auth, resolver) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, register._castAuth(auth)._initializationPromise];
                case 1:
                    _a.sent();
...
function _getRedirectUrl(auth, provider, authType, redirectUrl, eventId, additionalParams) {
    register._assert(auth.config.authDomain, auth, "auth-domain-config-required" /* MISSING_AUTH_DOMAIN */);
    register._assert(auth.config.apiKey, auth, "invalid-api-key" /* INVALID_API_KEY */);
    var params = {
...
var BrowserPopupRedirectResolver = /** @class */ (function () {
    ...
    BrowserPopupRedirectResolver.prototype._openPopup = function (auth, provider, authType, eventId) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                ...
                url = _getRedirectUrl(auth, provider, authType, register._getCurrentUrl(), eventId);
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _setWindowLocation(_getRedirectUrl(auth, provider, authType, register._getCurrentUrl(), eventId));
    ...
    BrowserPopupRedirectResolver.prototype._initialize = function (auth) {
        ...
        if (this.eventManagers[key]) {
            ...
            if (manager) {
                ...
                register.debugAssert(promise_1, 'If manager is not set, promise should be');
                return promise_1;
            }
        }
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        iframe.register('authEvent', function (iframeEvent) {
                            register._assert(iframeEvent === null || iframeEvent === void 0 ? void 0 : iframeEvent.authEvent, auth, "invalid-auth-event" /* INVALID_AUTH_EVENT */);
    ...
    BrowserPopupRedirectResolver.prototype._isIframeWebStorageSupported = function (auth, cb) {
        ...
        iframe.send(WEB_STORAGE_SUPPORT_KEY, { type: WEB_STORAGE_SUPPORT_KEY }, function (result) {
            ...
            register._fail(auth, "internal-error" /* INTERNAL_ERROR */);
        }, gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER);
    };
...
function startSignInPhoneMfa(auth, request) {
    return register._performApiRequest(auth, "POST" /* POST */, "/v2/accounts/mfaSignIn:start" /* START_PHONE_MFA_SIGN_IN */, tslib.__assign({ tenantId: auth.tenantId }, request));
}
function finalizeSignInPhoneMfa(auth, request) {
    return register._performApiRequest(auth, "POST" /* POST */, "/v2/accounts/mfaSignIn:finalize" /* FINALIZE_PHONE_MFA_SIGN_IN */, tslib.__assign({ tenantId: auth.tenantId }, request));
}
...
function getRecaptchaParams(auth) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, register._performApiRequest(auth, "GET" /* GET */, "/v1/recaptchaParams" /* GET_RECAPTCHA_PARAM */)];
...
var MockWidget = /** @class */ (function () {
    function MockWidget(containerOrId, appName, params) {
        ...
        var container = typeof containerOrId === 'string'
            ...
            : containerOrId;
        register._assert(container, "argument-error" /* ARGUMENT_ERROR */, { appName: appName });
...
var NETWORK_TIMEOUT_DELAY = new register.Delay(30000, 60000);
...
var ReCaptchaLoaderImpl = /** @class */ (function () {
    ...
    ReCaptchaLoaderImpl.prototype.load = function (auth, hl) {
        var _this = this;
        if (hl === void 0) { hl = ''; }
        register._assert(isHostLanguageValid(hl), auth, "argument-error" /* ARGUMENT_ERROR */);
        ...
        return new Promise(function (resolve, reject) {
            ...
            _window()[_JSLOAD_CALLBACK] = function () {
                ...
                if (!recaptcha) {
                    reject(register._createError(auth, "internal-error" /* INTERNAL_ERROR */));
                    return;
                }
...
var RecaptchaVerifier = /** @class */ (function () {
    ...
    function RecaptchaVerifier(containerOrId, parameters, authExtern) {
        ...
        register._assert(typeof document !== 'undefined', this.auth, "operation-not-supported-in-this-environment" /* OPERATION_NOT_SUPPORTED */);
        var container = typeof containerOrId === 'string'
            ? document.getElementById(containerOrId)
            : containerOrId;
        register._assert(container, this.auth, "argument-error" /* ARGUMENT_ERROR */);
        this.container = container;
    ...
    RecaptchaVerifier.prototype.validateStartingState = function () {
        register._assert(!this.parameters.sitekey, this.auth, "argument-error" /* ARGUMENT_ERROR */);
        register._assert(this.isInvisible || !this.container.hasChildNodes(), this.auth, "argument-error" /* ARGUMENT_ERROR */);
        register._assert(typeof document !== 'undefined', this.auth, "operation-not-supported-in-this-environment" /* OPERATION_NOT_SUPPORTED */);
    };
    ...
    RecaptchaVerifier.prototype.assertNotDestroyed = function () {
        register._assert(!this.destroyed, this.auth, "internal-error" /* INTERNAL_ERROR */);
    };
    ...
    RecaptchaVerifier.prototype.init = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        register._assert(register._isHttpOrHttps() && !_isWorker(), this.auth, "internal-error" /* INTERNAL_ERROR */);
                    ...
                    case 3:
                        siteKey = _b.sent();
                        register._assert(siteKey, this.auth, "internal-error" /* INTERNAL_ERROR */);
    ...
    RecaptchaVerifier.prototype.getAssertedRecaptcha = function () {
        register._assert(this.recaptcha, this.auth, "internal-error" /* INTERNAL_ERROR */);
...
var ConfirmationResultImpl = /** @class */ (function () {
    ...
    ConfirmationResultImpl.prototype.confirm = function (verificationCode) {
        var authCredential = register.PhoneAuthCredential._fromVerification(this.verificationId, verificationCode);
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, new ConfirmationResultImpl(verificationId, function (cred) {
                            return register.signInWithCredential(authInternal, cred);
                        })];
            }
        });
    });
    ...
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userInternal = util.getModularInstance(user);
                    return [4 /*yield*/, register._assertLinkedStatus(false, userInternal, "phone" /* PHONE */)];
                case 1:
                    _a.sent();
                ...
                case 2:
                    verificationId = _a.sent();
                    return [2 /*return*/, new ConfirmationResultImpl(verificationId, function (cred) {
                            return register.linkWithCredential(userInternal, cred);
                        })];
            }
        });
    });
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    verificationId = _a.sent();
                    return [2 /*return*/, new ConfirmationResultImpl(verificationId, function (cred) {
                            return register.reauthenticateWithCredential(userInternal, cred);
                        })];
            }
        });
    });
        ...
        return tslib.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    register._assert(typeof recaptchaToken === 'string', auth, "argument-error" /* ARGUMENT_ERROR */);
                    register._assert(verifier.type === RECAPTCHA_VERIFIER_TYPE, auth, "argument-error" /* ARGUMENT_ERROR */);
                    ...
                    register._assert(session.type === "enroll" /* ENROLL */, auth, "internal-error" /* INTERNAL_ERROR */);
                    return [4 /*yield*/, register.startEnrollPhoneMfa(auth, {
                ...
                case 4:
                    register._assert(session.type === "signin" /* SIGN_IN */, auth, "internal-error" /* INTERNAL_ERROR */);
                    mfaEnrollmentId = ((_a = phoneInfoOptions.multiFactorHint) === null || _a === void 0 ? void 0 : _a.uid) ||
                        phoneInfoOptions.multiFactorUid;
                    register._assert(mfaEnrollmentId, auth, "missing-multi-factor-info" /* MISSING_MFA_INFO */);
                ...
                case 7: return [4 /*yield*/, register.sendPhoneVerificationCode(auth, {
                        phoneNumber: phoneInfoOptions.phoneNumber,
                        recaptchaToken: recaptchaToken
                    })];
                case 8:
...
function updatePhoneNumber(user, credential) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, register._link(util.getModularInstance(user), credential)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
 ...
 * limitations under the License.
 */
var _POLL_WINDOW_CLOSE_TIMEOUT = new register.Delay(2000, 10000);
/**
...
var PopupOperation = /** @class */ (function (_super) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        register._assert(result, this.auth, "internal-error" /* INTERNAL_ERROR */);
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.resolver._isIframeWebStorageSupported(this.auth, function (isSupported) {
                            if (!isSupported) {
                                _this.reject(register._createError(_this.auth, "web-storage-unsupported" /* WEB_STORAGE_UNSUPPORTED */));
                            }
                        });
    ...
    PopupOperation.prototype.cancel = function () {
        this.reject(register._createError(this.auth, "cancelled-popup-request" /* EXPIRED_POPUP_REQUEST */));
    };
        ...
        var poll = function () {
            ...
            if ((_b = (_a = _this.authWindow) === null || _a === void 0 ? void 0 : _a.window) === null || _b === void 0 ? void 0 : _b.closed) {
                ...
                _this.pollId = window.setTimeout(function () {
                    _this.pollId = null;
                    _this.reject(register._createError(_this.auth, "popup-closed-by-user" /* POPUP_CLOSED_BY_USER */));
                }, 2000 /* AUTH_EVENT */);
                return;
            }
...
var MultiFactorAssertionImpl = /** @class */ (function () {
    ...
    MultiFactorAssertionImpl.prototype._process = function (auth, session, displayName) {
        switch (session.type) {
            ...
            default:
                return register.debugFail('unexpected MultiFactorSessionType');
        }
    };
...
register.registerAuth("Browser" /* BROWSER */);
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (register._isIOS()) {
                        ...
                        register._fail(auth, "operation-not-supported-in-this-environment" /* OPERATION_NOT_SUPPORTED */);
                    }
                    ...
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            ...
                            function resumed() {
                                ...
                                onCloseTimer = window.setTimeout(function () {
                                    ...
                                    reject(register._createError(auth, "redirect-cancelled-by-user" /* REDIRECT_CANCELLED_BY_USER */));
                                }, REDIRECT_TIMEOUT_MS);
                            }
...
function _checkCordovaConfiguration(auth) {
    ...
    register._assert(typeof ((_a = win === null || win === void 0 ? void 0 : win.universalLinks) === null || _a === void 0 ? void 0 : _a.subscribe) === 'function', auth, "invalid-cordova-configuration" /* INVALID_CORDOVA_CONFIGURATION */, {
        missingPlugin: 'cordova-universal-links-plugin-fix'
    });
    // https://www.npmjs.com/package/cordova-plugin-buildinfo
    register._assert(typeof ((_b = win === null || win === void 0 ? void 0 : win.BuildInfo) === null || _b === void 0 ? void 0 : _b.packageName) !== 'undefined', auth, "invalid-cordova-configuration" /* INVALID_CORDOVA_CONFIGURATION */, {
        missingPlugin: 'cordova-plugin-buildInfo'
    });
    // https://github.com/google/cordova-plugin-browsertab
    register._assert(typeof ((_e = (_d = (_c = win === null || win === void 0 ? void 0 : win.cordova) === null || _c === void 0 ? void 0 : _c.plugins) === null || _d === void 0 ? void 0 : _d.browsertab) === null || _e === void 0 ? void 0 : _e.openUrl) === 'function', auth, "invalid-cordova-configuration" /* INVALID_CORDOVA_CONFIGURATION */, {
        missingPlugin: 'cordova-plugin-browsertab'
    });
    register._assert(typeof ((_h = (_g = (_f = win === null || win === void 0 ? void 0 : win.cordova) === null || _f === void 0 ? void 0 : _f.plugins) === null || _g === void 0 ? void 0 : _g.browsertab) === null || _h === void 0 ? void 0 : _h.isAvailable) === 'function', auth, "invalid-cordova-configuration" /* INVALID_CORDOVA_CONFIGURATION */, {
        missingPlugin: 'cordova-plugin-browsertab'
    });
    // https://cordova.apache.org/docs/en/latest/reference/cordova-plugin-inappbrowser/
    register._assert(typeof ((_k = (_j = win === null || win === void 0 ? void 0 : win.cordova) === null || _j === void 0 ? void 0 : _j.InAppBrowser) === null || _k === void 0 ? void 0 : _k.open) === 'function', auth, "invalid-cordova-configuration" /* INVALID_CORDOVA_CONFIGURATION */, {
...
function _generateNewEvent(auth, type, eventId) {
    ...
    return {
        ...
        error: register._createError(auth, "no-auth-event" /* NO_AUTH_EVENT */)
    };
}
...
function _eventFromPartialAndUrl(partialEvent, url) {
    ...
    if (callbackUrl.includes('/__/auth/callback')) {
        ...
        var error = code ? register._createError(code) : null;
        if (error) {
            return {
...
function persistenceKey(auth) {
    return register._persistenceKeyName("authEvent" /* AUTH_EVENT */, auth.config.apiKey, auth.name);
}
...
function generateNoEvent() {
    return {
        ...
        postBody: null,
        tenantId: null,
        error: register._createError("no-auth-event" /* NO_AUTH_EVENT */)
    };
}
