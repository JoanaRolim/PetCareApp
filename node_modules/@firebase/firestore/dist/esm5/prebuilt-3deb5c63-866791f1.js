 ...
 */ function D(t) {
    ...
    if (S.logLevel <= c.DEBUG) {
        var r = e.map(x);
        S.debug.apply(S, w([ "Firestore (8.4.3): " + t ], r));
    }
}
...
function A(t) {
    ...
    if (S.logLevel <= c.ERROR) {
        var r = e.map(x);
        S.error.apply(S, w([ "Firestore (8.4.3): " + t ], r));
    }
}
...
function k(t) {
    ...
    if (S.logLevel <= c.WARN) {
        var r = e.map(x);
        S.warn.apply(S, w([ "Firestore (8.4.3): " + t ], r));
    }
}
 ...
 */ var q = /** @class */ function() {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new T(_.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new T(_.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new T(_.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new T(_.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
 ...
 */ var G = /** @class */ function() {
    ...
    e.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var s = o[i];
            if (s.indexOf("//") >= 0) throw new T(_.INVALID_ARGUMENT, "Invalid segment (" + s + "). Paths must not contain // in them.");
    ...
    e.fromServerFormat = function(t) {
        for (var n = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new T(_.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            n.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new T(_.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new T(_.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new T(_.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new e(n);
    }, e.emptyPath = function() {
        return new e([]);
    }, e;
 ...
 */ function je(t) {
    ...
    return A("GRPC error has no .code"), _.UNKNOWN;
    switch (t) {
      case Me.OK:
        return _.OK;
    ...
    t.prototype.rt = function(t) {
        ...
        if (r) {
            ...
            if (Dt(i)) if (0 === n) {
                ...
                // queries.
                var o = new st(i.path);
                this.tt(e, o, Et.newNoDocument(o, U.min()));
...
function Tn(t, e) {
    var n = En(e);
    if (n.get(1) !== t.databaseId.projectId) throw new T(_.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
    if (n.get(3) !== t.databaseId.database) throw new T(_.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
    return new st(An(n));
}
...
function Rn(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? _e.updateTime(bn(t.updateTime)) : void 0 !== t.exists ? _e.exists(t.exists) : _e.none();
                  ...
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, r) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            "VersionError" === n.name ? r(new T(_.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r(new Ir(t, n));
...
/** Decodes a remote document from storage locally to a Document. */ function Or(t, e) {
    ...
    if (e.noDocument) {
        var n = st.fromSegments(e.noDocument.path), r = Vr(e.noDocument.readTime), i = Et.newNoDocument(n, r);
...
/** Decodes a DbTarget into TargetData */ function Ur(t) {
    ...
    e = Jt(Qt(Nn(n.documents[0])))) : e = function(t) {
        return Jt(Pn(t));
 ...
 */ function hi(t) {
    return b(this, void 0, void 0, (function() {
        return I(this, (function(e) {
            if (t.code !== _.FAILED_PRECONDITION || t.message !== pr) throw t;
            ...
            return b(e, void 0, void 0, (function() {
                ...
                return I(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Er(e = n.sent()) ? (D("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return g(e, t), e.prototype.applyChanges = function(t) {
        ...
        return this.changes.forEach((function(o, s) {
            ...
            if (s.document.isValidDocument()) {
                ...
                var h = Lr(e.Ie.R, Et.newNoDocument(o, U.min()), e.getReadTime(o));
...
var Ni = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Di = /** @class */ function() {
    ...
    h) {
        ...
        }, !t.yt()) throw new T(_.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new T(_.FAILED_PRECONDITION, Ni);
    ...
    t.prototype.fn = function() {
        ...
        return this.Be.runTransaction(t, o, dr, (function(o) {
            return i = new Dr(o, r.Ne ? r.Ne.next() : E.o), "readwrite-primary" === e ? r.Je(i).next((function(t) {
                return !!t || r.Ye(i);
            })).next((function(e) {
                if (!e) throw A("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Se.enqueueRetryable((function() {
                    return r.Me(!1);
                })), new T(_.FAILED_PRECONDITION, pr);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.dn = function(t) {
        var e = this;
        return Ai(t).get(Jn.key).next((function(t) {
            if (null !== t && e.sn(t.leaseTimestampMs, 5e3) && !e.cn(t.ownerId) && !e.tn(t) && !(e.Ce || e.allowTabSynchronization && t.allowTabSynchronization)) throw new T(_.FAILED_PRECONDITION, Ni);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.Xe = function(t) {
        ...
        return n.get(Jn.key).next((function(t) {
            return e.tn(t) ? (D("IndexedDbPersistence", "Releasing primary lease."), n.delete(Jn.key)) : mr.resolve();
        }));
    }, 
 ...
 */
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Rn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    h = Et.newInvalidDocument(c), r = r.insert(c, h)), De(a, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (zt(e) || Wt(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (N() <= c.DEBUG && D("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ne(e)), 
...
function Wi(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = O(t), i = Ye(), o = Pr(n), s = Ei(e), u = IDBKeyRange.lowerBound(o, !0);
            return s.Ot({
 ...
 */ var $i = /** @class */ function() {
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return mr.resolve(n ? n.document.clone() : Et.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = Ye();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
...
var fo = /** @class */ function() {
    ...
    return g(u, t), u.prototype.ki = function(t, e, n, r) {
            ...
            s.listenOnce(f.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case l.TIMEOUT:
                        D("Connection", 'RPC "' + t + '" timed out'), o(new T(_.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case l.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new T(u, r.message));
                            } else o(new T(_.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new T(_.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var g = c.createWebChannel(l, f), w = !1, b = !1, I = new Eo({
            Ei: function(t) {
        ...
        return E(g, y.EventType.OPEN, (function() {
            ...
            b || (b = !0, k("Connection", "WebChannel transport errored:", t), I.Vi(new T(_.UNAVAILABLE, "The operation could not be completed")));
 ...
 */ var Do = /** @class */ function() {
    ...
    t.prototype.ar = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new T(_.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.dr(e);
            }));
        }));
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    var e = void 0 === t.code ? _.UNKNOWN : je(t.code);
            ...
            i = Tn(t, r.document), o = r.readTime ? bn(r.readTime) : U.min(), u = Et.newNoDocument(i, o), 
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (R(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        n = bn(e)), new Ee(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
    ...
    return g(e, t), e.prototype.br = function() {
        if (this.Rr) throw new T(_.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
                ...
                return e && is(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return b(this, void 0, void 0, (function() {
                        ...
                        return I(this, (function(i) {
                            switch (i.label) {
                              case 0:
                                return Be(r = e.code) && r !== _.ABORTED ? (n = t.kr.shift(), 
...
var os = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new T(_.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
 ...
 */ function ss(t, e) {
    if (A("AsyncQueue", e + ": " + t), Er(t)) return new T(_.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var ms = /** @class */ function() {
    ...
    t.prototype.Un = function(t) {
        return t.metadata.exists ? xn(this.R, t.document, !1) : Et.newNoDocument(this.qn(t.metadata.name), this.Qn(t.metadata.readTime));
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Mn.pn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                ...
                                // exists=true
                                s.push(new Re(c.key, h, It(h.toProto().mapValue), _e.exists(!0)));
                            }
        ...
        return I(this, (function(c) {
            switch (c.label) {
              case 0:
                ...
                (o = i && i.key) ? (s = (s = new Ke(st.comparator)).insert(o, Et.newNoDocument(o, U.min())), 
...
function js(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Es ? (t.No.addReference(o.key, e), Ks(t, o)) : o instanceof _s ? (D("SyncEngine", "Document no longer in limbo: " + o.key), 
 ...
 */ function Gs(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Co.set(r, new Ns(n)), t.Do = t.Do.insert(n, r), Mo(t.remoteStore, new Cr(Jt(Qt(n.path)), r, 2 /* LimboResolution */ , E.o));
    }
}
              ...
              case 1:
                ...
                function(t, e) {
                    t.Fo.forEach((function(t) {
                        t.forEach((function(t) {
                            t.reject(new T(_.CANCELLED, "'waitForPendingWrites' promise is rejected due to a user change."));
                        }));
                    })), t.Fo.clear();
                }(n), 
...
var su = /** @class */ function() {
    ...
    return g(e, t), e.prototype.initialize = function(e) {
        ...
        var e = To();
        if (!mo.yt(e)) throw new T(_.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
    ...
    return t.prototype.initialize = function(t, e) {
        ...
        var e, n = No(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new _o(e));
 ...
 */ var fu = /** @class */ function() {
    ...
    return t.prototype.lookup = function(t) {
        return b(this, void 0, void 0, (function() {
            ...
            return I(this, (function(r) {
                switch (r.label) {
                  case 0:
                    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new T(_.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, e) {
                        return b(this, void 0, void 0, (function() {
                            var n, r, i, o, s, u;
                            return I(this, (function(a) {
        ...
        if (n) {
            ...
            throw new T(_.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.preconditionForUpdate = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new T(_.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    t.prototype.verifyNotTerminated = function() {
        if (this.asyncQueue.isShuttingDown) throw new T(_.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.terminate = function() {
        var t = this;
                    ...
                    return r = function(t, e, n, r, i) {
                        var o = new fu({
                            next: function(n) {
                                ...
                                e.enqueueAndForget((function() {
                                    return ds(t, s);
                                })), n.fromCache && "server" === r.source ? i.reject(new T(_.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
 ...
 */
function Pu(t, e, n) {
    if (!n) throw new T(_.INVALID_ARGUMENT, "Function " + t + "() cannot be called with an empty " + e + ".");
}
...
function Mu(t, e) {
    ...
    if (void 0 !== e.mergeFields && void 0 !== e.merge) throw new T(_.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
 ...
 */ function Fu(t, e, n, r) {
    if (!0 === e && !0 === r) throw new T(_.INVALID_ARGUMENT, t + " and " + n + " cannot be used together.");
}
 ...
 */ function Vu(t) {
    if (!st.isDocumentKey(t)) throw new T(_.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function qu(t) {
    if (st.isDocumentKey(t)) throw new T(_.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new T(_.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = Uu(t);
        throw new T(_.INVALID_ARGUMENT, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function ju(t, e) {
    if (e <= 0) throw new T(_.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */ var Ku = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new T(_.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new T(_.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    ...
    /** @hideconstructor */
    function t(t, e) {
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new Ku({}), 
        this._settingsFrozen = !1, t instanceof Au ? (this._databaseId = t, this._credentials = new Cu) : (this._app = t, 
        this._databaseId = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new T(_.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
    ...
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this._app) throw new T(_.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this._app;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this._settingsFrozen) throw new T(_.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this._settings = new Ku(t), void 0 !== t.credentials && (this._credentials = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new T(_.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */
    ...
    return Object.defineProperty(t.prototype, "_path", {
         ...
         */
        get: function() {
            return new Wu(this.firestore, this.converter, this._key.path.popLast());
        },
        enumerable: !1,
        configurable: !0
    ...
    function e(e, n, r) {
        var i = this;
        return (i = t.call(this, e, n, Qt(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
 ...
 */ function Hu(t, e) {
    ...
    if (!(t instanceof Qu || t instanceof Wu)) throw new T(_.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
 ...
 */ function Yu(t, e) {
    ...
    if (!(t instanceof Qu || t instanceof Wu)) throw new T(_.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Vu(n = t._path.child(Q.fromString.apply(Q, w([ e ], r)))), new Qu(t.firestore, t instanceof Wu ? t.converter : null, new st(n));
}
 ...
 * Firestore database.
 */ function Xu(t, e) {
    return t = u(t), e = u(e), (t instanceof Qu || t instanceof Wu) && (e instanceof Qu || e instanceof Wu) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function $u(t, e) {
    return t = u(t), e = u(e), t instanceof zu && e instanceof zu && t.firestore === e.firestore && te(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var ta = /** @class */ function() {
    ...
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, n) || this).type = "firestore", r._queue = new Ju, r._persistenceKey = "name" in e ? e.name : "[DEFAULT]", 
        r;
    }
 ...
 */
function sa(t) {
    if (t._initialized || t._terminated) throw new T(_.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ var ua = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new T(_.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
     ...
     */    return t.fromBase64String = function(e) {
        try {
            ...
            throw new T(_.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
...
function(t) {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new T(_.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new T(_.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
...
/** Parse document data from a set() call. */ function ga(t, e, n, r, i, o) {
    ...
    if (o.merge) u = new H(s.fieldMask), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var d = Ra(e, l[f], n);
            if (!s.contains(d)) throw new T(_.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            Ma(h, d) || h.push(d);
        }
...
/** Parse update data from a list of field/value arguments. */ function Na(t, e, n, r, i, o) {
    ...
    if (o.length % 2 != 0) throw new T(_.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
...
function Pa(t, e, n, r, i) {
    ...
    a += ")"), new T(_.INVALID_ARGUMENT, (u += ". ") + t + a)
 ...
 */ var Ua = /** @class */ function() {
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new ja(n._firestore, n._userDataWriter, r.key, r, new Ua(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
    ...
    t.prototype.docChanges = function(t) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new T(_.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    var r = new ja(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Ua(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new ja(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Ua(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 * limitations under the License.
 */ function za(t) {
    if (Wt(t) && 0 === t.explicitOrderBy.length) throw new T(_.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var Ya = /** @class */ function(t) {
    ...
    return g(e, t), e.prototype._apply = function(t) {
        var e = ma(t.firestore), n = function(t, e, n, r, i, o, s) {
            var u;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new T(_.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            return function(t, e) {
                if (e.g()) {
                    var n = Yt(t);
                    if (null !== n && !n.isEqual(e.field)) throw new T(_.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = Ht(t);
 ...
 */
                ...
                throw i === e.op ? new T(_.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new T(_.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, l), l;
        }(t._query, 0, e, t.firestore._databaseId, this.Qc, this.Kc, this.jc);
        return new zu(t.firestore, t.converter, function(t, e) {
    ...
    return g(e, t), e.prototype._apply = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new T(_.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new T(_.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new qt(e, n);
            return function(t, e) {
                if (null === Ht(t)) {
    ...
    return g(e, t), e.prototype._apply = function(t) {
        return new zu(t.firestore, t.converter, Zt(t._query, this.Gc, this.zc));
    }, e;
...
function tc(t, e, n, r) {
    if (n[0] = u(n[0]), n[0] instanceof Fa) return function(t, e, n, r, i) {
        if (!r) throw new T(_.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        for (var o = [], s = 0, u = $t(t); s < u.length; s++) {
            ...
            if (a.field.isKeyField()) o.push(pt(e, r.key)); else {
                ...
                if (tt(c)) throw new T(_.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var h = a.field.canonicalString();
                    throw new T(_.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    return function(t, e, n, r, i, o) {
        ...
        if (i.length > s.length) throw new T(_.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var u = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (s[a].field.isKeyField()) {
                if ("string" != typeof c) throw new T(_.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!Xt(t) && -1 !== c.indexOf("/")) throw new T(_.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(Q.fromString(c));
                if (!st.isDocumentKey(h)) throw new T(_.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var f = new st(h);
                u.push(pt(e, f));
            } else {
                var l = Da(n, r, c);
...
function ec(t, e, n) {
    if ("string" == typeof (n = u(n))) {
        if ("" === n) throw new T(_.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!Xt(e) && -1 !== n.indexOf("/")) throw new T(_.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(Q.fromString(n));
        if (!st.isDocumentKey(r)) throw new T(_.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return pt(t, new st(r));
    }
    if (n instanceof Qu) return pt(t, n._key);
    throw new T(_.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Uu(n) + ".");
}
 ...
 * array requirements.
 */ function nc(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new T(_.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new T(_.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function rc(t, e, n) {
    if (!n.isEqual(e)) throw new T(_.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
...
var sc = /** @class */ function(t) {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = ac(t, this._firestore), i = oc(r.converter, e, n), o = ga(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
    ...
    t.prototype.delete = function(t) {
        ...
        return this._mutations = this._mutations.concat(new Ve(e._key, _e.none())), this;
    }, 
    /**
    ...
    t.prototype.commit = function() {
        ...
        if (this._committed) throw new T(_.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();
 ...
 * called.
 */ function ac(t, e) {
    if ((t = u(t)).firestore !== e) throw new T(_.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function hc(t, e, n) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = u(e)) || e instanceof ua ? Na(s, "updateDoc", t._key, e, n, r) : Sa(s, "updateDoc", t._key, e)).toMutation(t._key, _e.exists(!0)) ]);
}
 ...
 */ function dc(t, e, n) {
    ...
    return new Ba(t, i, e._key, r, new Ua(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var pc = /** @class */ function(t) {
    ...
    return t.prototype.get = function(t) {
        ...
        return this._transaction.lookup([ n._key ]).then((function(t) {
            ...
            var i = t[0];
            if (i.isFoundDocument()) return new Fa(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new Fa(e._firestore, r, n._key, null, n.converter);
            throw C();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = ac(t, this._firestore), i = oc(r.converter, e, n), o = ga(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
...
/** Helper function to assert Uint8Array is available at runtime. */ function yc() {
    if ("undefined" == typeof Uint8Array) throw new T(_.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function vc() {
    if ("undefined" == typeof atob) throw new T(_.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
...
/** Immutable class holding a blob (binary data) */ var mc = /** @class */ function() {
    ...
    return t.prototype.enableIndexedDbPersistence = function(t, e) {
        ...
        return function(t) {
            var e = this;
            if (t._initialized && !t._terminated) throw new T(_.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
            var n = new vr;
 ...
 */;
        ...
        get: function() {
            if (!this.Xc) throw new T(_.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Xc;
        },
        enumerable: !1,
        configurable: !0
        ...
        try {
            return new Cc(this, function(t, e) {
                if (t = Bu(t, Gu), Pu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new T(_.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new zu(t, 
                /* converter= */ null, 
                /**
 ...
 */
        ...
        var t = this;
        return ra(this._delegate), new _c(new uc(this._delegate, (function(e) {
            return lc(t._delegate, e);
        })));
    }, t.prototype.loadBundle = function(t) {
        throw new T(_.FAILED_PRECONDITION, '"loadBundle()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, t.prototype.namedQuery = function(t) {
        throw new T(_.FAILED_PRECONDITION, '"namedQuery()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, t;
}(), bc = /** @class */ function(t) {
    function e(e) {
        var n = this;
 ...
 */ var Ec = /** @class */ function() {
    ...
    return t.prototype.get = function(t) {
        ...
        return this._delegate.get(n).then((function(t) {
            return new kc(e._firestore, new Ba(e._firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, n.converter));
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Pc(t);
...
var Sc = /** @class */ function() {
    ...
    return t.nu = function(e, n, r) {
        if (e.length % 2 != 0) throw new T(_.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + e.canonicalString() + " has " + e.length);
        ...
        try {
            return function(t, e, n) {
                t = Bu(t, Qu);
                var r = Bu(t.firestore, na), i = oc(t.converter, e, n);
                return lc(r, [ ga(ma(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, _e.none()) ]);
            }(this._delegate, t, e);
        } catch (t) {
        ...
        return lc(Bu((t = this._delegate).firestore, na), [ new Ve(t._key, _e.none()) ]);
        var t;
        /**
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        var r = Dc(e), i = Ac(e, (function(e) {
            return new kc(t.firestore, new Ba(t.firestore._delegate, t._userDataWriter, e._key, e._document, e.metadata, t._delegate.converter));
        }));
        ...
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
                                    ...
                                    return b(this, void 0, void 0, (function() {
                                        ...
                                        return I(this, (function(o) {
                                            switch (o.label) {
                                              ...
                                              case 1:
                                                return (i = o.sent()).isFoundDocument() ? n.resolve(i) : i.isNoDocument() ? n.resolve(null) : n.reject(new T(_.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                [ 3 /*break*/ , 3 ];
            ...
            return new kc(e.firestore, new Ba(e.firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, e._delegate.converter));
        }));
    }, t.prototype.withConverter = function(e) {
...
var kc = /** @class */ function() {
     ...
     */
        function(t) {
            ...
            t = Bu(t, zu);
            var e = Bu(t.firestore, na), n = ra(e), r = new cc(e);
            return za(t._query), Nu(n, t._query).then((function(n) {
                return new Ka(e, r, t, n);
            }));
        }(this._delegate)).then((function(t) {
    ...
    return g(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        var e = this;
        return function(t, e) {
            var n = Bu(t.firestore, na), r = Yu(t), i = oc(t.converter, e);
            return lc(n, [ ga(ma(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, _e.exists(!1)) ]).then((function() {
                return r;
            }));
...
export { wc as $, Ec as B, kc as G, Cc as H, Ic as L, gc as O, Sc as Q, Lc as X, Oc as Y, ea as _, Fc as e, q as k, na as m, Vc as n, _c as q, qc as s, Mc as t, ha as v, mc as x, xc as z };
//# sourceMappingURL=prebuilt-3deb5c63-866791f1.js.map
