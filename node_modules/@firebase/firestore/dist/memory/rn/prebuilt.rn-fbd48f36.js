 ...
 */ class zc {
    constructor(t, e, n) {
        this.ac = t, this.hc = e, this.lc = n, this.type = "FirstParty", this.user = fr.FIRST_PARTY;
    }
    get authHeaders() {
        const t = {
 ...
 */ class ru {
    ...
    constructor(t, e) {
        ...
        this._settingsFrozen = !1, t instanceof Qc ? (this._databaseId = t, this._credentials = new Wc) : (this._app = t, 
...
function lu(t, e, ...n) {
    ...
    }
    {
        ...
        return Zc(s), new ou(t.firestore, t instanceof uu ? t.converter : null, new it(s));
    }
}
 ...
 * Firestore database.
 */ function du(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), t instanceof cu && e instanceof cu && (t.firestore === e.firestore && te(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = lo.createAndSchedule(this, t, e, n, (t => this.Rc(t)));
...
class Bu extends Pu {
    ...
    _toFieldTransform(t) {
        const e = Mu(this, t, 
        /*array=*/ !0), n = this.qc.map((t => Wu(t, e))), s = new we(n);
...
class qu extends Pu {
    ...
    _toFieldTransform(t) {
        const e = Mu(this, t, 
        /*array=*/ !0), n = this.qc.map((t => Wu(t, e))), s = new me(n);
        return new Te(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Uu extends Pu {
    ...
    _toFieldTransform(t) {
        const e = new ge(t.R, ue(t.R, this.Uc));
 ...
 */ class _a extends la {
    ...
    _apply(t) {
        return new cu(t.firestore, t.converter, Zt(t._query, this.Gc, this.zc));
    }
}
...
class La extends Ia {
    ...
    convertReference(t) {
        const e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Ka.Zc(e, this.firestore, /* converter= */ null);
    }
}
 ...
 */ class qa {
    ...
    get(t) {
        const e = th(t);
        return this._delegate.get(e).then((t => new za(this._firestore, new ra(this._firestore._delegate, this._userDataWriter, t._key, t._document, t.metadata, e.converter))));
    }
    set(t, e, n) {
        const s = th(t);
    ...
    set(t, e) {
        ...
        try {
            return function(t, e, n) {
                ...
                return Da(s, [ Ou(ku(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Re.none()) ]);
            }(this._delegate, t, e);
        } catch (t) {
 ...
 */    }
    onSnapshot(...t) {
        const e = Wa(t), n = Ga(t, (t => new za(this.firestore, new ra(this.firestore._delegate, this._userDataWriter, t._key, t._document, t.metadata, this._delegate.converter))));
 ...
 */ (this._delegate) : function(t) {
        ...
        }(this._delegate), e.then((t => new za(this.firestore, new ra(this.firestore._delegate, this._userDataWriter, t._key, t._document, t.metadata, this._delegate.converter))));
    }
    withConverter(t) {
        return new Ka(this.firestore, t ? this._delegate.withConverter(Qa.tu(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
 ...
 */ (this._delegate) : "server" === (null == t ? void 0 : t.source) ? function(t) {
    ...
    withConverter(t) {
        return new Ja(this.firestore, t ? this._delegate.withConverter(Qa.tu(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
...
class Za extends Ja {
    ...
    add(t) {
        return function(t, e) {
            ...
            return Da(n, [ Ou(ku(t.firestore), "addDoc", s._key, i, null !== t.converter, {}).toMutation(s._key, Re.exists(!1)) ]).then((() => s));
    ...
    withConverter(t) {
        return new Za(this.firestore, t ? this._delegate.withConverter(Qa.tu(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
...
//# sourceMappingURL=prebuilt.rn-fbd48f36.js.map
